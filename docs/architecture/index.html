...
Version: ImageMagick <?php echo MagickVersion ?> <?php echo MagickReleaseDate ?> Q16-HDRI https://imagemagick.org</samp></pre>
...
<p>ImageMagick supports <a href="/multispectral-imagery/">multispectral imagery</a> where all channels have the same dimensions and number of pixels as the original image.  However, not all image formats support multispectral images.  PSD, TIFF, MIFF, MPC, and FTXT have full support for multispectral images up to 31 bands, 21 of them meta channels.  Note, if you build ImageMagick with the configure script <samp>--enable-64bit-channel-masks</samp> option, you can process 62 band multispectral images with up to 52 meta channels.</p>
...
<p>We also provide a lightweight tool, <a href="/stream/">stream</a>, to stream one or more pixel components of the image or portion of the image to your choice of storage formats.  It writes the pixel components as they are read from the input image a row at a time making <a href="/stream/">stream</a> desirable when working with large images or when you require raw pixel components.  A majority of the image formats stream pixels (red, green, and blue) from left to right and top to bottom.  However, a few formats do not support this common ordering (e.g. the PSD format).</p>
...
<p>In certain cases, it might be optimal to set the number of threads to 1 or to disable OpenMP completely with the <a href="/resources/#environment">MAGICK_THREAD_LIMIT</a> environment variable, <a href="/command-line-options/#limit">-limit</a> command line option,  or the  <a href="/resources/#configure">policy.xml</a> configuration file.</p>
...
<p>We provide the <a href="https://download.imagemagick.org/archive/kits/">Magick Coder Kit</a> to help you get started writing your own custom coder.</p>
...
<p>We provide the <a href="https://download.imagemagick.org/archive/kits/">Magick Filter Kit</a> to help you get started writing your own custom image filter.</p>
