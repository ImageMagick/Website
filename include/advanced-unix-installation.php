...
<dt>make check</dt>
  <dd>Run tests using the installed ImageMagick (<code>sudo make install</code> must be done first).  Freetype and Ghostscript are a prerequisite, otherwise certain unit tests that render text and the EPS, PS, and PDF formats will likely fail.</dd>
<dt>make clean</dt>
