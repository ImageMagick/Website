...
<p>For performance reasons, the first pass is fast by repeating the random sequence of bytes.  Subsequent passes are an order of magnitude slower but generates cryptographically strong random bytes for the entire buffer.</p>
