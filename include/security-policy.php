...
<ul><pre class="pre-scrollable bg-light"><code>&lt;policymap>
...
<ul><pre class="bg-light">$ magick https://imagemagick.org/image/wizard.png wizard.jpg
...
<ul><pre class="pre-scrollable bg-light">-> identify -list policy
