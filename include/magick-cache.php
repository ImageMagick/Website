...
<p class="text-info">The Magick image cache is a work in progress.  Do not use it in production services until the API is at least version 1.0.0.  It is currently 0.9.2.</p>
...
<p>Set an API key and the time to live to 2 days.  Anytime after 1 day, the image will automatically expire with the <code>expire</code> function.  To get, expire, or delete the image, you will need to use the same API key.</p>
...
<p>Don't forget your API key.  Without it, you will not be able to get, list, delete or expire your content.</p>
<h5>Get an image from the Magick Cache</h5>
...
<h5>Delete an image from the Magick Cache</h5>
