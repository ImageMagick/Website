...
<pre class="bg-light text-dark"><samp>magick mogrify -resize 50% rose.jpg</samp></pre>
...
<pre class="bg-light text-dark"><samp>magick mogrify -resize 256x256 *.jpg</samp></pre>

<p>Finally, we convert all our PNG images in a folder to the JPEG format:</p>

<pre class="bg-light text-dark"><samp>magick mogrify -format jpg *.png</samp></pre>
