...
<pre class="p-3 mb-2 bg-light text-dark cli"><samp>magick mogrify -resize 50% rose.jpg</samp></pre>
...
<pre class="p-3 mb-2 bg-light text-dark cli"><samp>magick mogrify -resize 256x256 *.jpg</samp></pre>

<p>Finally, we convert all our PNG images in a folder to the JPEG format:</p>

<pre class="p-3 mb-2 bg-light text-dark cli"><samp>magick mogrify -format jpg *.png</samp></pre>
...
transparent, extract, background, or shape the alpha channel</td>
  ...
  <tr>
    <td><a href="<?php echo $_SESSION['RelativePath']?>/../script/command-line-options.php#path">-path <var>path</var></a></td>
