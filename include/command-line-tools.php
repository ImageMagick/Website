...
<dl class="row">
  ...
  <dt class="col-md-4"><a class="anchor" id="import"></a><a href="<?php echo $_SESSION['RelativePath']?>/../script/import.php">magick import</a></dt><dd class="col-md-8">save any visible window on an X server and outputs it as an image file. You can capture a single window, the entire screen, or any rectangular portion of the screen.</dd>
