...
<dl class="row">
  <dt class="col-md-4"><a id="magick"></a><a href="<?php echo $_SESSION['RelativePath']?>/../script/magick.php">magick</a></dt><dd class="col-md-8">convert between image formats as well as resize an image, blur, crop, despeckle, dither, draw on, flip, join, re-sample, and much more.</dd>
  <dt class="col-md-4"><a id="magick-script"></a><a href="<?php echo $_SESSION['RelativePath']?>/../script/magick-script.php">magick-script</a></dt><dd class="col-md-8">use this scripting language interpreter to convert between image formats as well as resize an image, blur, crop, despeckle, dither, draw on, flip, join, re-sample, and much more.</dd>
</dl>
...
<dl class="row">
  ...
  <dt class="col-md-4"><a id="compare"></a><a href="<?php echo $_SESSION['RelativePath']?>/../script/compare.php">compare</a></dt><dd class="col-md-8">mathematically and visually annotate the difference between an image and its reconstruction.</dd>
  <dt class="col-md-4"><a id="composite"></a><a href="<?php echo $_SESSION['RelativePath']?>/../script/composite.php">composite</a></dt><dd class="col-md-8">overlap one image over another.</dd>
  <dt class="col-md-4"><a id="conjure"></a><a href="<?php echo $_SESSION['RelativePath']?>/../script/conjure.php">conjure</a></dt><dd class="col-md-8">interpret and execute scripts written in the Magick Scripting Language (MSL).</dd>
  <dt class="col-md-4"><a id="convert"></a><a href="<?php echo $_SESSION['RelativePath']?>/../script/convert.php">convert</a></dt><dd class="col-md-8">convert between image formats as well as resize an image, blur, crop, despeckle, dither, draw on, flip, join, re-sample, and much more.</dd>
  <dt class="col-md-4"><a id="display"></a><a href="<?php echo $_SESSION['RelativePath']?>/../script/display.php">display</a></dt><dd class="col-md-8">display an image or image sequence on any X server.</dd>
  <dt class="col-md-4"><a id="identify"></a><a href="<?php echo $_SESSION['RelativePath']?>/../script/identify.php">identify</a></dt><dd class="col-md-8">describe the format and characteristics of one or more image files.</dd>
  <dt class="col-md-4"><a id="import"></a><a href="<?php echo $_SESSION['RelativePath']?>/../script/import.php">import</a></dt><dd class="col-md-8">save any visible window on an X server and outputs it as an image file. You can capture a single window, the entire screen, or any rectangular portion of the screen.</dd>
  <dt class="col-md-4"><a id="mogrify"></a><a href="<?php echo $_SESSION['RelativePath']?>/../script/mogrify.php">mogrify</a></dt><dd class="col-md-8">resize an image, blur, crop, despeckle, dither, draw on, flip, join, re-sample, and much more.  Mogrify overwrites the original image file, whereas, <a href="<?php echo $_SESSION['RelativePath']?>/../script/convert.php">convert</a> writes to a different image file.</dd>
