...
<pre class="bg-light text-dark mx-4"><samp>magick myimage.jpg -colorspace RGB -resize 200% -colorspace sRGB mybigimage.jpg</samp></pre>

<p>To declare that an image is linear RGB rather than sRGB, you can use the set option:</p>

<pre class="bg-light text-dark mx-4"><samp>magick myimage.png -set colorspace RGB myRGBimage.png</samp></pre>
...
<pre class="bg-light text-dark mx-4"><samp>magick myimage.png -colorspace RGB -separate myimage_channels_%d.png</samp></pre>
...
<pre class="bg-light text-dark mx-4"><samp>magick myimage.png -separate myimage_channels_%d.png
...
<pre class="bg-light text-dark mx-4"><samp>magick myimage.png -set colorspace RGB -separate myimage_channels_%d.png
...
<pre class="bg-light text-dark mx-4"><samp>magick myimage.png -colorspace HSL -separate myimage_channels_%d.png
magick myimage_channels_*.png -set colorspace HSL -combine -colorspace sRGB myimage2.png</samp></pre>

<pre class="bg-light text-dark mx-4"><samp>magick myimage.png -set colorspace RGB -colorspace HSL -separate myimage_channels_%d.png
