...
<p>By default, converting color images to grayscale returns non-linear gray.  To instead convert to linear gray, use the <a href="/script/command-line-processing.php#set">-set</a> or <a href="/script/command-line-processing.php#intensity">-intensity</a
> or <a href="/script/command-line-processing.php#grayscale">-grayscale</a> options:</p>
