...
beyond what is provided by normal means.  Defined settings are listed in <a href="/command-line-options/#verbose">-verbose</a> information ("<samp>info:</samp>" output format) as "Artifacts". </p>
...
<table class="table table-sm table-hover table-striped table-responsive">
 ...
 <tr>
    ...
    <td>Set the divide SNR constant <a href="/command-line-options/#complex">-complex</a>.</td>
  </tr>

  <tr>
    <td>compose:args=<var>arguments</var></td>
     <td>Set certain compose argument values when using convert ... -compose ...
    -composite. See <a href="/compose/"
    >Image Composition</a>.</td>
  </tr>

  <tr>
    <td>compose:clip-to-self=<var>true|false</var></td>
    <td>Some <a href="/command-line-options/#compose" >-compose</a> methods can modify the
 ...
 <tr>
  ...
  <tr>
    ...
    <td>Set the output scaling factor for use with <a href="/command-line-options/#distort"
   >-distort</a>.</td>
  </tr>

  <tr>
    <td>distort:viewport=<var>WxH+X+Y</var></td>
    <td>Set the viewport for use with <a href="/command-line-options/#distort">-distort</a>.</td>
  </tr>
  ...
  <tr>
    <td>filter:option=<var>value</var></td>
     <td>Set a filter option for use with <a href="/command-line-options/#resize">-resize</a>.
 ...
 <tr>
  ...
  <tr>
    ...
    <a href="/command-line-options/#fft">+-fft</a> and <a href="/command-line-options/#ift">+-ift</a>. The default is
    <var>forward</var>.</td>
  </tr>
 ...
 <tr>
  ...
  <tr>
    ...
    <td>Define the colorspace to use with <a href="/command-line-options/#modulate">-modulate</a>.
 ...
 <tr>
  ...
  <tr>
    ...
    <td>In combination with <a href="/command-line-options/#depth">-depth</a>, this define allows color values to be presented in one or combination of: percent, names, 8-bit components, or hex values. 16-bit depth values are generally shown as percents and 8-bit depth values generally are shown as a combination of color names and 8-bit component values.</td>
  </tr>
  ...
  <tr>
    ...
    to preserve negative values. If <a href="/command-line-options/#depth">-depth</a> 16 is
    included, the result is a single precision floating point format.
    If <a href="/command-line-options/#depth">-depth</a> 32 is included, the result is
 ...
 <tr>
  ...
  <tr>
    ...
    expressed as percentages (see <a href="/command-line-options/#sample" >-sample</a>).</td>
  </tr>
  ...
  <tr>
    ...
    wish to do this, you must use the appropriate <a href="/command-line-options/#depth">-depth</a>,
    <a href="/command-line-options/#colors">-colors</a>, or <a href="/command-line-options/#type">-type</a> directives to
  ...
  <tr>
    ...
    <p>The <a href="/command-line-options/#strip">-strip</a>
