...
<pre class="p-3 mb-2 bg-light text-dark cli"><samp>magick bilevel.tif -define ps:imagemask eps3:stencil.ps </samp></pre>
...
<pre class="p-3 mb-2 bg-light text-dark"><samp>-define registry:temporary-path=/data/tmp </samp></pre>
...
<table class="table table-sm table-hover table-striped table-responsive">
 ...
 <tr>
  ...
  <tr>
    ...
    <pre class="p-3 mb-2 bg-light text-dark"><samp>-define png:include-chunk=none,gAMA
    </samp></pre>
