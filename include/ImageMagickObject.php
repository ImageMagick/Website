...
<p>The source code for ImageMagickObject is available from the ImageMagick <a href="https://github.com/ImageMagick">GIT</a> repository, or as part of the <a href="<?php echo $_SESSION['RelativePath']?>/../script/install-source.php#windows">Windows source</a> distribution. Once the source code has been retrieved and extracted, the source for ImageMagickObject is the directory <samp>ImageMagick\contrib\win32\ATL7ImageMagickObject</samp>, however, ImageMagick itself must be built using the static-multithread (VisualStaticMT) build configuration.  Building ImageMagickObject requires Microsoft Visual C++ 7.0 as delivered with Microsoft's Visual Studio .NET package. See the <a href="<?php echo $_SESSION['RelativePath']?>/../script/install-source.php#windows">Windows compilation instructions</a> to get ImageMagick itself built before building the ImageMagick COM+ component.</p>
