...
<p>ImageMagick provides a statically-built ImageMagick object as part of its <a href="<?php echo $_SESSION['RelativePath']?>/../script/binary-releases.php#windows">Windows installation package</a>.  When this package is installed, ImageMagickObject and its sample programs are installed to this path:</p>
