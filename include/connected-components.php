...
<ul>
<li>connected-components:angle-threshold</li>
...
<li>connected-components:major-axis-threshold (diameter)</li>
<li>connected-components:minor-axis-threshold (diameter)</li>
