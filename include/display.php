...
<p class="lead">Use the <samp>display</samp> program to display an image or image sequence on any X server.  See <a href="/command-line-processing/">Command Line Processing</a> for advice on how to structure your <samp>display</samp> command or see below for example usages of the command.</p>
