...
<pre class="bg-light text-dark"><samp>magick display rose.jpg </samp></pre>

<p>To tile a slate texture onto the root window, use:</p>

<pre class="bg-light text-dark"><samp>magick display -size 1280x1024 -window root slate.png </samp></pre>

<p>To display a visual image directory of all your JPEG images, use:</p>

<pre class="bg-light text-dark"><samp>magick display 'vid:*.jpg' </samp></pre>
...
<pre class="bg-light text-dark"><samp>magick display -density 72 drawing.svg </samp></pre>
