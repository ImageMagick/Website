...
<pre class="bg-light text-dark mx-4"><samp>magick rose.jpg -sharpen 0x1 reconstruct.jpg
...
<pre class="bg-light text-dark mx-4"><samp>$ magick compare -metric RMSE -subimage-search logo.png hat.jpg similarity.png
