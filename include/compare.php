...
<pre class="bg-light"><code>magick rose.jpg -sharpen 0x1 reconstruct.jpg
...
<pre class="bg-light"><code>$ magick compare -verbose -metric mae rose.jpg reconstruct.jpg difference.png
Image: rose.jpg
...
<pre class="bg-light"><code>$ magick compare -channel red -metric PSNR rose.jpg reconstruct.jpg difference.png
19.63
</code></pre>

<p>Or, if you just want the overall image distortion, use this command:</p>

<pre class="bg-light"><code>$ magick compare -metric PSNR rose.jpg reconstruct.jpg difference.png
28.31
</code></pre>
...
<pre class="bg-light"><code>$ magick compare -metric RMSE -subimage-search logo.png wizard.jpg similarity.gif
