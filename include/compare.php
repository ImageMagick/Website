...
<p class="lead">Use the <samp>compare</samp> program to mathematically and visually annotate the difference between an image and its reconstruction.  See <a href="/script/command-line-processing.php">Command Line Processing</a> for advice on how to structure your <samp>compare</samp> command or see below for example usages of the command.</p>
...
transparent, extract, background, or shape the alpha channel</td>
  ...
  <tr>
    <td><a href="/script/command-line-options.php#dissimilarity-threshold">-dissimilarity-threshold <var>value</var></a></td>
  ...
  <tr>
    <td><a href="/script/command-line-options.php#highlight-color">-highlight-color <var>color</var></a></td>
  ...
  <tr>
    <td><a href="/script/command-line-options.php#lowlight-color">-lowlight-color <var>color</var></a></td>
  ...
  <tr>
    <td><a href="/script/command-line-options.php#similarity-threshold">-similarity-threshold <var>value</var></a></td>
  ...
  <tr>
    <td><a href="/script/command-line-options.php#subimage-search">-subimage-search</a></td>
  ...
  <tr>
    <td><a href="/script/command-line-options.php#write-mask">-read-mask <var>filename</var></a></td>
