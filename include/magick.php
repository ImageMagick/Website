...
<pre class="bg-light text-dark"><samp>magick rose.jpg rose.png </samp></pre>

<p>Next, we reduce the image size before it is written to the PNG format:</p>

<pre class="bg-light text-dark"><samp>magick rose.jpg -resize 50% rose.png </samp></pre>
...
<pre class="bg-light text-dark"><samp>magick -size 320x85 canvas:none -font Bookman-DemiItalic -pointsize 72 \
...
<pre class="bg-light text-dark"><samp>magick input.png -colorspace RGB +sigmoidal-contrast 11.6933 \
...
<pre class="bg-light text-dark"><samp>ln -s magick
