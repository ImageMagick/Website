...
<p>Utilize other command-line <a href="/command-line-tools/">tools</a> from the <samp>magick</samp> tool.  To invoke this functionality, simply create a symbolic link to the <samp>magick</samp> tool or specify the tool you want to use as the first argument.  These two methods are equivalent:</p>
...
<p>You can find additional examples of using <samp>magick</samp> in <a href="https://usage.imagemagick.org/">Examples of ImageMagick Usage</a>.</p>
...
transparent, extract, background, or shape the alpha channel</td>
  ...
  <tr>
    <td><a href="/command-line-options/#compare">-compare</a></td>
    <td>compare image</td>
  </tr>
  ...
  <tr>
    <td><a href="/command-line-options/#ift">-ift</a></td>
