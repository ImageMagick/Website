...
<dl>
  ...
  <dt><a href="http://boundforhealth.com"> <img class="clearfix" src="https://www.imagemagick.org/image/boundforhealth.png" width="342" height="105" alt="[Bound for Health]" /></a>  BoundForHealth &#8211; Change Course.  Cure disease.  Be well.</dt><br/>
</dl>
...
<ul>
<dt><img src="<?php echo $_SESSION['RelativePath']?>/../image/litecoin.png" alt="Click to Donate to ImageMagick via Litecoin" title="Click to Donate to ImageMagick via Litecoin" width="256" height="256" /></dt>
</ul>
<h3>Check</h3>
