...
<ul>
<dt class="col-md-4"><img src="<?php echo $_SESSION['RelativePath']?>/../image/bitcoin.png" alt="Click to Donate to ImageMagick via Bitcoin" title="Click to Donate to ImageMagick via Bitcoin" width="297" height="297" /></dt>
</ul>
</fieldset>
<br/>
