<div>
<p class="lead"><a href="/image/wizard.png" title="And Now a Touch of Magick"><img class="img-fluid border rounded-3 shadow-lg mb-4" style="float: left; margin-right: 10px;" id="logo" alt="And Now a Touch of Magick" width="265" height="352" src="/image/wizard.jpg" /></a> ImageMagick<sup><a href="http://tarr.uspto.gov/servlet/tarr?regser=serial&amp;entry=78333969" target="_blank">&#174;</a></sup> is a free, <a href="https://imagemagick.org/script/license.php">open-source</a> software suite, used for editing and manipulating digital images. It can be used to create, edit, compose, or convert bitmap images, and supports a wide range of file <a href="/script/formats.php">formats</a>, including JPEG, PNG, GIF, TIFF, and Ultra HDR.</p>
...
<p>The main website for ImageMagick can be found at <a href="https://imagemagick.org">https://imagemagick.org</a>. The most recent version available is <a href="/script/download.php">ImageMagick <?php echo MagickLibVersionText . MagickLibSubversion; ?></a>. The source code for this software can be accessed through a <a href="https://github.com/ImageMagick/ImageMagick" target="_blank">repository</a>. In addition, we maintain a legacy version of ImageMagick, <a href="https://legacy.imagemagick.org" target="_blank">version 6</a>.</p>

<p>Creating a security policy that fits your specific local environment before making use of ImageMagick is highly advised. You can find guidance on setting up this <a href="/script/security-policy.php">policy</a>. Also, it's important to verify your policy using the <a href="https://imagemagick-secevaluator.doyensec.com/">validation tool</a>.</p>
...
<table class="table table-sm table-hover table-striped table-responsive">
  ...
  <tr>
    <td><a href="/script/multispectral-imagery.php">Multispectral imagery</a></td>
