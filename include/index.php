...
<p>The main website for ImageMagick can be found at <a href="https://imagemagick.org">https://imagemagick.org</a>. The most recent version available is <a href="/download/">ImageMagick <?php echo MagickVersion; ?></a>. The source code for this software can be accessed through a <a href="https://github.com/ImageMagick/ImageMagick" rel="noopener noreferrer" target="_blank">repository</a>. In addition, we maintain a legacy version of ImageMagick, <a href="https://legacy.imagemagick.org" rel="noopener noreferrer" target="_blank">version 6</a>. Read our <a href="/porting/">porting</a> guide for comprehensive details on transitioning from version 6 to version 7.</p>
