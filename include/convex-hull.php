...
<ul><img class="img-fluid img-thumbnail" src="/image/convex-hull.png" alt="[Convex Hull]" width="250" height="250" name="convert-hull" /></ul>
...
<ul><img class="img-fluid img-thumbnail" src="/image/convex-hull-blocks.png" alt="[Convex Hull Blocks]" width="128" height="128" name="convert-hull-blocks" /></ul>
...
<ul><img class="img-fluid img-thumbnail" src="/image/convex-hull-blocks-closure.png" alt="[Convex Hull Blocks Closure]" width="128" height="128" name="convert-hull" /></ul>

<p>Finally, here is an example with a non-constant, non-black background using -fuzz to determine the background color:</p>

<ul><img class="img-fluid img-thumbnail" src="/image/convex-hull-barn.jpg" alt="[Convex Hull Barn]" width="250" height="250" name="convert-hull-barn" /></ul>
...
<ul><img class="img-fluid img-thumbnail" src="/image/convex-hull-barn-closure.jpg" alt="[Convex Hull Barn Closure]" width="250" height="250" name="convert-hull-barn-closure" /></ul>
