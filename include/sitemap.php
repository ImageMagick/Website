...
<p class="lead">Use this ImageMagick sitemap to quickly jump to one of the areas of interest listed below.  If you can't find what you want on this page, try our <a href="/search/?q=ImageMagick&sa=">site search</a>.</p>

<h2><a class="anchor" id="overview"></a>Overview</h2>

<dl >
  <li><a href="/">Introduction</a>: convert, edit, or compose images from the command-line or program interface.</li>
  <li><a href="/examples/">Examples of ImageMagick usage</a>: a few examples that show what you can do with an image using ImageMagick.</li>
  ...
  <li><a href="/security-policy/">Security policy</a>: best practices strongly encourage you to configure a security policy that suits your local environment.</li>
  ...
  <li><a href="/privacy-policy/">Privacy policy</a>: we do not collect personal identifier information.</li>
  <li><a href="/porting/">ImageMagick version 7</a>: learn how ImageMagick version 7 differs from previous versions.</li>
...
<dl >
    <li><a href="/install-source/">Install from source</a>: ImageMagick builds under Windows, macOS, and Linux.</li>
</dl>
...
<dl >
  ...
  <ul >
    ...
    <li><a href="/magick-wand/">MagickWand</a>: convert, compose, and edit images from the C language.</li>
...
<dl >
  ...
  <li><a href="/motion-picture/">Motion picture digital images</a>: use SMPTE DPX Version 2.0 to process images used by the motion picture (film and high-definition) industry.</li>
...
<table class="table table-sm table-hover table-striped table-responsive">
  ...
  <tr>
    <td><a href="/color-management/">Color management</a></td>
  ...
  <tr>
    <td><a href="/architecture/#multispectral">Multispectral imagery</a></td>
