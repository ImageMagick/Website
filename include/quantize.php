...
<p>These errors are measured and printed when the <a href="/command-line-options/#colors">-colors</a> and <a href="/command-line-options/#verbose">-verbose</a> options are specified on the <a href="<?php echo $_SESSION['RelativePath']?>/../script/magick.php">magick</a> command line:</p>
