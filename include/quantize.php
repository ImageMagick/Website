...
<pre class="p-3 mb-2 bg-light text-dark"><samp>total nodes = 1+Sum(8^i), i=1,k
...
<pre class="p-3 mb-2 bg-light text-dark"><samp>For Cmax=255,
...
<pre class="p-3 mb-2 bg-light text-dark"><samp>Ep = 0
