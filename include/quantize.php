...
<pre class="bg-light text-dark mx-4"><samp>total nodes = 1+Sum(8^i), i=1,k
...
<pre class="bg-light text-dark mx-4"><samp>For Cmax=255,
...
<pre class="bg-light text-dark mx-4"><samp>Ep = 0
