...
<ul><pre class="pre-scrollable bg-light text-dark"><samp>magick -background none -size 960x960 xc:black \( xc:darkred -duplicate 1 +append \) \
  ...
  -background black -flatten -brightness-contrast 20,20 -normalize dragonFire.png</samp></pre></ul>
