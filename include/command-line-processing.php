...
<pre class="bg-light text-dark mx-4"><samp>magick image.jpg image.png </samp></pre>

<p>Or it can be complex with a plethora of <a href="#option">options</a>, as in the following:</p>

<pre class="bg-light text-dark mx-4"><samp>magick label.gif +matte \
...
<pre class="bg-light text-dark mx-4"><samp>magick -size 320x90 canvas:none -stroke snow4 -size 1x90 -tile gradient:white-snow4 \
...
<pre class="pre-scrollable bg-light text-dark mx-4"><samp>magick -background none -size 960x960 xc:black \( xc:darkred -duplicate 1 +append \) \
...
<pre class="bg-light text-dark mx-4"><samp>magick *.jpg images.gif</samp></pre>
...
<pre class="bg-light text-dark mx-4"><samp>magick -size 640x480 -depth 8 rgb:image image.png</samp></pre>
...
<pre class="bg-light text-dark mx-4"><samp>magick -size 640x480 pattern:checkerboard checkerboard.png</samp></pre>
...
<pre class="bg-light text-dark mx-4"><samp>magick logo: gif:- | magick display gif:-</samp></pre>
...
<pre class="bg-light text-dark mx-4"><samp>magick rose: gif:- | magick - -resize "200%" bigrose.jpg'</samp></pre>
...
<pre class="bg-light text-dark mx-4"><samp>magick fd:3 fd:4 -append fd:5</samp></pre>

<p>When needed, explicit image formats can be given as mentioned earlier, as in the following.
</p>

<pre class="bg-light text-dark mx-4"><samp>magick gif:fd:3 jpg:fd:4 -append tif:fd:5</samp></pre>
...
<pre class="bg-light text-dark mx-4"><samp>magick 'images.gif[0]' image.png</samp></pre>
...
<pre class="bg-light text-dark mx-4"><samp>magick 'images.gif[0-3]' images.mng</samp></pre>
...
<pre class="bg-light text-dark mx-4"><samp>magick -size 6000x4000 -depth 8 'rgb:image[600x400+1900+2900]' image.jpg</samp></pre>

<p>
  You can get the same results with the <?php option("extract"); ?> option:
</p>

<pre class="bg-light text-dark mx-4"><samp>magick -size 6000x4000 -depth 8 -extract 600x400+1900+2900 rgb:image image.jpg</samp></pre>
...
<pre class="bg-light text-dark mx-4"><samp>magick '*.jpg' -resize 120x120 thumbnail%03d.png</samp></pre>
...
<pre class="bg-light text-dark mx-4"><samp>magick '*.jpg[120x120]' thumbnail%03d.png</samp></pre>
...
<pre class="bg-light text-dark mx-4"><samp>magick '*.jpg' -crop 120x120+10+5 thumbnail%03d.png</samp></pre>
...
<pre class="bg-light text-dark mx-4"><samp>magick '*.jpg[120x120+10+5]' thumbnail%03d.png</samp></pre>
...
<pre class="bg-light text-dark mx-4"><samp>magick @myimages.txt mymovie.gif</samp></pre>
...
<pre class="bg-light text-dark mx-4"><samp>magick image-%d.jpg[1-5]</samp></pre>
...
<pre class="bg-light text-dark mx-4"><samp>magick logo: gif:- | magick display -define stream:buffer-size=0 gif:-</samp></pre>
...
<pre class="bg-light text-dark mx-4"><samp>magick -channel RGB wand.png wizard.png images.png</samp></pre>
...
<pre class="bg-light text-dark mx-4"><samp>magick wand.png -negate wizard.png images.png</samp></pre>
...
<pre class="bg-light text-dark mx-4"><samp>magick mikayla.png picnic.png beach.png -append vacation.png</samp></pre>
...
<pre class="bg-light text-dark mx-4"><samp>magick logo: -resize '200%' bigWiz.png
...
<pre class="bg-light text-dark mx-4"><samp>magick logo: -resize '100' wiz1.png
...
<pre class="bg-light text-dark mx-4"><samp>magick logo: -resize '10000@' wiz10000.png</samp></pre>
...
<pre class="bg-light text-dark mx-4"><samp>magick logo: -region '100x200+10+20' -negate wizNeg1.png
...
<pre class="bg-light text-dark mx-4"><samp>magick wand.gif \( wizard.gif -rotate 30 \) +append images.gif</samp></pre>
...
<pre class="bg-light text-dark mx-4"><samp>magick image.jpg rgb:image</samp></pre>
...
<pre class="bg-light text-dark mx-4"><samp>magick rose: -set filename:area '%wx%h' 'rose-%[filename:area].png'</samp></pre>
...
<pre class="bg-light text-dark mx-4"><samp>magick *.jpg +adjoin page-%d.pdf</samp></pre>
...
<pre class="bg-light text-dark mx-4"><samp>magick -define stream:buffer-size=0 logo: gif:- | magick display gif:-</samp></pre>
</div>
