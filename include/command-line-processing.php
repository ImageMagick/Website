...
<pre><code>convert label.gif +matte \
...
<pre><code>convert -size 320x90 canvas:none -stroke snow4 -size 1x90 -tile gradient:white-snow4 \
...
<pre><code>convert *.jpg images.gif</code></pre>
...
<pre><code>convert -size 640x480 -depth 8 rgb:image image.png</code></pre>
...
<pre><code>convert -size 640x480 pattern:checkerboard checkerboard.png</code></pre>
...
<pre><code>convert logo: gif:- | display gif:-</code></pre>
...
<pre><code>convert rose: gif:- | magick - -resize "200%" bigrose.jpg'</code></pre>
...
<pre><code>convert fd:3 fd:4 -append fd:5</code></pre>

<p>When needed, explicit image formats can be given as mentioned earlier, as in the following.
</p>

<pre><code>convert gif:fd:3 jpg:fd:4 -append tif:fd:5</code></pre>
...
<pre><code>convert 'images.gif[0]' image.png</code></pre>
...
<pre><code>convert 'images.gif[0-3]' images.mng</code></pre>
...
<pre><code>convert 'images.gif[3,2,4]' images.mng</code></pre>
...
<pre><code>convert -size 6000x4000 -depth 8 'rgb:image[600x400+1900+2900]' image.jpg</code></pre>

<p>
  You can get the same results with the <?php option("extract"); ?> option:
</p>

<pre><code>convert -size 6000x4000 -depth 8 -extract 600x400+1900+2900 rgb:image image.jpg</code></pre>
...
<pre><code>convert '*.jpg' -resize 120x120 thumbnail%03d.png</code></pre>
...
<pre><code>convert '*.jpg[120x120]' thumbnail%03d.png</code></pre>
...
<pre><code>convert '*.jpg' -crop 120x120+10+5 thumbnail%03d.png</code></pre>
...
<pre><code>convert '*.jpg[120x120+10+5]' thumbnail%03d.png</code></pre>
...
<pre><code>convert @myimages.txt mymovie.gif</code></pre>
...
<pre><code>convert image-%d.jpg[1-5]</code></pre>
...
<pre><code>convert logo: gif:- | display -define stream:buffer-size=0 gif:-</code></pre>
...
<pre><code>convert -channel RGB wand.png wizard.png images.png</code></pre>
...
<pre><code>convert wand.png -negate wizard.png images.png</code></pre>
...
<pre><code>convert mikayla.png picnic.png beach.png -append vacation.png</code></pre>
...
<pre><code>convert logo: -resize '200%' bigWiz.png
...
<pre><code>convert logo: -resize '100' wiz1.png
...
<pre><code>convert logo: -resize '10000@' wiz10000.png</code></pre>
...
<pre><code>convert logo: -region '100x200+10+20' -negate wizNeg1.png
...
<pre><code>convert wand.gif \( wizard.gif -rotate 30 \) +append images.gif</code></pre>
...
<pre><code>convert image.jpg rgb:image</code></pre>
...
<pre><code>convert rose: -set filename:area '%wx%h' 'rose-%[filename:area].png'</code></pre>
...
<pre><code>convert *.jpg +adjoin page-%d.pdf</code></pre>
...
<pre><code>convert -define stream:buffer-size=0 logo: gif:- | display gif:-</code></pre>
</div>
