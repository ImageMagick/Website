...
<pre class="p-3 mb-2 bg-light text-dark">  blur
  contrast
  charcoal
  function
  grayscale
...
<pre class="p-3 mb-2 bg-light text-dark">  despeckle
  equalize
  modulate</pre>
    </li>
</ol>
...
<pre class="p-3 mb-2 bg-light text-dark cli"><samp>MAGICK_OCL_DEVICE=true magick sample.jpg -blur 0x5 null:</samp></pre>
...
<pre class="p-3 mb-2 bg-light text-dark"><samp>clEnv=GetCurrentOpenCLEnv();
