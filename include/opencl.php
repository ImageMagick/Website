...
<pre class="bg-light text-dark mx-4">  blur
  contrast
  charcoal
  function
  grayscale
...
<pre class="bg-light text-dark mx-4">  despeckle
  equalize
  modulate</pre>
    </li>
</ol>
...
<pre class="bg-light text-dark mx-4 cli"><samp>MAGICK_OCL_DEVICE=true magick sample.jpg -blur 0x5 null:</samp></pre>
...
<pre class="bg-light text-dark mx-4"><samp>clEnv=GetCurrentOpenCLEnv();
