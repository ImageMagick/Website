...
<pre class="pre-scrollable bg-light"><code>ImageMagick is configured as follows. Please verify that this configuration
...
<table class="table table-sm table-hover">
  ...
  <br /><br />
<pre class="bg-light"><code>Quantum Depth     Valid Range (Decimal)   Valid Range (Hex)
    8             0-255                   00-FF
  ...
  <br /><br />
<pre class="bg-light"><code>Quantum Depth   Virtual Memory
     8               3MB
    16               8MB
    32              15MB
</code></pre></td>
...
<pre class="bg-light"><code>magick logo: logo.gif
identify logo.gif
</code></pre>
...
<pre class="bg-light"><code>magick identify -list configure
</code></pre>
...
<pre class="bg-light"><code>no decode delegate for this image format
