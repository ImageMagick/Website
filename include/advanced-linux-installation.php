...
<pre class="bg-light text-dark"><samp>tar xvzf ImageMagick.tar.gz</samp></pre>
...
<pre class="pre-scrollable bg-light text-dark"><samp>ImageMagick is configured as follows. Please verify that this configuration
...
<pre class="bg-light text-dark"><samp>configure CC=c99 CFLAGS=-O2 LDFLAGS='-L/usr/local/lib -R/usr/local/lib' LIBS=-lposix</samp></pre>
...
<table class="table table-sm table-hover">
  ...
  <br /><br />
<pre class="bg-light text-dark"><samp>Quantum Depth     Valid Range (Decimal)   Valid Range (Hex)
    8             0-255                   00-FF
  ...
  <br /><br />
<pre class="bg-light text-dark"><samp>Quantum Depth   Virtual Memory
     8               3MB
    16               8MB
    32              15MB</samp></pre>
</td>
...
<pre class="bg-light text-dark"><samp>make </samp></pre>
...
<pre class="bg-light text-dark"><samp>make install </samp></pre>
...
<pre class="bg-light text-dark"><samp>magick logo: logo.gif
...
<pre class="bg-light text-dark"><samp>magick identify -list configure</samp></pre>
...
<pre class="bg-light text-dark"><samp>make check</samp></pre>
...
<pre class="bg-light text-dark"><samp>rpmbuild --rebuild ImageMagick.src.rpm</samp></pre>
...
<pre class="bg-light text-dark"><samp>sudo port -v install freetype +bytecode
...
<pre class="bg-light text-dark"><samp>sudo port install jpeg </samp></pre>
...
<pre class="bg-light text-dark"><samp>./configure --prefix=/opt --with-quantum-depth=16 \
...
<pre class="bg-light text-dark"><samp>sudo make install </samp></pre>
  <p>To verify your install, type</p>

<pre class="bg-light text-dark"><samp>/opt/local/bin/identify -list font </samp></pre>

  <p>to list all the fonts ImageMagick knows about.</p>
	  <p>To test the ImageMagick GUI, in a new shell, type:</p>

<pre class="bg-light text-dark"><samp>display -display :0 </samp></pre>
...
<pre class="bg-light text-dark"><samp>configure LDFLAGS='-L/usr/local/lib -R/usr/local/lib' </samp></pre>
...
<pre class="bg-light text-dark"><samp>/sbin/ldconfig /usr/local/lib </samp></pre>
...
<pre class="bg-light text-dark"><samp>ldd `which convert` </samp></pre>

<h4>Delegate Libraries</h4>
<p>On occasion you may receive these warnings:</p>
<pre class="bg-light text-dark"><samp>no decode delegate for this image format
...
<pre class="bg-light text-dark"><samp>yum install libjpeg libjpeg-devel </samp></pre>
