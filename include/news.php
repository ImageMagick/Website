...
<p>Creating a security policy that fits your specific local environment before making use of ImageMagick is highly advised. You can find guidance on setting up this <a href="/security-policy/">policy</a>. Also, it's important to verify your policy using the <a href="https://imagemagick-secevaluator.doyensec.com/">validation tool</a>.  As of ImageMagick version 7.1.1-16, you can choose and customize one of these <a href="/security-policy/">security policies</a>: Open, Limited, Secure, and Websafe.<p>
...
<p><a href="https://github.com/snibgo">@Snibgo</a> contributed a <a href="/fx/">Fx</a> special-effects image operator interpreter.  It has vastly improved error checking and performance.</p>
...
<ul>
<li>add more memory to your system, see <a href="/architecture/#cache">the pixel cache</a>;</li>
<li>add more cores to your system, see <a href="/architecture/#threads">threads of execution support</a>;</li>
...
<p>Now that ImageMagick version 7 is released, we continue to maintain the legacy release of ImageMagick, version 6, at <a href="https://legacy.imagemagick.org/">https://legacy.imagemagick.org</a>.  Learn how ImageMagick version 7 differs from previous versions with our <a href="/porting/">porting guide</a>.</p>
</div>
