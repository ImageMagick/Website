...
<p>With recent releases of ImageMagick 7, we continue to evolve our support of <a href="/script/multispectral-imagery.php">Multispectral imagery</a>.  PSD, TIFF, MIFF, MPC, and FTXT can now read and write multispectral images with more multispectral formats to follow.</p>
...
<ul>
<li>add more memory to your system, see <a href="/script/architecture.php#cache">the pixel cache</a>;</li>
<li>add more cores to your system, see <a href="/script/architecture.php#threads">threads of execution support</a>;</li>
...
<p>Now that ImageMagick version 7 is released, we continue to maintain the legacy release of ImageMagick, version 6, at <a href="https://legacy.imagemagick.org/">https://legacy.imagemagick.org</a>.  Learn how ImageMagick version 7 differs from previous versions with our <a href="/script/porting.php">porting guide</a>.</p>
</div>
