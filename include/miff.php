...
<table class="table table-sm table-hover table-striped table-responsive">
  ...
  <tr>
    ...
    <td>these optional keys reflect the image background, border, and matte colors respectively.  A <a href="/color/">color</a> can be a name (e.g. white) or a hex value (e.g. #ccc).</td>
  </tr>
  <tr>
