...
<pre class="bg-light text-dark mx-4"><samp>$ magick identify -verbose image.jpg
Image: image.jpg
...
<pre class="bg-light text-dark mx-4"><samp>$ magick image.jpg -print "%[colorspace]\n" null:
sRGB </samp></pre>
...
<table class="table table-sm table-hover table-striped table-responsive">
  ...
  <tr>
    ...
    <td>Requires the <a href="https://gitlab.com/ImageMagick/MagickCache">MagickCache</a> delegate library.  Supported options include <samp>dmr:path</samp> (location of repository), <samp>dmr:passkey</samp> (key to open digital media respository), <samp>dmr:passphrase</samp> (optionally scramble or unscramble media resource), and <samp>dmr:ttl</samp> (time-to-live).</td>
  </tr>
