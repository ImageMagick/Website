...
<table class="table table-sm table-hover table-striped table-responsive">
  ...
  <tr>
    ...
    <td>Requires the <a href="https://jxrlib.codeplex.com/">jxrlib</a> delegate library. Put the JxrDecApp and JxrEncApp applications in your execution path. Add the <samp>-define quantum:format=floating-point</samp> option to minimize distortion.</td>
  </tr>
