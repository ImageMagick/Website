...
<table class="table table-sm table-hover table-striped table-responsive">
  ...
  <tr>
    ...
    <td>Requires the <a href="https://gitlab.com/ImageMagick/MagickCache">MagickCache</a> delegate library.  Supported options include <samp>dmr:path</samp>, <samp>dmr:passkey</samp>, <samp>dmr:passphrase</samp>, and <samp>dmr:ttl</samp>.</td>
  </tr>
