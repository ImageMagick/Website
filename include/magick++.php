...
<pre class="bg-light text-dark"><samp>c++ `Magick++-config --cxxflags --cppflags` -O2 -o demo demo.cpp \
...
<pre class="bg-light text-dark"><samp>export PKG_CONFIG_PATH=/usr/local/lib/pkgconfig </samp></pre>
...
<pre class="bg-light text-dark"><samp>int main( int argc, char ** argv) {
