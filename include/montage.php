...
<pre class="bg-light text-dark"><samp>magick montage -background '#336699' -geometry +4+4 rose.jpg red-ball.png montage.jpg </samp></pre>
...
<pre class="bg-light text-dark"><samp>magick montage -label %f -frame 5 -background '#336699' -geometry +4+4 rose.jpg red-ball.png frame.jpg </samp></pre>
...
<pre class="bg-light text-dark"><samp>magick '*.png' -resize 320x320 -label %f ashlar:ashlar.png</samp></pre>
