...
<p class="lead">Use the <samp>montage</samp> program to create a composite image by combining several separate images.  The images are tiled on the composite image optionally adorned with a border, frame, image name, and more. See <a href="/command-line-processing/">Command Line Processing</a> for advice on how to structure your <samp>montage</samp> command or see below for example usages of the command.</p>
...
<p>You can find additional examples of using <samp>montage</samp> at <a href="https://usage.imagemagick.org/montage/">Examples of ImageMagick Usage</a> and <a href="https://usage.imagemagick.org/">Examples of ImageMagick Usage</a>.</p>
...
transparent, extract, background, or shape the alpha channel</td>
  ...
  <tr>
    <td><a href="/command-line-options/#clone">-clone <var>index</var></a></td>
 ...
 <tr>
  ...
  <tr>
    <td><a href="/command-line-options/#mode">-mode <var>type</var></a></td>
    <td>framing style</td>
  </tr>
  ...
  <tr>
    <td><a href="/command-line-options/#origin">-origin <var>geometry</var></a></td>
    <td>image origin</td>
  </tr>
  ...
  <tr>
    <td><a href="/command-line-options/#scenes">-scenes <var>range</var></a></td>
  ...
  <tr>
    <td><a href="/command-line-options/#tile">-tile <var>geometry</var></a></td>
  ...
  <tr>
    <td><a href="/command-line-options/#title">-title</a></td>
