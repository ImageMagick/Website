...
<pre class="bg-light text-dark"><samp>%[artifact:<var>setting</var>]
...
<pre class="bg-light text-dark"><samp>-> identify -format "%m:%f %wx%h" bird.miff
...
<pre class="bg-light text-dark"><samp>magick ... \
...
<pre class="bg-light text-dark"><samp>%[fx:<var>expression</var>] </samp></pre>
...
<pre class="bg-light text-dark"><samp>%[pixel:<var>expression</var>] </samp></pre>
...
<pre class="bg-light text-dark"><samp>%[EXIF:<var>tag</var>] </samp></pre>
...
<pre class="bg-light text-dark"><samp>%[IPTC:<var>dataset</var>:<var>record</var>] </samp></pre>
