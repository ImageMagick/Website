<div class="magick-header"><dl><dt>2015-11-14  6.9.2-6 Cristy  &lt;quetzlzacatenango@image...&gt;</dt>
...
<dt>2015-11-08  6.9.2-6 Cristy  &lt;quetzlzacatenango@image...&gt;</dt>
  ...
  <li> Eliminate stack overflow (reference    https://www.imagemagick.org/discourse-server/viewtopic.php?f=1&amp;t=28658).</li>
<dt>2015-11-03  6.9.2-6 Dirk Lemstra &lt;dirk@lem.....org&gt;</dt>
  <li> Added local contrast enhancement.</li>
  <li> Fixed bug in SetPixelCacheExtent that made images all black (reference    https://www.imagemagick.org/discourse-server/viewtopic.php?f=3&amp;t=28514).</li>
...
<dt>2015-11-02  6.9.2-6 Samuel Thibault &lt;samuel.thibault@...org&gt; </dt>
  <li> Added 6dot variant for unicode and iso braille formats (reference    https://www.imagemagick.org/discourse-server/viewtopic.php?f=2&amp;p=127111).</li>
...
<dt>2015-10-15  6.9.2-5 Dirk Lemstra &lt;dirk@lem.....org&gt;</dt>
  <li> Fixed alpha blending issue with semi-transparent pixels in the merged    image of PSD files. This can be disabled by setting the option    'psd:alpha-unblend' to 'off' (reference    https://www.imagemagick.org/discourse-server/viewtopic.php?f=3&amp;t=28169).</li>
  <li> Fixed issue in jpeg:extent that prevented it from working (reference    https://www.imagemagick.org/discourse-server/viewtopic.php?f=3&amp;p=126638).</li>
...
<dt>2015-10-12  6.9.2-5 Cristy  &lt;quetzlzacatenango@image...&gt;</dt>
  ...
  <li> Recognize label:@- as stdin (reference    https://www.imagemagick.org/discourse-server/viewtopic.php?f=3&amp;t=28501).</li>
...
<dt>2015-10-08  6.9.2-4 Dirk Lemstra &lt;dirk@lem.....org&gt;</dt>
  <li> Fixed accessing subimage in a TIFF photoshop layer (reference    https://www.imagemagick.org/discourse-server/viewtopic.php?f=3&amp;t=28469).</li>
  <li> Fixed out of bounds error in -splice (reference    https://www.imagemagick.org/discourse-server/viewtopic.php?f=3&amp;t=28466).</li>
...
<dt>2015-09-22  6.9.2-4 Cristy  &lt;quetzlzacatenango@image...&gt;</dt>
  ...
  <li> Specify histogram code image format implictedly (reference    https://www.imagemagick.org/discourse-server/viewtopic.php?f=3&amp;t=28412).</li>
  <li> Don't round up for JPEG image resolution (reference    https://www.imagemagick.org/discourse-server/viewtopic.php?f=1&amp;t=28422).</li>
...
<dt>2015-09-16  6.9.2-2 Cristy  &lt;quetzlzacatenango@image...&gt;</dt>
  ...
  <li> Use modern idiom for autoconf    Fix a forgotten dir when regenerating html doc (reference    https://www.imagemagick.org/discourse-server/viewtopic.php?f=3&amp;t=28363).</li>
  <li> The -colorspace gray option no long leaves a ghostly shadow (reference    https://www.imagemagick.org/discourse-server/viewtopic.php?f=3&amp;t=28350).</li>
...
<dt>2015-09-13  6.9.2-1 Dirk Lemstra &lt;dirk@lem.....org&gt;</dt>
  <li> Preserving image origin in TGA files (reference    https://www.imagemagick.org/discourse-server/viewtopic.php?f=1&amp;t=28310).</li>
<dt>2015-08-15  6.9.2-1 Cristy  &lt;quetzlzacatenango@image...&gt;</dt>
  ...
  <li> The first argument of a hsl() color is integer, not percentage (reference    https://www.imagemagick.org/discourse-server/viewtopic.php?f=2&amp;t=26072).</li>
  <li> Limit -fx recursive to avoid stack overflow (reference    https://www.imagemagick.org/discourse-server/viewtopic.php?f=3&amp;t=28200).</li>
  <li> Support inline images with data URLS.</li>
  <li> Report progress less often (reference    https://www.imagemagick.org/discourse-server/viewtopic.php?f=3&amp;t=28299).</li>
...
<dt>2015-08-10  6.9.2-0 Cristy  &lt;quetzlzacatenango@image...&gt;</dt>
  <li> Swap pixels for -spread command-line option (reference    https://www.imagemagick.org/discourse-server/viewtopic.php?f=1&amp;t=28043).</li>
  <li> fx logical operations short circuit (reference    https://www.imagemagick.org/discourse-server/viewtopic.php?f=3&amp;t=28179).</li>
  <li> Type cast intensity variable (reference    https://www.imagemagick.org/discourse-server/viewtopic.php?f=3&amp;t=28182).</li>
  <li> Fix ModulusAdd &amp; ModulusSubstract for HDRI compositing (reference    https://www.imagemagick.org/discourse-server/viewtopic.php?f=3&amp;t=28186).</li>
<dt>2015-07-25  6.9.2-0 Dirk Lemstra &lt;dirk@lem.....org&gt;</dt>
  ...
  <li> Fixed reading Photoshop layers of LSB TIFF files (reference    https://www.imagemagick.org/discourse-server/viewtopic.php?f=1&amp;t=28045).</li>
  <li> Fixed memory leak in font cache under Windows (reference    https://www.imagemagick.org/discourse-server/viewtopic.php?f=6&amp;t=28191).</li>
...
<dt>2015-07-18  6.9.1-10 Dirk lemstra &lt;dirk@lem.....org&gt;</dt>
  <li> Removed incorrect EOF check in the DDS reader (reference    https://www.imagemagick.org/discourse-server/viewtopic.php?f=3&amp;t=28065).</li>
<dt>2015-07-18  6.9.1-10 Cristy  &lt;quetzlzacatenango@image...&gt;</dt>
  <li> Fixed undefined behaviors (reference    https://www.imagemagick.org/discourse-server/viewtopic.php?f=3&amp;t=28067).</li>
  <li> Return exception message for unknown image properties.</li>
  <li> Color shift removed when reading transparent gray images (reference    https://www.imagemagick.org/discourse-server/viewtopic.php?f=3&amp;t=28081)</li>
...
<dt>2015-07-12  6.9.1-9 Dirk Lemstra &lt;dirk@lem.....org&gt;</dt>
  <li> Fixed issue with radial gradient in MVG (reference    https://www.imagemagick.org/discourse-server/viewtopic.php?f=3&amp;t=27995).</li>
...
<dt>2015-06-25  6.9.1-8 Cristy  &lt;quetzlzacatenango@image...&gt;</dt>
  ...
  <li> Different gif cropping behavior between versions (reference    https://www.imagemagick.org/discourse-server/viewtopic.php?f=3&amp;t=28013).</li>
  <li> Cannot read properly simple psd file (reference    https://www.imagemagick.org/discourse-server/viewtopic.php?f=3&amp;t=28002).</li>
...
<dt>2015-06-27  6.9.1-7 Eric Dalquist</dt>
  <li> Fixed and escaped output of the json coder. (reference    https://www.imagemagick.org/discourse-server/viewtopic.php?f=3&amp;p=27894).</li>
<dt>2015-06-25  6.9.1-7 Cristy  &lt;quetzlzacatenango@image...&gt;</dt>
  <li> Support BPG image format (respects -quality option).</li>
  <li> A bordered transparent image now remains transparent (reference    https://www.imagemagick.org/discourse-server/viewtopic.php?f=5&amp;t=27937).</li>
  <li> The -update option behavior restored (reference    https://www.imagemagick.org/discourse-server/viewtopic.php?f=1&amp;t=27939).</li>
...
<dt>2015-06-14  6.9.1-6 Cristy  &lt;quetzlzacatenango@image...&gt;</dt>
  ...
  <li> Add an additional check for end-of-file for the RLE coder (reference    https://www.imagemagick.org/discourse-server/viewforum.php?f=3&amp;t=27870).</li>
...
<dt>2015-06-03  6.9.1-5 Cristy  &lt;quetzlzacatenango@image...&gt;</dt>
  ...
  <li> DrawGetVectorGraphics() now returns proper XML (reference    https://www.imagemagick.org/discourse-server/viewtopic.php?f=3&amp;t=27751).</li>
  <li> Support writing EXR files with different color types (reference    https://www.imagemagick.org/discourse-server/viewtopic.php?f=2&amp;t=27759).</li>
  ...
  <li> Resolve undefined behaviors (reference    https://www.imagemagick.org/discourse-server/viewtopic.php?f=3&amp;t=27811).</li>
...
<dt>2015-05-03  6.9.1-3 Dirk Lemstra &lt;dirk@lem.....org&gt;</dt>
  <li> Fixed transparency issue with 16-bit tga files (reference    https://www.imagemagick.org/discourse-server/viewtopic.php?f=3&amp;t=27469).</li>
  <li> Fixed writing label and comment in tiff images (reference    https://www.imagemagick.org/discourse-server/viewtopic.php?f=3&amp;t=25516).</li>
  <li> Jpeg images no longer have pixels per inch as a default value for density    units when the density is not set (reference    https://www.imagemagick.org/discourse-server/viewtopic.php?f=3&amp;t=27589).</li>
...
<dt>2015-05-03  6.9.1-3 Glenn Randers-Pehrson &lt;glennrp@image...&gt;</dt>
  ...
  <li> Avoid palette-building when writing a grayscale PNG (reference    https://www.imagemagick.org/discourse-server/viewtopic.php?f=3&amp;t=27580).</li>
<dt>2015-04-20  6.9.1-3 Cristy  &lt;quetzlzacatenango@image...&gt;</dt>
  <li> Support -define compose:clamp=false option (reference    https://www.imagemagick.org/discourse-server/viewtopic.php?f=3&amp;t=26946).</li>
  ...
  <li> Draw a rectangle of width &amp; height of 1 (reference    https://www.imagemagick.org/discourse-server/viewtopic.php?f=3&amp;t=24874).</li>
...
<dt>2015-04-07  6.9.1-2 Cristy  &lt;quetzlzacatenango@image...&gt;</dt>
  <li> Fix JPEG-2000 transparency on write (reference    https://www.imagemagick.org/discourse-server/viewtopic.php?f=3&amp;t=27304).</li>
  <li> Identify now identifies PSD (reference    https://www.imagemagick.org/discourse-server/viewtopic.php?f=3&amp;t=26948).</li>
  <li> Speed up writing to TGA (reference    https://www.imagemagick.org/discourse-server/viewtopic.php?f=3&amp;t=27369).</li>
<dt>2015-04-06  6.9.1-2 Dirk Lemstra &lt;dirk@lem.....org&gt;</dt>
  <li> Reduce draw epsilon to increase mathematical stability.</li>
  <li> Fixed UTF8 issue when determining the current working directory    on Windows (reference    https://www.imagemagick.org/discourse-server/viewtopic.php?f=3&amp;t=27295).</li>
...
<dt>2015-03-21  6.9.1-1 Cristy  &lt;quetzlzacatenango@image...&gt;</dt>
  <li> Skip empty frames when comparing layers (reference    https://www.imagemagick.org/discourse-server/viewtopic.php?f=3&amp;t=27234).</li>
...
<dt>2015-03-17  6.9.1-0 Cristy  &lt;quetzlzacatenango@image...&gt;</dt>
  <li> Grayscale DPX image files are no longer skewed (reference    https://www.imagemagick.org/discourse-server/viewtopic.php?f=3&amp;t=27209).</li>
<dt>2015-03-16  6.9.1-0 Glenn Randers-Pehrson &lt;glennrp@image...&gt;</dt>
  <li> Fix integer overflow when scaling a 1-bit sample to Q64 (reference    https://www.imagemagick.org/discourse-server/viewtopic.php?f=3&amp;t=27195).</li>
...
<dt>2015-03-03  6.9.0-10 Cristy  &lt;quetzlzacatenango@image...&gt;</dt>
  ...
  <li> Set an upper ceiling compression with -quality and jpeg:extent (reference    https://www.imagemagick.org/discourse-server/viewtopic.php?f=2&amp;t=27071).</li>
...
<dt>2015-02-22  6.9.0-9 Cristy  &lt;quetzlzacatenango@image...&gt;</dt>
  <li> Writing histograms / mpeg working again (reference    https://www.imagemagick.org/discourse-server/viewtopic.php?f=3&amp;t=27089).</li>
  <li> The -linear-stretch option worked for Q16 but not Q32 (reference    https://www.imagemagick.org/discourse-server/viewtopic.php?f=3&amp;t=27112).</li>
...
<dt>2015-02-15  6.9.0-7 Cristy  &lt;quetzlzacatenango@image...&gt;</dt>
  <li> Line strokes appeared too thin (reference    https://www.imagemagick.org/discourse-server/viewtopic.php?f=3&amp;t=26927).</li>
  <li> Keep text in caption area (reference    https://www.imagemagick.org/discourse-server/viewtopic.php?f=3&amp;t=22504).</li>
...
<dt>2015-02-12  6.9.0-6 Dirk Lemstra &lt;dirk@lem.....org&gt;</dt>
  <li> Fixed command line execution in Windows for delegates that    move files (reference    https://www.imagemagick.org/discourse-server/viewtopic.php?f=1&amp;t=27027).</li>
<dt>2015-02-10  6.9.0-6 Cristy  &lt;quetzlzacatenango@image...&gt;</dt>
  <li> A transient bug for the write MSL element (reference    https://www.imagemagick.org/discourse-server/viewtopic.php?f=3&amp;t=27022).</li>
...
<dt>2015-01-24  6.9.0-5 Dirk Lemstra &lt;dirk@lem.....org&gt;</dt>
  <li> Fixed iccColorProfile() in Magick++ (reference    https://www.imagemagick.org/discourse-server/viewtopic.php?f=2&amp;t=26910).</li>
  <li> Fixed infinite loop in HDR reader (reference    https://www.imagemagick.org/discourse-server/viewtopic.php?f=3&amp;t=26929).</li>
...
<dt>2015-01-07  6.9.0-4 Cristy  &lt;quetzlzacatenango@image...&gt;</dt>
  <li> Additional coder sanity checks (reference    https://www.imagemagick.org/discourse-server/viewtopic.php?f=3&amp;t=26842,    https://www.imagemagick.org/discourse-server/viewtopic.php?f=3&amp;t=26682).</li>
<dt>2015-01-05  6.9.0-4 Dirk Lemstra &lt;dirk@lem.....org&gt;</dt>
  ...
  <li> Fixed invalid path check in MagickCoreGenesis under Windows and disabled    ProvideDllMain by default (reference    https://www.imagemagick.org/discourse-server/viewtopic.php?f=3&amp;p=118875).</li>
<dt>2015-01-01  6.9.0-3 Cristy  &lt;quetzlzacatenango@image...&gt;</dt>
  <li> New version 6.9.0-3, SVN revision 17537.</li>
<dt>2015-01-01  6.9.0-3 Cristy  &lt;quetzlzacatenango@image...&gt;</dt>
  <li> ImageMagick builds when HDRI is enabled (reference    https://www.imagemagick.org/discourse-server/viewtopic.php?f=3&amp;t=26803).</li>
...
<dt>2014-12-14  6.9.0-1 Dirk Lemstra &lt;dirk@snakeware...&gt;</dt>
  ...
  <li> Fixed enabling alpha in 32-bit BMP files (reference    https://www.imagemagick.org/discourse-server/viewtopic.php?f=3&amp;t=26662).</li>
  <li> Added support for writing 16-bit TGA files (reference    https://www.imagemagick.org/discourse-server/viewtopic.php?f=1&amp;t=26693).</li>
...
<dt>2014-11-20  6.9.0-1 Glenn Randers-Pehrson &lt;glennrp@image...&gt;</dt>
  ...
  <li> Don't override gamma with 1.0 when reading a grayscale PNG image (reference    https://www.imagemagick.org/discourse-server/viewtopic.php?f=3&amp;t=26576).</li>
  <li> Update progress monitor for every PNG row instead of every pass (reference    https://www.imagemagick.org/discourse-server/viewtopic.php?f=1&amp;t=26589).</li>
...
<dt>2014-11-20  6.9.0-1 Cristy  &lt;quetzlzacatenango@image...&gt;</dt>
  ...
  <li> Transient problem with SVG (reference      https://www.imagemagick.org/discourse-server/viewtopic.php?f=3&amp;t=26587).</li>
  <li> Numerous buffer overflow fixes (thanks to Gynvael Coldwind and    Mateusz Jurczyk of the Google Security Team).</li>
  <li> Additional PNM sanity checks (reference    https://www.imagemagick.org/discourse-server/viewtopic.php?f=3&amp;t=26682).</li>
  <li> The SetImageBias() bias value is no longer ignored (reference    https://www.imagemagick.org/discourse-server/viewtopic.php?f=3&amp;t=25732).</li>
  <li> Area crop now returns the expected number of tiles (reference    https://www.imagemagick.org/discourse-server/viewtopic.php?f=3&amp;t=26701).</li>
  <li> Respect TGA ColorMapIndex field (reference    https://www.imagemagick.org/discourse-server/viewtopic.php?f=3&amp;t=26738).</li>
  <li> Clang does not support __alloc_size__, fix fabs() (reference    https://www.imagemagick.org/discourse-server/viewtopic.php?f=3&amp;t=26739).</li>
  <li> Support width and height resource limits.</li>
  <li> Don't read TIFF profiles when pinging (reference    https://www.imagemagick.org/discourse-server/viewtopic.php?f=2&amp;t=26670).</li>
...
<dt>2014-10-29  6.8.9-10 Cristy  &lt;quetzlzacatenango@image...&gt;</dt>
  <li> EXIF directory offsets must be greater than 0 (reference    https://www.imagemagick.org/discourse-server/viewtopic.php?f=3&amp;t=26456).</li>
  <li> Accept morphology kernels from files (reference    https://www.imagemagick.org/discourse-server/viewtopic.php?f=2&amp;t=26466).</li>
  <li> Don't optimize JPEG compression by default (reference    https://www.imagemagick.org/discourse-server/viewtopic.php?f=3&amp;t=26482).</li>
<dt>2014-10-26  6.8.9-10 Dirk Lemstra &lt;dirk@snakeware...&gt;</dt>
  <li> Added support for reading jpeg compressed YCCK tiff files (reference    https://www.imagemagick.org/discourse-server/viewtopic.php?f=3&amp;t=24412).</li>
  <li> Fixed reading DICOM files with big endian transfer syntax (reference    https://www.imagemagick.org/discourse-server/viewtopic.php?f=3&amp;t=26448).</li>
...
<dt>2014-09-30  6.8.9-9 Cristy  &lt;quetzlzacatenango@image...&gt;</dt>
  <li> Support xyY colorspace (reference    https://www.imagemagick.org/discourse-server/viewtopic.php?f=2&amp;t=26324).</li>
  <li> Reduce noise while preserving edges with the -kuwahara option.</li>
  <li> Off-by-one count when parsing an 8BIM profile.</li>
  <li> Locale.c won't build if uselocale found but strtod_l isn't (reference    https://www.imagemagick.org/discourse-server/viewtopic.php?f=3&amp;t=26362).</li>
...
<dt>2014-09-16  6.8.9-8 Cristy  &lt;quetzlzacatenango@image...&gt;</dt>
  <li> JPEG library version &gt;= 80 is thread safe (reference    https://www.imagemagick.org/discourse-server/viewtopic.php?f=2&amp;t=25495).</li>
<dt>2014-08-31  6.8.9-8 Dirk Lemstra &lt;dirk@snakeware...&gt;</dt>
  <li> Added support for some legacy dds formats (reference    https://www.imagemagick.org/discourse-server/viewtopic.php?f=2&amp;t=26184).</li>
...
<dt>2014-08-14  6.8.9-7 Cristy  &lt;quetzlzacatenango@image...&gt;</dt>
  <li> Fix off by one buglet when extracting profiles 8BIM (reference    https://www.imagemagick.org/discourse-server/viewtopic.php?f=3&amp;t=26095).</li>
<dt>2014-07-31  6.8.9-7 Dirk Lemstra &lt;dirk@snakeware...&gt;</dt>
  <li> Fixed bug when reading 1 bit PSD. (reference    https://www.imagemagick.org/discourse-server/viewtopic.php?f=3&amp;t=26015).</li>
...
<dt>2014-07-19  6.8.9-6 Dirk Lemstra &lt;dirk@snakeware...&gt;</dt>
  <li> Fixed fill-rule in SVG clip path (reference    https://www.imagemagick.org/discourse-server/viewtopic.php?f=2&amp;t=25882).</li>
...
<dt>2014-07-01  6.8.9-6 Cristy  &lt;quetzlzacatenango@image...&gt;</dt>
  <li> Write LAB pixels as percentages in the TXT image format (reference    https://www.imagemagick.org/discourse-server/viewtopic.php?f=3&amp;t=25830).</li>
  <li> Throw exception when image morphology differs when comparing (reference    https://www.imagemagick.org/discourse-server/viewtopic.php?f=3&amp;t=25927).</li>
  <li> Remove mogrify backup file (reference    https://www.imagemagick.org/discourse-server/viewtopic.php?f=3&amp;t=25683).</li>
  <li> Read WEBP images from STDIN (reference    https://www.imagemagick.org/discourse-server/viewtopic.php?f=3&amp;t=25886).</li>
...
<dt>2014-06-15  6.8.9-4 Cristy  &lt;quetzlzacatenango@image...&gt;</dt>
  ...
  <li> Pipe image to display program no longer reports an exception (reference    https://www.imagemagick.org/discourse-server/viewtopic.php?f=3&amp;t=23532).</li>
  <li> Check that profile is non-NULL in coders/tiff.c (reference    https://www.imagemagick.org/discourse-server/viewtopic.php?f=3&amp;t=25770).</li>
...
<dt>2014-06-07  6.8.9-3 Dirk Lemstra &lt;dirk@snakeware...&gt;</dt>
  <li> Fixed creation of SVG from 8bim clip path. (reference     https://www.imagemagick.org/discourse-server/viewtopic.php?f=1&amp;t=25594).</li>
<dt>2014-06-02  6.8.9-3 Cristy  &lt;quetzlzacatenango@image...&gt;</dt>
  <li> The -version option returns 0 status (reference    https://www.imagemagick.org/discourse-server/viewtopic.php?f=3&amp;t=25667).</li>
  <li> The inline coder can now read from standard input (reference    https://www.imagemagick.org/discourse-server/viewtopic.php?f=3&amp;t=25641).</li>
...
<dt>2014-05-14  6.8.9-2 Cristy  &lt;quetzlzacatenango@image...&gt;</dt>
  <li> The -fx equality operator returns a proper boolean result now (reference    https://www.imagemagick.org/discourse-server/viewtopic.php?f=3&amp;t=25580).</li>
  <li> Permit spaces in the gradient color specification (reference    https://www.imagemagick.org/discourse-server/viewtopic.php?f=3&amp;t=25614).</li>
  <li> Fix IdentifyImage() crash when image-&gt;magick member is null (reference    https://www.imagemagick.org/discourse-server/viewtopic.php?f=3&amp;t=25615).</li>
  <li> The -format M and Y channels are no longer reversed (reference    https://www.imagemagick.org/discourse-server/viewtopic.php?f=3&amp;t=25633).</li>
  ...
  <li> Fix memory leak in BlobToStringInfo() (reference    https://www.imagemagick.org/discourse-server/viewtopic.php?f=3&amp;t=25639).</li>
  <li> In certain cases, -adaptive-sharpen failed to sharpen (reference    https://www.imagemagick.org/discourse-server/viewtopic.php?f=3&amp;t=23211</li>
<dt>2014-05-12  6.8.9-2 Dirk Lemstra &lt;dirk@snakeware...&gt;</dt>
  <li> Bump major Magick++ library version.</li>
  <li> Added support for writing RLE compressed TGA files (reference    https://www.imagemagick.org/discourse-server/viewtopic.php?f=3&amp;t=12335).</li>
  <li> Improved performance of parsing the xmp profile (reference    https://www.imagemagick.org/discourse-server/viewtopic.php?f=3&amp;t=25612).</li>
  <li> Fixed detecting transparency in PSD files (reference    https://www.imagemagick.org/discourse-server/viewtopic.php?f=3&amp;t=25634).</li>
...
<dt>2014-04-22  6.8.9-1 Cristy  &lt;quetzlzacatenango@image...&gt;</dt>
  ...
  <li> identify -units without argument no longer faults (reference    https://www.imagemagick.org/discourse-server/viewtopic.php?f=3&amp;t=25542).</li>
...
<dt>2014-04-20  6.8.9-1 Dirk Lemstra &lt;dirk@snakeware...&gt;</dt>
  ...
  <li> Fix for stack overflow in DestroyXMLTree in Windows (reference    https://www.imagemagick.org/discourse-server/viewtopic.php?f=3&amp;t=25457).</li>
  <li> Added new coder for VIPS image format (reference    https://www.imagemagick.org/discourse-server/viewtopic.php?f=2&amp;t=25445).</li>
...
<dt>2014-04-03  6.8.9-0 Glenn Randers-Pehrson &lt;glennrp@image...&gt;</dt>
  <li> Fixed bug with -strip failing to exclude PNG chunks (reference    https://www.imagemagick.org/discourse-server/viewtopic.php?f=3&amp;t=25353).</li>
<dt>2014-03-30  6.8.9-0 Dirk Lemstra &lt;dirk@snakeware...&gt;</dt>
  <li> Added new coder to take a screen shot of a monitor in Windows (reference    https://www.imagemagick.org/discourse-server/viewtopic.php?f=23&amp;t=25191).</li>
<dt>2014-03-24  6.8.9-0 Cristy  &lt;quetzlzacatenango@image...&gt;</dt>
  ...
  <li> Use temporary path rather then current working directory (reference    https://www.imagemagick.org/discourse-server/viewtopic.php?f=3&amp;t=25313).</li>
  <li> Support -canny edge detection option.</li>
  <li> Use MAGICKCORE_LIBOPENJP2_DELEGATE instead of MAGICKCORE_JP2_DELEGATE    (reference www.imagemagick.org/discourse-server/viewtopic.php?f=3&amp;t=25376).</li>
...
<dt>2014-03-23  6.8.8-10 Cristy  &lt;quetzlzacatenango@image...&gt;</dt>
  <li> Although they are internal methods, deprecate InitializeModuleList(),    LoadMimeLists(), and RelinquishCommandQueue() (reference   https://www.imagemagick.org/discourse-server/viewtopic.php?f=3&amp;t=25263).</li>
...
<dt>2014-03-16  6.8.8-9 Glenn Randers-Pehrson &lt;glennrp@image...&gt;</dt>
  <li> Do not block threads in the png codec when PNG_SETJMP_SUPPORTED is not    defined (reference    https://www.imagemagick.org/discourse-server/viewtopic.php?f=23&amp;t=25218).</li>
...
<dt>2014-03-11  6.8.8-9 Cristy  &lt;quetzlzacatenango@image...&gt;</dt>
  <li> The -define jpeg:extent option overrides the image quality (reference    https://www.imagemagick.org/discourse-server/viewtopic.php?f=3&amp;t=25200). </li>
...
<dt>2014-03-04  6.8.8-8 Glenn Randers-Pehrson &lt;glennrp@image...&gt;</dt>
  <li> Reset colorspace to Grayscale when reading a gray PNG image with    gamma &gt; 0.75 instead of when gamma==1.0 (reference    https://www.imagemagick.org/discourse-server/viewtopic.php?f=3&amp;t=25136).</li>
<dt>2014-02-22  6.8.8-8 Dirk Lemstra &lt;dirk@snakeware...&gt;</dt>
  ...
  <li> Added option pdf:fit-page to scale a pdf to the specified size (reference    https://www.imagemagick.org/discourse-server/viewtopic.php?f=1&amp;t=25044).</li>
...
<dt>2014-02-21  6.8.8-8 Cristy  &lt;quetzlzacatenango@image...&gt;</dt>
  ...
  <li> Tweak color reduction optimization to return a full color palette (reference    https://www.imagemagick.org/discourse-server/viewtopic.php?f=1&amp;t=25098).</li>
  <li> Patch configure.ac to support FlashPix under Debian (reference    https://www.imagemagick.org/discourse-server/viewtopic.php?f=3&amp;t=25140).</li>
  <li> OpenCL support writes to $HOME/.config/ImageMagick, if the path does not    exist, two calls to mkdir() are required (reference    https://www.imagemagick.org/discourse-server/viewtopic.php?f=3&amp;t=25080).</li>
  <li> Replace  MAGICKCORE_JP2_DELEGATE with MAGICKCORE_LIBOPENJP2_DELEGATE in    magick/static.c (reference    https://www.imagemagick.org/discourse-server/viewtopic.php?f=3&amp;t=25153).</li>
  <li> Eliminate thread race condition (reference    https://www.imagemagick.org/discourse-server/viewtopic.php?f=3&amp;t=25168).</li>
...
<dt>2014-02-16  6.8.8-7 Dirk Lemstra &lt;dirk@snakeware...&gt;</dt>
  <li> Improved detection of JPEG 2000 code streams and .j2c support (reference    https://www.imagemagick.org/discourse-server/viewtopic.php?f=2&amp;t=24942).</li>
...
<dt>2014-01-31  6.8.8-5 Cristy  &lt;quetzlzacatenango@image...&gt;</dt>
  ...
  <li> Enhance the TXT coder to read RGB percent values, e.g. 10.008% (reference    https://www.imagemagick.org/discourse-server/viewtopic.php?f=3&amp;t=24934).</li>
<dt>2014-01-30  6.8.8-5 Glenn Randers-Pehrson &lt;glennrp@image...&gt;</dt>
  <li> Fixed new "-define png:swap-bytes" option (reference    https://www.imagemagick.org/discourse-server/viewtopic.php?f=2&amp;t=24818).</li>
...
<dt>2014-01-28  6.8.8-4 Dirk Lemstra &lt;dirk@snakeware...&gt;</dt>
  <li> Added transpose and transverse to Magick++. (reference    https://www.imagemagick.org/discourse-server/viewtopic.php?f=2&amp;t=24884).</li>
...
<dt>2014-01-18  6.8.8-3 Dirk Lemstra &lt;dirk@snakeware...&gt;</dt>
  ...
  <li> Added support for defining dimensions with icon:auto-resize (reference    https://www.imagemagick.org/discourse-server/viewtopic.php?f=1&amp;t=24796).</li>
<dt>2014-01-16  6.8.8-3 Glenn Randers-Pehrson &lt;glennrp@image...&gt;</dt>
  <li> Added "-define png:swap-bytes" option (reference    https://www.imagemagick.org/discourse-server/viewtopic.php?f=2&amp;t=24818).</li>
  <li> Added image-&gt;duration to image.h, calculate duration in gif.c, and    report duration in identify.c (reference    https://www.imagemagick.org/discourse-server/viewtopic.php?f=1&amp;t=23276).</li>
<dt>2014-01-15  6.8.8-3 Cristy  &lt;quetzlzacatenango@image...&gt;</dt>
  <li> The -type truecolor option for a grayscale image returns RGB JPEG (reference    https://www.imagemagick.org/discourse-server/viewtopic.php?f=3&amp;t=24814).</li>
...
<dt>2014-01-09  6.8.8-2 Dirk Lemstra &lt;dirk@snakeware...&gt;</dt>
  ...
  <li> Added text kerning/spacing to Magick++. (reference    https://www.imagemagick.org/discourse-server/viewtopic.php?f=23&amp;t=24716).</li>
<dt>2013-12-30  6.8.8-2 Cristy  &lt;quetzlzacatenango@image...&gt;</dt>
  <li> The -evaluate-sequence sum returns a proper alpha channel now (reference    https://www.imagemagick.org/discourse-server/viewtopic.php?f=3&amp;t=24704).</li>
  <li> Support OpenJPEG for JPEG-2000 support.</li>
  <li> Support IsMagickWandInstantiated() method (reference    https://www.imagemagick.org/discourse-server/viewtopic.php?f=6&amp;t=24724).</li>
  <li> LevelColorsImageChannel() returns proper status (reference    https://www.imagemagick.org/discourse-server/viewtopic.php?f=3&amp;t=24751).</li>
  <li> Generate a proper SVG clipping path (reference    https://www.imagemagick.org/discourse-server/viewtopic.php?f=3&amp;t=24752).</li>
...
<dt>2013-12-27  6.8.8-1 Cristy  &lt;quetzlzacatenango@image...&gt;</dt>
  ...
  <li> The -page option now correctly sets the image page offset (reference    https://www.imagemagick.org/discourse-server/viewtopic.php?f=3&amp;t=24701).</li>
<dt>2013-12-26  6.8.8-1 Dirk Lemstra &lt;dirk@snakeware...&gt;</dt>
  <li> Added support for reading zip compressed PSD files. (reference    https://www.imagemagick.org/discourse-server/viewtopic.php?f=3&amp;t=24676).</li>
...
<dt>2013-12-23  6.8.8-0 Cristy  &lt;quetzlzacatenango@image...&gt;</dt>
  <li> Blurring with transparency no longer returns a halo (reference    https://www.imagemagick.org/discourse-server/viewtopic.php?f=3&amp;t=24665).</li>
  <li> Eliminate ICC profile memory leak for JP2 coder (reference    https://www.imagemagick.org/discourse-server/viewtopic.php?f=2&amp;t=24679).</li>
...
<dt>2013-12-10  6.8.7-10  SiuChi Chan  &lt;...&gt;</dt>
  <li> Fix crash when using -resize with GPU acceleration (reference    https://www.imagemagick.org/discourse-server/viewtopic.php?f=3&amp;t=24603).</li>
...
<dt>2013-12-03  6.8.7-9 Glenn Randers-Pehrson &lt;glennrp@image...&gt;</dt>
  <li> Fixed bug in coders/png.c that caused -define png:color-type=0 to    fail (reference    https://www.imagemagick.org/discourse-server/viewtopic.php?f=1&amp;t=24568).</li>
<dt>2013-11-30  6.8.7-9 Dirk Lemstra &lt;dirk@snakeware...&gt;</dt>
  <li> Fixed bug in automatic selection of OpenCL device (reference    https://www.imagemagick.org/discourse-server/viewtopic.php?f=3&amp;t=24542).</li>
  <li> Fixed transparency for 32 bits BMP.</li>
<dt>2013-11-28  6.8.7-9 Cristy  &lt;quetzlzacatenango@image...&gt;</dt>
  <li> The -type bilevel option sometimes returned an all white image (reference    https://www.imagemagick.org/discourse-server/viewtopic.php?f=3&amp;t=24444).</li>
  <li> Check blue channel threshold for -solarize option (reference    https://www.imagemagick.org/discourse-server/viewtopic.php?f=3&amp;t=24473).</li>
...
<dt>2013-11-14  6.8.7-6 Cristy  &lt;quetzlzacatenango@image...&gt;</dt>
  ...
  <li> Constrain color reduction acceleration to positive integers (reference    https://www.imagemagick.org/discourse-server/viewtopic.php?f=1&amp;t=24459).</li>
  <li> fx:maxima.a now returns the alpha value rather than opacity (reference    https://www.imagemagick.org/discourse-server/viewtopic.php?f=3&amp;t=24461).</li>
...
<dt>2013-11-03  6.8.7-5 Cristy  &lt;quetzlzacatenango@image...&gt;</dt>
  <li> The jpeg:extent option no longer returns double-free exception (reference    https://www.imagemagick.org/discourse-server/viewtopic.php?f=3&amp;t=24366).</li>
  <li> Turn off arch-specific optimizations (reference    https://www.imagemagick.org/discourse-server/viewtopic.php?f=3&amp;t=24353).</li>
  <li> The -type bilevel option no longer returns black image (reference    https://www.imagemagick.org/discourse-server/viewtopic.php?f=3&amp;t=24394).</li>
...
<dt>2013-10-24  6.8.7-4 Cristy  &lt;quetzlzacatenango@image...&gt;</dt>
  <li> Color reduction acceleration from Yoya (reference    https://www.imagemagick.org/discourse-server/viewtopic.php?f=2&amp;t=24324).</li>
  <li> -intensity rec709luma -colorspace gray returns gamma 1.0/2.2 (reference    https://www.imagemagick.org/discourse-server/viewtopic.php?f=3&amp;t=24330).</li>
  <li> Handle 16-bit JPEG-compressed TIFF images (reference    https://www.imagemagick.org/discourse-server/viewtopic.php?f=3&amp;t=24331).</li>
  <li> An image -compose ModulusAdd negate-image returns the original (reference    https://www.imagemagick.org/discourse-server/viewtopic.php?f=3&amp;t=24337).</li>
  <li> Support %U escape character for resolution units (reference    https://www.imagemagick.org/discourse-server/viewtopic.php?f=1&amp;t=24140).</li>
<dt>2013-10-23  6.8.7-3 Cristy  &lt;quetzlzacatenango@image...&gt;</dt>
  <li> New version 6.8.7-3, SVN revision 13557.</li>
<dt>2013-10-23  6.8.7-3 Cristy  &lt;quetzlzacatenango@image...&gt;</dt>
  <li> The -roll option is now working when the +x coordinate is +0 (reference    https://www.imagemagick.org/discourse-server/viewtopic.php?f=3&amp;t=24314).</li>
...
<dt>2013-10-20  6.8.7-2 Cristy  &lt;quetzlzacatenango@image...&gt;</dt>
  ...
  <li> Set xc:gray() intensity to Rec709Luma (reference    https://www.imagemagick.org/discourse-server/viewtopic.php?f=3&amp;t=24303).</li>
...
<dt>2013-10-10  6.8.7-1 Cristy  &lt;quetzlzacatenango@image...&gt;</dt>
  ...
  <li> Sync pixel cache for -set colorspace cmyk option (reference    https://www.imagemagick.org/discourse-server/viewtopic.php?f=3&amp;t=24173).</li>
<dt>2013-09-27  6.8.7-1 Glenn Randers-Pehrson &lt;glennrp@image...&gt;</dt>
  ...
  <li> Set image-&gt;intensity = Rec709LuminancePixelIntensityMethod before    setting the colorspace to Gray while reading a gray PNG (reference    https://www.imagemagick.org/discourse-server/viewtopic.php?f=3&amp;t=24205).    This ensures that image-&gt;gamma will be set to 1.0 (linear).</li>
<dt>2013-09-26  6.8.7-1 Dirk Lemstra &lt;dirk@snakeware...&gt;</dt>
  <li> Fixed incorrect size of DICOM image (reference    https://www.imagemagick.org/discourse-server/viewtopic.php?f=3&amp;t=24135).</li>
  <li> Fixed rounding in YUV coder (reference    https://www.imagemagick.org/discourse-server/viewtopic.php?f=3&amp;t=24148).</li>
  <li> Fixed colorspace issue when combining images (reference    https://www.imagemagick.org/discourse-server/viewtopic.php?f=3&amp;t=24173).</li>
...
<dt>2013-09-23  6.8.7-0 Glenn Randers-Pehrson &lt;glennrp@image...&gt;</dt>
  <li> Fixed comments about the -quality value in PNG coder (reference    https://www.imagemagick.org/discourse-server/viewtopic.php?f=2&amp;t=24134).</li>
<dt>2013-09-19  6.8.7-0 Dirk Lemstra &lt;dirk@snakeware...&gt;</dt>
  <li> Fixed issue with colormap when reading Viff image.</li>
  <li> Added support for opening https files under windows (reference    https://www.imagemagick.org/discourse-server/viewtopic.php?f=3&amp;t=24121).</li>
  <li> Fixed incorrect format when reading EPT image from a blob (reference    https://www.imagemagick.org/discourse-server/viewtopic.php?f=3&amp;t=24129).</li>
...
<dt>2013-08-29  6.8.6-10 Cristy  &lt;quetzlzacatenango@image...&gt;</dt>
  <li> Call SVG / MSL xmlCleanupParser() / xmlInitParser() once (reference    https://www.imagemagick.org/discourse-server/viewtopic.php?f=3&amp;t=23991).</li>
  ...
  <li> 16bit PSD images might have a 65536 colormap (reference    https://www.imagemagick.org/discourse-server/viewtopic.php?f=3&amp;t=24102).</li>
  <li> Ascii map is now declare as AsciiMap (reference    https://www.imagemagick.org/discourse-server/viewtopic.php?f=3&amp;t=24106).</li>
  <li> Return label for identify -format "%l" (reference    https://www.imagemagick.org/discourse-server/viewtopic.php?f=3&amp;t=24105).</li>
...
<dt>2013-08-10  6.8.6-9 Dirk Lemstra &lt;dirk@snakeware..&gt;</dt>
  ...
  <li> Fixed infinite loop with jpeg:extent (reference    https://www.imagemagick.org/discourse-server/viewtopic.php?f=3&amp;t=23314).</li>
  <li> Fixed performance issue when converting jpeg to png (reference    https://www.imagemagick.org/discourse-server/viewtopic.php?f=3&amp;t=23922).</li>
<dt>2013-08-10  6.8.6.9 Glenn Randers-Pehrson &lt;glennrp@image...&gt;</dt>
  <li> Added "-define bmp:format=bmp2|bmp3|bmp4" option (reference    https://www.imagemagick.org/discourse-server/viewtopic.php?f=1&amp;t=23875).</li>
<dt>2013-08-07  6.8.6-9 Cristy  &lt;quetzlzacatenango@image...&gt;</dt>
  <li> Free disk resource if cache resources are exhausted (reference    https://www.imagemagick.org/discourse-server/viewtopic.php?f=3&amp;t=23877).</li>
  <li> Return proper EXIF:ISOSpeedRating property value for TIFF images (reference    https://www.imagemagick.org/discourse-server/viewtopic.php?f=3&amp;t=23913).</li>
  <li> Escape MIFF properties with null values (reference    https://www.imagemagick.org/discourse-server/viewtopic.php?f=3&amp;t=23931).</li>
  <li> Allow negative pixel values in TXT image format (reference    https://www.imagemagick.org/discourse-server/viewtopic.php?f=3&amp;t=23923).</li>
  <li> The -fx option no longer crashes for certain expressions (reference    https://www.imagemagick.org/discourse-server/viewtopic.php?f=3&amp;t=23932).</li>
...
<dt>2013-08-04  6.8.6-8 Dirk Lemstra &lt;dirk@snakeware...&gt;</dt>
  <li> Added support for WebP to the Windows distribution (reference    https://www.imagemagick.org/discourse-server/viewtopic.php?f=1&amp;t=23856).</li>
<dt>2013-07-31  6.8.6-8 Cristy  &lt;quetzlzacatenango@image...&gt;</dt>
  <li> Properly handle interlaced GIF images with less than 8 rows (reference    https://www.imagemagick.org/discourse-server/viewtopic.php?f=3&amp;t=23812).</li>
  <li> Ensure image colorspace is sRGB when writing WebP format (reference    https://www.imagemagick.org/discourse-server/viewtopic.php?f=1&amp;t=23841).</li>
  <li> Avoid deadlock with logging subsystem (reference    https://www.imagemagick.org/discourse-server/viewtopic.php?f=2&amp;t=23849).</li>
...
<dt>2013-07-24  6.8.6-7 Cristy  &lt;quetzlzacatenango@image...&gt;</dt>
  <li> Missing case for HCLpColorspace (reference    https://www.imagemagick.org/discourse-server/viewtopic.php?f=3&amp;t=23811).</li>
<dt>2013-07-21  6.8.6.7 Glenn Randers-Pehrson &lt;glennrp@image...&gt;</dt>
  <li> Do not write "jpeg:" properties in a PNG output file (reference    https://www.imagemagick.org/discourse-server/viewtopic.php?f=3&amp;t=23794).</li>
...
<dt>2013-07-16  6.8.6-6 Cristy  &lt;quetzlzacatenango@image...&gt;</dt>
  <li> JPEG ICC color profile requires null after ICC tag (reference    https://www.imagemagick.org/discourse-server/viewtopic.php?f=3&amp;t=23756).</li>
  <li> Don't sync channels for the -unsharp option (reference    https://www.imagemagick.org/discourse-server/viewtopic.php?f=3&amp;t=23740).</li>
  <li> Magick++ version so bump (reference    https://www.imagemagick.org/discourse-server/viewtopic.php?f=3&amp;t=23752).</li>
...
<dt>2013-07-10  6.8.6-5 Cristy  &lt;quetzlzacatenango@image...&gt;</dt>
  <li> Compare exits with a non-zero exit code when no error (reference    https://www.imagemagick.org/discourse-server/viewtopic.php?f=3&amp;t=23722).</li>
  <li> Correct calculation of quantization error (reference    https://www.imagemagick.org/discourse-server/viewtopic.php?t=23734).</li>
  <li> Correct quantize tree walking mistake for RiemersmaDither (reference    https://www.imagemagick.org/discourse-server/viewtopic.php?f=2&amp;t=23735).</li>
...
<dt>2013-07-09  6.8.6-4 Dirk Lemstra &lt;dirk@snakeware...&gt;</dt>
  <li> Added combineImages, evaluateImages, mergeImageLayers, optimizeImageLayers    optimizePlusImageLayers and separateImages to STL.h (reference    https://www.imagemagick.org/discourse-server/viewtopic.php?f=2&amp;t=23699).</li>
  <li> Added support for the fill area flag ('^') and the pixel area    count limit flag ('@') to the Geometry class of Magick++ (reference    https://www.imagemagick.org/discourse-server/viewtopic.php?f=2&amp;t=23704).</li>
  <li> Enabled automatic linking for static Magick++ in Visual Studio (reference    https://www.imagemagick.org/discourse-server/viewtopic.php?f=2&amp;t=23558).</li>
<dt>2013-07-01  6.8.6-4 Cristy  &lt;quetzlzacatenango@image...&gt;</dt>
  <li> Thumb property need Height, not height (reference    https://www.imagemagick.org/discourse-server/viewtopic.php?f=3&amp;t=23661).</li>
  <li> White pixels previously were written as black for the CIP format (reference    https://www.imagemagick.org/discourse-server/viewtopic.php?f=3&amp;t=23677).</li>
  <li> Rec709Luma is sRGB compatible (reference    https://www.imagemagick.org/discourse-server/viewtopic.php?f=3&amp;t=23693).</li>
  <li> Colorspace RGB is linear, gamma is 1.0 (reference    https://www.imagemagick.org/discourse-server/viewtopic.php?f=3&amp;t=23708).</li>
...
<dt>2013-06-26  6.8.6-3 Cristy  &lt;quetzlzacatenango@image...&gt;</dt>
  <li> Improve HCL to RGB roundtrip (reference    https://www.imagemagick.org/discourse-server/viewtopic.php?f=3&amp;t=22384).</li>
  <li> Prefer external log configuration file to built-in (reference    https://www.imagemagick.org/discourse-server/viewtopic.php?f=3&amp;t=23640).</li>
  <li> Do not log in the IsLinkedListEmpty() method to prevent overflow (reference    https://www.imagemagick.org/discourse-server/viewtopic.php?f=3&amp;t=23640).</li>
  <li> Fix bug loading TGA image with 32-bit palette (reference    https://www.imagemagick.org/discourse-server/viewtopic.php?f=3&amp;t=17889).</li>
  <li> Color profiles are no longer corrupted for the JPEG format (reference    https://www.imagemagick.org/discourse-server/viewtopic.php?f=3&amp;t=23651).</li>
  <li> Repair problem with -emboss / -equalize problem (reference    https://www.imagemagick.org/discourse-server/viewtopic.php?f=3&amp;t=23643).</li>
...
<dt>2013-06-16  6.8.6-1 Cristy  &lt;quetzlzacatenango@image...&gt;</dt>
  ...
  <li> Improve LCHab and LCHuv roundtrip to / from sRGB (reference    https://www.imagemagick.org/discourse-server/viewtopic.php?f=1&amp;t=23596).</li>
...
<dt>2013-06-10  6.8.6-0 Cristy  &lt;quetzlzacatenango@image...&gt;</dt>
  <li> Clone image-&gt;intensity in CloneImageProperties() (reference    https://www.imagemagick.org/discourse-server/viewtopic.php?f=3&amp;t=23569).</li>
  <li> Split test suite into smaller tests (reference    https://www.imagemagick.org/discourse-server/viewtopic.php?f=3&amp;t=23577).</li>
  <li> Undercolor rectangle was off by one pixel (reference    https://www.imagemagick.org/discourse-server/viewtopic.php?f=3&amp;t=23574).</li>
  <li> Don't msync() for a read-only memory-mapped mode (reference    https://www.imagemagick.org/discourse-server/viewtopic.php?f=3&amp;t=23531).</li>
  <li> BlurChannelImage() no longer faults for certain CMYK images (reference    https://www.imagemagick.org/discourse-server/viewtopic.php?f=3&amp;t=23581).</li>
...
<dt>2013-06-02  6.8.5-10 Cristy  &lt;quetzlzacatenango@image...&gt;</dt>
  <li> Improve caption formatting (reference    https://www.imagemagick.org/discourse-server/viewtopic.php?f=3&amp;t=23522).</li>
...
<dt>2013-05-30  6.8.5-9 Cristy  &lt;quetzlzacatenango@image...&gt;</dt>
  <li> Caption no longer clips long words (reference    https://www.imagemagick.org/discourse-server/viewtopic.php?f=3&amp;t=23504).</li>
  <li> The lightness intensity is (min(R',G',B')+max(R',G',B'))/2.0 (reference    https://www.imagemagick.org/discourse-server/viewtopic.php?f=3&amp;t=23517).</li>
...
<dt>2013-05-20  6.8.5-8 Cristy  &lt;quetzlzacatenango@image...&gt;</dt>
  <li> The -white-threshold option is symmetrical with -black-threshold (reference    https://www.imagemagick.org/discourse-server/viewtopic.php?f=3&amp;t=23441);</li>
  <li> Fix multi-line PNM comments (reference    https://www.imagemagick.org/discourse-server/viewtopic.php?f=3&amp;t=23442).</li>
  ...
  <li> The -level option is no longer returning a darkened image (reference    https://www.imagemagick.org/discourse-server/viewtopic.php?f=3&amp;t=23479).</li>
  <li> Identify SVG image as "SVG" (reference    https://www.imagemagick.org/discourse-server/viewtopic.php?f=3&amp;t=27654).</li>
...
<dt>2013-05-11  6.8.5-7 Cristy  &lt;quetzlzacatenango@image...&gt;</dt>
  <li> Sometimes an sRGB image is masquerading as grayscale (reference    https://www.imagemagick.org/discourse-server/viewtopic.php?f=3&amp;t=23370).</li>
  <li> Labels no longer overflow (reference    https://www.imagemagick.org/discourse-server/viewtopic.php?f=3&amp;t=22964).</li>
  <li> If more then one exception, return the highest security exception.</li>
  <li> A grayscale image returns a color JPEG for -type TrueColor (reference    https://www.imagemagick.org/discourse-server/viewtopic.php?f=1&amp;t=23421).</li>
  <li> Read PAM comment (reference    https://www.imagemagick.org/discourse-server/viewtopic.php?f=3&amp;t=23442).</li>
...
<dt>2013-05-09  6.8.5-6 Cristy  &lt;quetzlzacatenango@image...&gt;</dt>
  <li> The stream utility no longer faults when exporting float pixels (reference    https://www.imagemagick.org/discourse-server/viewtopic.php?f=3&amp;t=23394).</li>
...
<dt>2013-05-05  6.8.5-5 Cristy  &lt;quetzlzacatenango@image...&gt;</dt>
  <li> The -poly option treats the opacity channel as alpha (reference    https://www.imagemagick.org/discourse-server/viewtopic.php?f=3&amp;t=23346).</li>
  <li> The -threshold 50% option returns a 50-50 black and white image (reference    https://www.imagemagick.org/discourse-server/viewtopic.php?f=3&amp;t=23354).</li>
  <li> Let user override the TIFF rows per strip  (reference    https://www.imagemagick.org/discourse-server/viewtopic.php?f=2&amp;t=23307).</li>
  <li> Fix transient bug in the -separate option (reference    https://www.imagemagick.org/discourse-server/viewtopic.php?f=3&amp;t=23335).</li>
...
<dt>2013-04-26  6.8.5-1 Cristy  &lt;quetzlzacatenango@image...&gt;</dt>
  ...
  <li> Loop over read() until requested bytes are consumed (reference    https://www.imagemagick.org/discourse-server/viewtopic.php?t=23268).</li>
...
<dt>2013-04-16  6.8.5-0 Cristy  &lt;quetzlzacatenango@image...&gt;</dt>
  <li> Don't modify channel values for -separate (reference    https://www.imagemagick.org/discourse-server/viewtopic.php?f=3&amp;t=23193).</li>
  <li> The -adaptive-sharpen option is now sharpening properly (reference    https://www.imagemagick.org/discourse-server/viewtopic.php?f=3&amp;t=23211).</li>
  <li> Sometimes an image says it's grayscale when it's not (reference    https://www.imagemagick.org/discourse-server/viewtopic.php?f=3&amp;t=23217).</li>
  <li> Use malloc() to allocate X image data (reference    https://www.imagemagick.org/discourse-server/viewtopic.php?f=3&amp;t=23221).</li>
  ...
  <li> Negatives raised to a non-integer power returns NaN's (reference    https://www.imagemagick.org/discourse-server/viewtopic.php?f=3&amp;t=23234).</li>
...
<dt>2013-04-11  6.8.4-10 Cristy  &lt;quetzlzacatenango@image...&gt;</dt>
  <li> Ensure -define jpeg:extent is restricted to at most 7 iterations (reference    https://www.imagemagick.org/discourse-server/viewtopic.php?f=3&amp;t=23179).</li>
...
<dt>2013-04-10  6.8.4-9 Bastien Roucaries  &lt;roucaries.basti...&gt;</dt>
  <li> Respect --program-suffix configure script option (reference    https://www.imagemagick.org/discourse-server/viewtopic.php?f=3&amp;t=23143).</li>
...
<dt>2013-04-08  6.8.4-9 Cristy  &lt;quetzlzacatenango@image...&gt;</dt>
  <li> Pass JP2 format type to decoder (reference    https://www.imagemagick.org/discourse-server/viewtopic.php?f=3&amp;t=23038).</li>
  <li> Previously tinting a grayscale image returned dark results.</li>
  <li> The -page option only affects new images (reference    https://www.imagemagick.org/discourse-server/viewtopic.php?f=3&amp;t=23172).</li>
...
<dt>2013-04-02  6.8.4-7 Cristy  &lt;quetzlzacatenango@image...&gt;</dt>
  ...
  <li> Revert the default upsampling algortithm for JPEG (reference    https://www.imagemagick.org/discourse-server/viewtopic.php?f=3&amp;t=23100).</li>
  <li> Prevent fault when temporary directory is not-writable (reference    https://www.imagemagick.org/discourse-server/viewtopic.php?f=3&amp;t=23117).</li>
...
<dt>2013-04-01  6.8.4-6 Cristy  &lt;quetzlzacatenango@image...&gt;</dt>
  ...
  <li> Caption fits the sized area (reference    https://www.imagemagick.org/discourse-server/viewtopic.php?f=3&amp;t=23085).</li>
...
<dt>2013-03-20  6.8.4-0 Cristy  &lt;quetzlzacatenango@image...&gt;</dt>
  <li> Do not write zero-length TIFF tags (reference    https://www.imagemagick.org/discourse-server/viewtopic.php?f=3&amp;t=22957).</li>
  <li> Math library should be private for *.pc.in configuration files (reference    https://www.imagemagick.org/discourse-server/viewtopic.php?f=2&amp;t=22986).</li>
  <li> Do not split words for caption (reference    https://www.imagemagick.org/discourse-server/viewtopic.php?f=1&amp;t=17123).</li>
  <li> Modify the configure script check for the webp delegate library (reference    https://www.imagemagick.org/discourse-server/viewtopic.php?f=1&amp;t=23025).</li>
  <li> The -blur, -gaussian-blur, and -sharpen are now convenience methods    for -morphology convolve.</li>
  <li> Fix infinite loop for 'display -window' (reference    https://www.imagemagick.org/discourse-server/viewtopic.php?f=3&amp;t=23028).</li>
  <li> Revert -auto-level patch to match the results of ImageMagick 6.8.3-4.</li>
  <li> Revert g_type_init() patch in svg.c (reference    https://www.imagemagick.org/discourse-server/viewtopic.php?f=3&amp;t=23035).</li>
...
<dt>2013-03-10  6.8.3-10 Cristy  &lt;quetzlzacatenango@image...&gt;</dt>
  ...
  <li> Avoid seq-fault in AcquireQuantumInfo() (reference    https://www.imagemagick.org/discourse-server/viewtopic.php?f=3&amp;t=22973).</li>
...
<dt>2013-03-09  6.8.3-9 Cristy  &lt;quetzlzacatenango@image...&gt;</dt>
  <li> Add a space after the LastPage option in coders/ps.c (reference    https://www.imagemagick.org/discourse-server/viewtopic.php?f=3&amp;t=22940).</li>
...
<dt>2013-03-05  6.8.3-8 Cristy  &lt;quetzlzacatenango@image...&gt;</dt>
  <li> GIF comments are no longer displaced by 1 for animated GIFs (reference    https://www.imagemagick.org/discourse-server/viewtopic.php?f=3&amp;t=22901).</li>
...
<dt>2013-02-25  6.8.3-6 Cristy  &lt;quetzlzacatenango@image...&gt;</dt>
  <li> Support built-in 1x1 and 2x1 threshold maps (reference    https://www.imagemagick.org/discourse-server/viewtopic.php?f=2&amp;t=22861).</li>
  <li> Check for webp version (reference    https://www.imagemagick.org/discourse-server/viewtopic.php?f=3&amp;t=22867).</li>
...
<dt>2013-02-23  6.8.3-5 Cristy  &lt;quetzlzacatenango@image...&gt;</dt>
  <li> Read the WebP extended file format (reference    https://www.imagemagick.org/discourse-server/viewtopic.php?f=2&amp;t=22809).</li>
...
<dt>2013-02-19  6.8.3-3 Cristy  &lt;quetzlzacatenango@image...&gt;</dt>
  <li> Set WEBP lossless / lossy property properly (reference    https://www.imagemagick.org/discourse-server/viewtopic.php?f=2&amp;t=22809).</li>
...
<dt>2013-02-17  6.8.3-2 Cristy  &lt;quetzlzacatenango@image...&gt;</dt>
  ...
  <li> WEBP coder enhancement and memory leak patch (reference    https://www.imagemagick.org/discourse-server/viewtopic.php?f=2&amp;t=22809).</li>
...
<dt>2013-02-14  6.8.3-0 Cristy  &lt;quetzlzacatenango@image...&gt;</dt>
  <li> Webp requires alpha, not opacity (reference    https://www.imagemagick.org/discourse-server/viewtopic.php?f=3&amp;t=22793).</li>
...
<dt>2013-02-09  6.8.2-9 Cristy  &lt;quetzlzacatenango@image...&gt;</dt>
  <li> The DOT coders now compiles with GraphViz 2.30 (reference    https://www.imagemagick.org/discourse-server/viewtopic.php?f=3&amp;t=22767).</li>
...
<dt>2013-02-07  6.8.2-6 Cristy  &lt;quetzlzacatenango@image...&gt;</dt>
  <li> Don't destroy an image that's already destroyed (reference    https://www.imagemagick.org/discourse-server/viewtopic.php?f=3&amp;t=22747).</li>
...
<dt>2013-02-02  6.8.2-4 Cristy  &lt;quetzlzacatenango@image...&gt;</dt>
  <li> Do not subsample raw CMYK JPEG images (reference    https://www.imagemagick.org/discourse-server/viewtopic.php?f=3&amp;t=22731).</li>
...
<dt>2013-02-01  6.8.2-3 Cristy  &lt;quetzlzacatenango@image...&gt;</dt>
  ...
  <li> Remove artifact when drawing a circle (reference    https://www.imagemagick.org/discourse-server/viewtopic.php?f=3&amp;t=22724).</li>
<dt>2013-02-01  6.8.2-3 Glenn Randers-Pehrson &lt;glennrp@image...&gt;</dt>
  <li> Deleted some code added to the PNG decoder in SVN revision 10825; it    was failing to handle transparency in paletted images (reference    https://www.imagemagick.org/discourse-server/viewtopic.php?f=3&amp;t=22720).</li>
...
<dt>2013-01-28  6.8.2-1 Cristy  &lt;quetzlzacatenango@image...&gt;</dt>
  <li> Fix 'format not a string literal' problem (reference    https://www.imagemagick.org/discourse-server/viewtopic.php?f=3&amp;t=22656).</li>
...
<dt>2013-01-08  6.8.1-10 Cristy  &lt;quetzlzacatenango@image...&gt;</dt>
  ...
  <li> Fix recursive descent within XGetWindowImage() (reference    https://www.imagemagick.org/discourse-server/viewtopic.php?f=3&amp;t=22550).</li>
  <li> Multi-plane MatLab images now render properly (reference    https://www.imagemagick.org/discourse-server/viewtopic.php?f=3&amp;t=22586).</li>
...
<dt>2013-01-02  6.8.1-8 Cristy  &lt;quetzlzacatenango@image...&gt;</dt>
  <li> Check for a density of zero when rendering with Pango (reference    https://www.imagemagick.org/discourse-server/viewforum.php?f=3).</li>
<dt>2013-01-01  6.8.1-7 Cristy  &lt;quetzlzacatenango@image...&gt;</dt>
  <li> New version 6.8.1-7, SVN revision 10468.</li>
<dt>2013-01-01  6.8.1-7 Cristy  &lt;quetzlzacatenango@image...&gt;</dt>
  <li> magick-baseconfig.h is architecture dependant;    make headers quantum depth neutral (reference    https://www.imagemagick.org/discourse-server/viewtopic.php?f=2&amp;t=22509).</li>
...
<dt>2012-12-31  6.8.1-6 Cristy  &lt;quetzlzacatenango@image...&gt;</dt>
  <li> Repair numerical stability issue with gradients (reference    https://www.imagemagick.org/discourse-server/viewtopic.php?f=3&amp;t=22507).</li>
...
<dt>2012-12-29  6.8.1-5 Cristy  &lt;quetzlzacatenango@image...&gt;</dt>
  <li> Correction to scientific notation for the -evaluate log option (reference    https://www.imagemagick.org/discourse-server/viewtopic.php?f=2&amp;t=22496).</li>
...
<dt>2012-12-28  6.8.1-4 Cristy  &lt;quetzlzacatenango@image...&gt;</dt>
  <li> Support scientific notation for the -evaluate log option (reference    https://www.imagemagick.org/discourse-server/viewtopic.php?f=2&amp;t=22496).</li>
...
<dt>2012-12-23  6.8.1-2 Cristy  &lt;quetzlzacatenango@image...&gt;</dt>
  <li> Magickcore headers recently used pow() in the inline functions inside    public headers.  Thus in order to avoid library depends problem, put -lm    in library depends (reference    https://www.imagemagick.org/discourse-server/viewtopic.php?f=3&amp;t=22483).</li>
  <li> Negative exponentiation bug fix (reference    https://www.imagemagick.org/discourse-server/viewtopic.php?f=3&amp;t=22484).</li>
...
<dt>2012-12-13  6.8.0-10 Anthony Thyssen &lt;A.Thyssen@griffith...&gt;</dt>
  ...
  <li> Added -define "shepards:power" to control the power setting (def=2)    for Shepards Method in -distort and  -sparse-color    https://www.imagemagick.org/discourse-server/viewtopic.php?t=22416</li>
...
<dt>2012-12-09  6.8.0-9 Cristy  &lt;quetzlzacatenango@image...&gt;</dt>
  <li> Further support for associating quantum depth with ABI (reference    https://www.imagemagick.org/discourse-server/viewtopic.php?f=3&amp;t=22352).</li>
  <li> Check for negative square root when resampling (reference    https://www.imagemagick.org/discourse-server/viewtopic.php?f=3&amp;t=22398).</li>
...
<dt>2012-11-28  6.8.0-8 Glenn Randers-Pehrson &lt;glennrp@image...&gt;</dt>
  <li> Fixed problem with writing grayscale PNG, bug introduced in version    6.8.0-0 or 6.8.0-1 (reference    https://www.imagemagick.org/discourse-server/viewtopic.php?f=3&amp;t=22355).</li>
<dt>2012-11-28  6.8.0-8 Cristy  &lt;quetzlzacatenango@image...&gt;</dt>
  ...
  <li> Implement symbol versioning (reference    https://www.imagemagick.org/discourse-server/viewtopic.php?f=3&amp;t=22352).</li>
  <li> ABI is incompatible if quantum depth change. Add abi indication to library    name, thanks to Bastien Roucaries (reference    https://www.imagemagick.org/discourse-server/viewtopic.php?f=3&amp;t=22352).</li>
  <li> The stream utility no longer returns a black image (reference    https://www.imagemagick.org/discourse-server/viewtopic.php?f=3&amp;t=22046).</li>
...
<dt>2012-11-21  6.8.0-6 Glenn Randers-Pehrson &lt;glennrp@image...&gt;</dt>
  <li> Fixed an old bug in chromaticity decoding in coders/bmp.c (reference    https://www.imagemagick.org/discourse-server/viewtopic.php?f=3&amp;t=22294).</li>
  <li> Fixed bug in coders/bmp.c that failed to read a paletted image    properly (fix by J. Summers, reference    https://www.imagemagick.org/discourse-server/viewtopic.php?f=3&amp;t=22316).</li>
<dt>2012-11-21  6.8.0-6 Cristy  &lt;quetzlzacatenango@image...&gt;</dt>
  <li> Fixed bug in coders/bmp.c that failed to read transparency    properly (fix by J. Summers, reference    https://www.imagemagick.org/discourse-server/viewtopic.php?f=3&amp;t=22312).</li>
...
<dt>2012-11-10  6.8.0-5 Cristy  &lt;quetzlzacatenango@image...&gt;</dt>
  ...
  <li> Support the OLE Macintosh image format (reference    https://www.imagemagick.org/discourse-server/viewtopic.php?f=2&amp;t=22257).</li>
...
<dt>2012-10-31  6.8.0-4 Cristy  &lt;quetzlzacatenango@image...&gt;</dt>
  <li> PFM images are grayscale, not sRGB (reference    https://www.imagemagick.org/discourse-server/viewtopic.php?f=3&amp;t=22178).</li>
  <li> Keep YCbCR JPEG compressed TIFF images in the YCbCr colorspace (reference    https://www.imagemagick.org/discourse-server/viewtopic.php?f=3&amp;t=22148).</li>
<dt>2012-10-27  6.7.9-4 Glenn Randers-Pehrson &lt;glennrp@image...&gt;</dt>
  <li> Don't write sRGB chunk if image-&gt;gamma isn't close to (1/2.2), i.e.,    (0.45 &lt;= gamma &lt;= 0.46) (reference    https://www.imagemagick.org/discourse-server/viewtopic.php?f=3&amp;t=22139).</li>
...
<dt>2012-10-21  6.8.0-3 Cristy  &lt;quetzlzacatenango@image...&gt;</dt>
  <li> TIFF positional information must be positive (reference    https://www.imagemagick.org/discourse-server/viewtopic.php?f=3&amp;t=22106).</li>
...
<dt>2012-10-12  6.8.0-1 Cristy  &lt;quetzlzacatenango@image...&gt;</dt>
  <li> Fix color management for the -solarize option (reference    https://www.imagemagick.org/discourse-server/viewtopic.php?f=3&amp;t=22059).</li>
...
<dt>2012-10-07  6.8.0-0 Cristy  &lt;quetzlzacatenango@image...&gt;</dt>
  ...
  <li> Corrupt PNG image could cause a memory leak (reference    https://www.imagemagick.org/discourse-server/viewtopic.php?f=3&amp;t=22024).</li>
...
<dt>2012-10-01  6.7.9-10 Cristy  &lt;quetzlzacatenango@image...&gt;</dt>
  <li> SVG specs says "1pt" equals "1.25px" (reference    https://www.imagemagick.org/discourse-server/viewtopic.php?f=3&amp;t=21967).</li>
  <li> Support TIFF proprietary tag 34118.</li>
  <li> The define option is no longer "lazy" interpretation (reference    https://www.imagemagick.org/discourse-server/viewtopic.php?f=3&amp;t=22007).</li>
...
<dt>2012-09-27  6.7.9-9 Cristy  &lt;quetzlzacatenango@image...&gt;</dt>
  <li> Fix memory leak in JPEG decoder when reading a corrupt image (reference    https://www.imagemagick.org/discourse-server/viewtopic.php?f=3&amp;t=21948).</li>
  <li> Add exif:thumbnail namespace to distiguish orientation tag (reference    https://www.imagemagick.org/discourse-server/viewtopic.php?f=3&amp;t=21938).</li>
  <li> Respect DPX data offsets (reference    https://www.imagemagick.org/discourse-server/viewtopic.php?f=3&amp;t=21960).</li>
...
<dt>2012-09-24  6.7.9-8 Cristy  &lt;quetzlzacatenango@image...&gt;</dt>
  ...
  <li> Fix memory leak in WebP decoder (reference    https://www.imagemagick.org/discourse-server/viewtopic.php?f=3&amp;t=21943).</li>
  <li> Certain caption phrases were cut off (reference    https://www.imagemagick.org/discourse-server/viewtopic.php?f=3&amp;t=21550).</li>
...
<dt>2012-09-20  6.7.9-7 Cristy  &lt;quetzlzacatenango@image...&gt;</dt>
  <li> jpeg:sampling-factor might be an image property or an option (reference<dt>https://www.imagemagick.org/discourse-server/viewtopic.php?f=2&amp;t=21884).</dt>
...
<dt>2012-09-09  6.7.9-5 Cristy  &lt;quetzlzacatenango@image...&gt;</dt>
  <li> The number of default OpenMP threads is 1 (reference    https://www.imagemagick.org/discourse-server/viewtopic.php?f=23&amp;t=21838).</li>
  <li> Only first image of raw grayscale image was set to GRAY (reference    https://www.imagemagick.org/discourse-server/viewtopic.php?f=3&amp;t=21428).</li>
...
<dt>2012-09-05  6.7.9-4 Cristy  &lt;quetzlzacatenango@image...&gt;</dt>
  <li> Identify image files with embedded '%d' (reference    https://www.imagemagick.org/discourse-server/viewtopic.php?f=3&amp;t=21798).</li>
  <li> Don't include TIFF header for compress.c source module    https://www.imagemagick.org/discourse-server/viewtopic.php?f=3&amp;t=21800).</li>
...
<dt>2012-08-28  6.7.9-3 Cristy  &lt;quetzlzacatenango@image...&gt;</dt>
  <li> Support -channel sync option for -equalize (reference    https://www.imagemagick.org/discourse-server/viewtopic.php?f=3&amp;t=21746).</li>
  <li> Don't remove color profile when setting the image colorspace (reference    https://www.imagemagick.org/discourse-server/viewtopic.php?f=3&amp;t=21747).</li>
  <li> Recognize ICO format in URL (e.g. http://www.google.com/favicon.ico).</li>
  <li> Don't define HAVE_BOOLEAN for JPEG under MinGW (reference    https://www.imagemagick.org/discourse-server/viewtopic.php?t=14071).</li>
...
<dt>2012-08-24  6.7.9-2 Cristy  &lt;quetzlzacatenango@image...&gt;</dt>
  <li> Support -channel option for -solarize (reference    https://www.imagemagick.org/discourse-server/viewtopic.php?f=3&amp;t=21738).</li>
...
<dt>2012-08-16  6.7.9-1 Cristy  &lt;quetzlzacatenango@image...&gt;</dt>
  <li> Adjust scaling for Luv colorspace conversion (reference    https://www.imagemagick.org/discourse-server/viewtopic.php?f=3&amp;t=21664).</li>
  <li> Copy alpha channel of the -median option (reference    https://www.imagemagick.org/discourse-server/viewtopic.php?f=2&amp;t=21694).</li>
  ...
  <li> In rare cases, label would not auto-size properly (reference    https://www.imagemagick.org/discourse-server/viewtopic.php?f=3&amp;t=21716).</li>
  <li> Identify command now reports the image colorspace for non-verbose results.</li>
  <li> Account for stroke width when rendering a caption (reference    https://www.imagemagick.org/discourse-server/viewtopic.php?f=1&amp;t=21721).</li>
  <li> Don't colorize alpha channel if it is not active (reference   https://www.imagemagick.org/discourse-server/viewtopic.php?f=3&amp;t=21547</li>
...
<dt>2012-08-14  6.7.9-0 Cristy  &lt;quetzlzacatenango@image...&gt;</dt>
  <li> RGB -&gt; HCL, return correct hue when g &lt; b &lt; r (reference    https://www.imagemagick.org/discourse-server/viewtopic.php?f=2&amp;t=21646).</li>
  <li> Prefer inkscape for best SVG compliance.</li>
  <li> HCL -&gt; RGB conversion enhancement (reference    https://www.imagemagick.org/discourse-server/viewtopic.php?f=2&amp;t=21663).</li>
...
<dt>2012-08-10  6.7.8-9 Cristy  &lt;quetzlzacatenango@image...&gt;</dt>
  <li> Respect the image mask for option -selective-blur (reference    https://www.imagemagick.org/discourse-server/viewtopic.php?f=3&amp;t=21631).</li>
  <li> Fix multiple issues with BMPv5 colorimetry (reference    https://www.imagemagick.org/discourse-server/viewtopic.php?f=3&amp;t=21640).</li>
<dt>2012-08-10  6.7.8-9 Cristy  &lt;quetzlzacatenango@image...&gt;</dt>
  <li> New version 6.7.8-9, SVN revision 8902.</li>
<dt>2012-08-07  6.7.8-9 Cristy  &lt;quetzlzacatenango@image...&gt;</dt>
  <li> Selective blur stopped working after version 6.7.4-10 (reference    https://www.imagemagick.org/discourse-server/viewtopic.php?f=3&amp;t=21604).</li>
  <li> Color reduction now handles transparent pixel properly (reference    https://www.imagemagick.org/discourse-server/viewtopic.php?f=3&amp;t=18463).</li>
  <li> ClipImagePath() now returns a valid SVG XML for Windows x64 (reference    https://www.imagemagick.org/discourse-server/viewtopic.php?f=3&amp;t=21617).</li>
...
<dt>2012-07-31  6.7.8-8 Cristy  &lt;quetzlzacatenango@image...&gt;</dt>
  ...
  <li> Caption no longer chops off text (reference    https://www.imagemagick.org/discourse-server/viewtopic.php?f=3&amp;t=21558).</li>
  ...
  <li> Interpret -border 5% as 5% of width and 5% of height (reference    https://www.imagemagick.org/discourse-server/viewtopic.php?f=3&amp;t=21537).</li>
  <li> Don't normalize zero-sum kernels (reference    https://www.imagemagick.org/discourse-server/viewtopic.php?f=3&amp;t=21584).</li>
  <li> Transform grayscale to linear RGB if fill color is non-gray (reference    https://www.imagemagick.org/discourse-server/viewtopic.php?f=3&amp;t=21586).</li>
...
<dt>2012-07-28  6.7.8-7 Cristy  &lt;quetzlzacatenango@image...&gt;</dt>
  ...
  <li> Missing grestore from ps3.c (reference    https://www.imagemagick.org/discourse-server/viewtopic.php?f=3&amp;t=20445).</li>
  <li> Use GetMagickResourceLimit(ThreadResource) to set the # threads (reference    https://www.imagemagick.org/discourse-server/viewtopic.php?f=3&amp;t=21543).</li>
...
<dt>2012-07-08  6.7.8-3 Cristy  &lt;quetzlzacatenango@image...&gt;</dt>
  <li> Attenuate random noise (reference    https://www.imagemagick.org/discourse-server/viewtopic.php?f=3&amp;t=21387).</li>
  ...
  <li> Revert sigmoidal contrast define (reference    https://www.imagemagick.org/discourse-server/viewtopic.php?f=22&amp;t=21415).</li>
...
<dt>2012-07-02  6.7.8-2 Cristy  &lt;quetzlzacatenango@image...&gt;</dt>
  <li> Set the colorspace to linear gray when reading intensity values (reference    https://www.imagemagick.org/discourse-server/viewtopic.php?f=3&amp;t=21362).</li>
...
<dt>2012-07-02  6.7.8-1 Cristy  &lt;quetzlzacatenango@image...&gt;</dt>
  <li> A single argument -stereo option now works as documented (reference    https://www.imagemagick.org/discourse-server/viewtopic.php?f=3&amp;t=21348).</li>
  <li> The -separate option returns channels as linear grayscale.</li>
  <li> Remove the sRGB color profile when converting to grayscale (reference    https://www.imagemagick.org/discourse-server/viewtopic.php?f=2&amp;t=21355).</li>
...
<dt>2012-06-28  6.8.0-0 Cristy  &lt;quetzlzacatenango@image...&gt;</dt>
  <li> Increase epsilon value, smallest difference between two points (reference    https://www.imagemagick.org/discourse-server/viewtopic.php?f=3&amp;t=15870).</li>
...
<dt>2012-06-26  6.7.7-10 Glenn Randers-Pehrson &lt;glennrp@image...&gt;</dt>
  ...
  <li> Increase PLTE chunk length to accommodate background color in indexed PNG    (reference www.imagemagick.org/discourse-server/viewtopic.php?f=1&amp;t=21288).</li>
...
<dt>2012-06-25  6.7.7-10 Cristy  &lt;quetzlzacatenango@image...&gt;</dt>
  ...
  <li> Fix conflicting types for 'GenerateDifferentialNoise' (reference    https://www.imagemagick.org/discourse-server/viewtopic.php?f=3&amp;t=21286).</li>
  <li> Fix cast to pointer from integer of different size (reference    https://www.imagemagick.org/discourse-server/viewtopic.php?f=3&amp;t=21286).</li>
  <li> Fix broken MSL profile tag (reference    https://www.imagemagick.org/discourse-server/viewforum.php?f=9).</li>
...
<dt>2012-06-09  6.7.7-8 Cristy  &lt;quetzlzacatenango@image...&gt;</dt>
  ...
  <li> XYZ and Lab colorspace conversion tweaked (reference    https://www.imagemagick.org/discourse-server/viewtopic.php?f=3&amp;t=21161).</li>
...
<dt>2012-06-01  6.7.7-6 Cristy  &lt;quetzlzacatenango@image...&gt;</dt>
  ...
  <li> Add Nicolas Robidoux's bicubic interpolation method (reference    https://www.imagemagick.org/discourse-server/viewtopic.php?f=2&amp;t=21118).    This replaces the old 'bicubic' which was very extreme 'cardinal' cubic.</li>
  <li> Add DuPont &amp; XFIG copyright to NOTICE.</li>
  <li> sRGB.icc has an unfriendly license, remove it.</li>
  <li> MinGW does not define KEY_WOW64_32KEY (reference    https://www.imagemagick.org/discourse-server/viewtopic.php?f=2&amp;t=21155).</li>
...
<dt>2012-05-28  6.7.7-3 Cristy  &lt;quetzlzacatenango@image...&gt;</dt>
  <li> Fix bug with stroke-dasharray (reference    https://www.imagemagick.org/discourse-server/viewtopic.php?f=3&amp;t=21090).</li>
  <li> In rare cases, caption would not word-wrap properly (reference    https://www.imagemagick.org/discourse-server/viewtopic.php?f=3&amp;t=21106).</li>
  <li> Don't set alpha pixels in SetImageVirtualPixelMethod() unless    image area is well defined (i.e. != 0) (reference    https://www.imagemagick.org/discourse-server/viewtopic.php?t=21110).</li>
...
<dt>2012-05-20  6.7.7-1 Cristy  &lt;quetzlzacatenango@image...&gt;</dt>
  <li> In rare cases, caption would not word-wrap properly (reference    https://www.imagemagick.org/discourse-server/viewtopic.php?f=3&amp;t=21044).</li>
  <li> Set the JPEG image colorspace after the columns / rows are set (reference    https://www.imagemagick.org/discourse-server/viewtopic.php?f=3&amp;t=21059).</li>
  <li> Potential gray images are in either the gray or RGB colorspaces.</li>
  <li> Restore MagickSetImageEndian() method (reference    https://www.imagemagick.org/discourse-server/viewtopic.php?t=20425&amp;p=81525).</li>
  <li> Respect resolution when rendering SVG (reference    https://www.imagemagick.org/discourse-server/viewtopic.php?f=3&amp;t=21076).</li>
...
<dt>2012-05-17  6.7.7-0 Cristy  &lt;quetzlzacatenango@image...&gt;</dt>
  <li> Group4-compressed TIFF / PDF image formats stopped working (reference    https://www.imagemagick.org/discourse-server/viewtopic.php?f=1&amp;t=21039).</li>
  <li> Auto convert images in the grayscale colorspace to sRGB (reference    https://www.imagemagick.org/discourse-server/viewtopic.php?f=3&amp;t=21031).</li>
...
<dt>2012-05-01  6.7.6-9 Cristy  &lt;quetzlzacatenango@image...&gt;</dt>
  <li> EXR images are in the linear RGB colorspace with a gamma of 1.0 (reference    https://www.imagemagick.org/discourse-server/viewtopic.php?f=2&amp;t=20895).</li>
  <li> Correct annotation offset for right-to-left labels (reference    https://www.imagemagick.org/discourse-server/viewtopic.php?f=3&amp;t=20884).</li>
  <li> The -level 100x0% now produces the equivalent of -negate (reference    https://www.imagemagick.org/discourse-server/viewtopic.php?f=3&amp;t=20889).</li>
  <li> Virtual pixel transparent no longer cause fatal exception (reference    https://www.imagemagick.org/discourse-server/viewtopic.php?t=20903).</li>
...
<dt>2012-04-11  6.7.6-6 Glenn Randers-Pehrson &lt;glennrp@image...&gt;</dt>
  <li> Always unlock the semaphore before returning from the png codec, either    by a "return" or png_error(); changed all Magick*Exception() calls    after setjmp() to png_error() to ensure proper cleanup (reference    https://www.imagemagick.org/discourse-server/viewtopic.php?f=3&amp;t=16883).</li>
...
<dt>2012-04-08  6.7.6-6 Cristy  &lt;quetzlzacatenango@image...&gt;</dt>
  ...
  <li> Ensure proper round trips to / from sRGB (reference    https://www.imagemagick.org/discourse-server/viewtopic.php?f=3&amp;t=20751).</li>
...
<dt>2012-04-06  6.7.6-5 Cristy  &lt;quetzlzacatenango@image...&gt;</dt>
  <li> Avoid fault in SetCacheAlphaChannel() (reference    https://www.imagemagick.org/discourse-server/viewtopic.php?f=3&amp;t=20681).</li>
...
<dt>2012-04-01  6.7.6-4 Cristy  &lt;quetzlzacatenango@image...&gt;</dt>
  <li> Properly set the XCF alpha channel values (reference    https://www.imagemagick.org/discourse-server/viewtopic.php?f=3&amp;t=20642).</li>
  <li> Support 'orientation' property (reference    https://www.imagemagick.org/discourse-server/viewtopic.php?f=2&amp;t=20650).</li>
  <li> The default RGB colorspace transform is now linear (reference    https://www.imagemagick.org/discourse-server/viewtopic.php?p=82839#p82839).</li>
...
<dt>2012-03-16  6.7.6-1 Glenn Randers-Pehrson &lt;glennrp@image...&gt;</dt>
  <li> Reduce the scope of quantum_info in the PNG decoder to avoid a possible    memory leak (reference    https://www.imagemagick.org/discourse-server/viewtopic.php?f=3&amp;t=20522).</li>
<dt>2012-03-13  6.7.6-1 Cristy  &lt;quetzlzacatenango@image...&gt;</dt>
  <li> Use uint32 pointer for ReadStripMethod in coders/tiff.c (reference    https://www.imagemagick.org/discourse-server/viewtopic.php?f=3&amp;t=20526).</li>
  <li> Ghostscript 32/64 bit detection patch (contributed by    axeld@pinc-...).</li>
  <li> Honor center gravity for caption: with Pango support (reference    https://www.imagemagick.org/discourse-server/viewtopic.php?f=3&amp;t=20517).</li>
...
<dt>2012-03-06  6.7.6-0 Cristy  &lt;quetzlzacatenango@image...&gt;</dt>
  <li> Importing from the X11 root windows no longer leaks memory (reference    https://www.imagemagick.org/discourse-server/viewtopic.php?f=3&amp;t=20470).</li>
...
<dt>2012-03-02  6.7.5-8 Glenn Randers-Pehrson &lt;glennrp@image...&gt;</dt>
  <li> non-verbose identify now reports DirectClass for transparent PNG images    to agree with the report by identify -verbose.  (reference    https://www.imagemagick.org/discourse-server/viewtopic.php?f=3&amp;t=20448 and    https://www.imagemagick.org/discourse-server/viewtopic.php?f=3&amp;t=15482).</li>
<dt>2012-02-29  6.7.5-8 Cristy  &lt;quetzlzacatenango@image...&gt;</dt>
  ...
  <li> Missing grestore from ps2.c (reference    https://www.imagemagick.org/discourse-server/viewtopic.php?f=3&amp;t=20445).</li>
...
<dt>2012-02-22  6.7.5-7 Anthony Thyssen &lt;A.Thyssen@griffith...&gt;</dt>
  <li> Re-added the Iterative Distance function in morphology (as opposed to the    faster more direct 2-pass Distance Function that replaced it) so it can be    used in the special situation of Constrained Distance Morphology.    https://www.imagemagick.org/discourse-server/viewtopic.php??f=2&amp;t=18032</li>
...
<dt>2012-01-30  6.7.5-1 Glenn Randers-Pehrson &lt;glennrp@image...&gt;</dt>
  <li> Fix bug in png coder (spurious warning, reference    https://www.imagemagick.org/discourse-server/viewtopic.php?f=1&amp;t=20257).</li>
...
<dt>2012-01-02  6.7.4-5 Glenn Randers-Pehrson &lt;glennrp@image...&gt;</dt>
  <li> Fixed -black-threshold and -white-threshold so they work properly with    the -channels option (reference    https://www.imagemagick.org/discourse-server/viewtopic.php?f=3&amp;t=20096).</li>
<dt>2012-01-02  6.7.4-5 Glenn Randers-Pehrson &lt;glennrp@image...&gt;</dt>
  <li> Removed PNG_USE_CLONE cruft from the PNG encoder (see 2011-11-19 entry)</li>
  <li> Promote image depths 9-15 to 16 to avoid crashing in the PNG    encoder (reference    https://www.imagemagick.org/discourse-server/viewtopic.php?f=3&amp;t=20098).</li>
...
<dt>2011-12-30  6.7.4-4 Glenn Randers-Pehrson &lt;glennrp@image...&gt;</dt>
  <li> Fix problems with JNG encoder "quality" (reference    https://www.imagemagick.org/discourse-server/viewtopic.php?f=3&amp;t=20076).</li>
...
<dt>2011-12-28  6.7.4-3 Cristy  &lt;quetzlzacatenango@image...&gt;</dt>
  <li> Fix memory leak in JP2 coder (reference    https://www.imagemagick.org/discourse-server/viewtopic.php?f=3&amp;t=20071).</li>
  <li> Use maximum bounds when rendering PDF (reference    https://www.imagemagick.org/discourse-server/viewtopic.php?f=3&amp;t=20078).</li>
...
<dt>2011-12-12  6.7.4-0 Cristy  &lt;quetzlzacatenango@image...&gt;</dt>
  ...
  <li> Read concatenated arcs correctly in a SVG path (reference    https://www.imagemagick.org/discourse-server/viewtopic.php?f=3&amp;t=19992).</li>
  <li> PDF's now convert properly with -define pdf:use-cropbox=true (reference    https://www.imagemagick.org/discourse-server/viewtopic.php?f=3&amp;t=20033).</li>
...
<dt>2011-11-29  6.7.4-0 Cristy  &lt;quetzlzacatenango@image...&gt;</dt>
  <li> Add GetQuantumFormat() method to return the quantum format (reference    https://www.imagemagick.org/discourse-server/viewtopic.php?f=1&amp;t=19961).</li>
  <li> Allow unspecified width/height in geometries with the aspect flag (reference    https://www.imagemagick.org/discourse-server/viewtopic.php?f=3&amp;t=19964).</li>
...
<dt>2011-11-29  6.7.3-10 Cristy  &lt;quetzlzacatenango@image...&gt;</dt>
  ...
  <li> Use viewbox offset when setting affine transform translation (reference    https://www.imagemagick.org/discourse-server/viewtopic.php?f=3&amp;t=19943).</li>
  <li> Ensure equally sized tiles for -crop 11x2@ (reference    https://www.imagemagick.org/discourse-server/viewtopic.php?f=3&amp;t=18322).</li>
  <li> Recognize SI prefixes for jpeg:extent (reference    https://www.imagemagick.org/discourse-server/viewtopic.php?f=3&amp;t=19944).</li>
...
<dt>2011-11-20  6.7.3-8 Cristy  &lt;quetzlzacatenango@image...&gt;</dt>
  ...
  <li> Set FILETYPE_REDUCEDIMAGE tag on pyramidal TIFF images (reference    https://www.imagemagick.org/discourse-server/viewtopic.php?f=3&amp;t=19892).</li>
  <li> Correct image geometry for Postscript for hi-res bounding box (reference    https://www.imagemagick.org/discourse-server/viewtopic.php?f=3&amp;t=19807).</li>
...
<dt>2011-11-18  6.7.3-7 Cristy  &lt;quetzlzacatenango@image...&gt;</dt>
  <li> Ensure embedded XML resource file is null terminated (reference    https://www.imagemagick.org/discourse-server/viewtopic.php?f=3&amp;t=19856).</li>
...
<dt>2011-11-11  6.7.3-6 Cristy  &lt;quetzlzacatenango@image...&gt;</dt>
  <li> Prefer the hires bounding box for Postscript rendering (reference    https://www.imagemagick.org/discourse-server/viewtopic.php?f=3&amp;t=19807).</li>
...
<dt>2011-11-07  6.7.3-4 Cristy  &lt;quetzlzacatenango@image...&gt;</dt>
  ...
  <li> MagickCoreGenesis() path must be accessible to use (reference    https://www.imagemagick.org/discourse-server/viewtopic.php?f=3&amp;t=19795).</li>
...
<dt>2011-11-02  6.7.3-4 Glenn Randers-Pehrson &lt;glennrp@image...&gt;</dt>
  <li> Ensure that the GIF encoder writes a large enough logical screen (reference    https://www.imagemagick.org/discourse-server/viewtopic.php?f=3&amp;t=19734).</li>
...
<dt>2011-11-02  6.7.3-3 Cristy  &lt;quetzlzacatenango@image...&gt;</dt>
  ...
  <li> Support -includearch-dir and -sharearch-dir configure option (reference    https://www.imagemagick.org/discourse-server/viewtopic.php?f=3&amp;t=19720).</li>
...
<dt>2011-11-01  6.7.3-2 Cristy  &lt;quetzlzacatenango@image...&gt;</dt>
  <li> Support Ghostscript under 64-bit Windows (reference    https://www.imagemagick.org/discourse-server/viewtopic.php?f=3&amp;t=19659).</li>
  <li> Correct affine translation for certain SVG files (reference    https://www.imagemagick.org/discourse-server/viewtopic.php?f=3&amp;t=19664).</li>
  <li> -evaluate-sequence multiply no longer hangs ereference    https://www.imagemagick.org/discourse-server/viewtopic.php?f=3&amp;t=19549).</li>
...
<dt>2011-10-15  6.7.3-1 Cristy  &lt;quetzlzacatenango@image...&gt;</dt>
  ...
  <li> Fix "test: no: unexpected operator" in the configure script (reference    https://www.imagemagick.org/discourse-server/viewtopic.php?f=3&amp;t=19615).</li>
  <li> Off by one error when writing the JPEG XMP profile (reference    https://www.imagemagick.org/discourse-server/viewtopic.php?f=3&amp;t=19616).</li>
  <li> Revert GetPathComponent() patch.</li>
<dt>2011-10-09  6.7.3-0 Cristy  &lt;quetzlzacatenango@image...&gt;</dt>
  <li> New version 6.7.3-0.</li>
<dt>2011-10-09  6.7.3-0 Cristy  &lt;quetzlzacatenango@image...&gt;</dt>
  <li> Generate output for caption:"[!]" (reference    https://www.imagemagick.org/discourse-server/viewtopic.php?f=1&amp;t=19589.</li>
...
<dt>2011-10-04  6.7.2-10 Cristy  &lt;quetzlzacatenango@image...&gt;</dt>
  ...
  <li> Fix bug in -evaluate-sequence multiply (reference    https://www.imagemagick.org/discourse-server/viewtopic.php?f=3&amp;t=19549).</li>
...
<dt>2011-09-20  6.7.2-8 Cristy  &lt;quetzlzacatenango@image...&gt;</dt>
  <li> Prevent infinite loop when font is too large for specified width (reference    https://www.imagemagick.org/discourse-server/viewtopic.php?f=3&amp;t=19502).</li>
...
<dt>2011-09-05  6.7.2-3 Cristy  &lt;quetzlzacatenango@image...&gt;</dt>
  <li> A small memory overwrite when reading TIFF with 1-bit alpha (reference    https://www.imagemagick.org/discourse-server/viewtopic.php?f=3&amp;t=19417).</li>
...
<dt>2011-08-31  6.7.2-2 Cristy  &lt;quetzlzacatenango@image...&gt;</dt>
  <li> Write grayscale MIFF as a single gray pixel component, not RGB (reference    https://www.imagemagick.org/discourse-server/viewtopic.php?f=2&amp;t=19403).</li>
  ...
  <li> Account for DCm bits allocated 16 and significant bits 12 (reference    https://www.imagemagick.org/discourse-server/viewtopic.php?f=3&amp;t=19420).</li>
  <li> Fix bug when appending JPEG image profiles (reference    https://www.imagemagick.org/discourse-server/viewtopic.php?f=3&amp;t=19429).</li>
...
<dt>2011-08-22  6.7.1-10 Cristy  &lt;quetzlzacatenango@image...&gt;</dt>
  <li> Revert FormatImageAttributeList(), FormatImagePropertyList() (reference    https://www.imagemagick.org/discourse-server/viewtopic.php?f=3&amp;t=19339).</li>
...
<dt>2011-08-20  6.7.1-9 Cristy  &lt;quetzlzacatenango@image...&gt;</dt>
  <li> Fix memory leak in text annotation (reference    https://www.imagemagick.org/discourse-server/viewtopic.php?f=1&amp;t=19331).</li>
<dt>2011-08-18  6.7.1-9 Glenn Randers-Pehrson &lt;glennrp@image...&gt;</dt>
  ...
  <li> When writing a PNG8 and more than one transparent color is present,  merge them into the image-&gt;background_color (Reference  https://www.imagemagick.org/discourse-server/viewtopic.php?f=1&amp;t=19329),  finishing the implementation started in version 6.6.8-7.</li>
<dt>2011-08-18  6.7.1-8 Cristy  &lt;quetzlzacatenango@image...&gt;</dt>
  <li> New version 6.7.1-8.</li>
<dt>2011-08-18  6.7.1-8 Cristy  &lt;quetzlzacatenango@image...&gt;</dt>
  <li> Caption now wraps properly for Chinese text (reference    https://www.imagemagick.org/discourse-server/viewtopic.php?f=3&amp;t=19249).</li>
<dt>2011-08-18  6.7.1-8 Glenn Randers-Pehrson &lt;glennrp@image...&gt;</dt>
  <li> The PNG encoder would sometimes fail to respect the -define PNG:color-type    option when the incoming image was PseudoClass (reference    https://www.imagemagick.org/discourse-server/viewtopic.php?f=1&amp;t=19262).</li>
...
<dt>2011-08-10  6.7.1-5 Cristy  &lt;quetzlzacatenango@image...&gt;</dt>
  <li> Revert -colorspace sRGB option patch (reference    https://www.imagemagick.org/discourse-server/viewtopic.php?f=3&amp;t=19256).</li>
  <li> Revert -type PaletteMatte option patch (reference    https://www.imagemagick.org/discourse-server/viewtopic.php?f=3&amp;t=19263</li>
...
<dt>2011-08-05  6.7.1-3 Cristy  &lt;quetzlzacatenango@image...&gt;</dt>
  <li> Use MultiByteToWideChar() for Windows filenames (reference    https://www.imagemagick.org/discourse-server/viewtopic.php?f=3&amp;t=19242).</li>
...
<dt>2011-06-30  6.7.0-10 Glenn Randers-Pehrson &lt;glennrp@image...&gt;</dt>
  <li> Added "-define PNG:compression-level|strategy|filter=value" options to    the PNG encoder.  If these options are used, they take precedence over    the -quality option (reference    https://www.imagemagick.org/discourse-server/viewtopic.php?&amp;f=1&amp;p=73548).</li>
...
<dt>2011-06-28  6.7.0-10 Cristy  &lt;quetzlzacatenango@image...&gt;</dt>
  <li> Properly allocate points when render text with large font size (reference    https://www.imagemagick.org/discourse-server/viewtopic.php?f=3&amp;t=18997).</li>
...
<dt>2011-06-08  6.7.0-7 Glenn Randers-Pehrson &lt;glennrp@image...&gt;</dt>
  <li> The PNG encoder would sometimes make black pixels transparent when some    other gray level was supposed to be the transparent color (reference    https://www.imagemagick.org/discourse-server/viewtopic.php?f=3&amp;t=18900).    This occurred only with 1, 2, 4-bit grayscale images with Q16 or Q32    builds.</li>
...
<dt>2011-05-25  6.7.0-1 Cristy  &lt;quetzlzacatenango@image...&gt;</dt>
  <li> Not all Linux'es define locale_t (reference    https://www.imagemagick.org/discourse-server/viewtopic.php?f=3&amp;t=18819).</li>
...
<dt>2011-05-21  6.7.0-0 Cristy  &lt;quetzlzacatenango@image...&gt;</dt>
  ...
  <li> Avoid fault on certain DJVU images (reference    https://www.imagemagick.org/discourse-server/viewtopic.php?f=3&amp;t=18807).</li>
  <li> Fix -fx to interpret scientific notation properly.</li>
...
<dt>2011-05-20  6.6.9-10 Glenn Randers-Pehrson &lt;glennrp@image...&gt;</dt>
  <li> The PNG encoder now respects the -depth setting, including 1, 2, 4.    Previously settings other than 8 and 16 were ignored (reference    https://www.imagemagick.org/discourse-server/viewtopic.php?f=3&amp;t=18412).</li>
<dt>2011-05-16  6.6.9-10 Cristy  &lt;quetzlzacatenango@image...&gt;</dt>
  <li> Don't use comma as a separator for stroked text (reference    https://www.imagemagick.org/discourse-server/viewtopic.php?f=3&amp;t=18742).</li>
...
<dt>2011-04-27  6.6.9-7 Cristy  &lt;quetzlzacatenango@image...&gt;</dt>
  <li> Fix pixel interpolation for -draw 'image Over' (reference    https://www.imagemagick.org/discourse-server/viewtopic.php?f=3&amp;t=18612).</li>
<dt>2011-04-26  6.6.9-7 Glenn Randers-Pehrson &lt;glennrp@image...&gt;</dt>
  <li> Write the proper bKGD chunk value in grayscale PNG images (reference    https://www.imagemagick.org/discourse-server/viewtopic.php?f=3&amp;t=18624).</li>
...
<dt>2011-04-18  6.6.9-6 Glenn Randers-Pehrson &lt;glennrp@image...&gt;</dt>
  ...
  <li> Added "-define PNG:preserve-colormap" option (reference    https://www.imagemagick.org/discourse-server/viewtopic.php?f=3&amp;t=18564).</li>
...
<dt>2011-04-15  6.6.9-5 Glenn Randers-Pehrson &lt;glennrp@image...&gt;</dt>
  <li> Added "#define PNG_PTR_NORETURN" because this macro does not work    on all platforms with libpng15, with failure to load png_longjmp() (ref    https://www.imagemagick.org/discourse-server/viewtopic.php?f=3&amp;t=18518).</li>
...
<dt>2011-04-02  6.6.9-4 Glenn Randers-Pehrson &lt;glennrp@image...&gt;</dt>
  ...
  <li> Remove any bogus colormap received by the PNG encoder with an image    that is not PseudoClass (reference    https://www.imagemagick.org/discourse-server/viewtopic.php?f=3&amp;t=18475).</li>
...
<dt>2011-04-01  6.6.9-3 Cristy  &lt;quetzlzacatenango@image...&gt;</dt>
  <li> Set the caption height correctly for missing row geometry (reference    https://www.imagemagick.org/discourse-server/viewtopic.php?f=3&amp;t=18447).</li>
...
<dt>2011-03-25  6.6.8-8 Cristy  &lt;quetzlzacatenango@image...&gt;</dt>
  <li> Fix memory access bug in CloneString() (reference    https://www.imagemagick.org/discourse-server/viewtopic.php?f=2&amp;t=18382).</li>
...
<dt>2011-03-24  6.6.8-7 Cristy  &lt;quetzlzacatenango@image...&gt;</dt>
  <li> Add support for 16-bit DCM short ints (reference    https://www.imagemagick.org/discourse-server/viewtopic.php?f=3&amp;t=18371).</li>
...
<dt>2011-03-21  6.6.8-7 Glenn Randers-Pehrson &lt;glennrp@image...&gt;</dt>
  ...
  <li> Force the PNG encoder to return image-&gt;matte==MagickTrue when the    format is RGBA or GA or if the tRNS chunk is present, even when the    image is fully opaque (reference    https://www.imagemagick.org/discourse-server/viewtopic.php?f=3&amp;t=18349).</li>
...
<dt>2011-03-21  6.6.8-6 Glenn Randers-Pehrson &lt;glennrp@image...&gt;</dt>
  <li> Re-enabled reduction of grayscale images (color-type 0) to 2 or 4 bits    when appropriate (reference    https://www.imagemagick.org/discourse-server/viewtopic.php?f=3&amp;t=18098).</li>
  <li> The "-define PNG:color-type=4" option did not always force the PNG    encoder to write an all-opaque alpha channel (reference    https://www.imagemagick.org/discourse-server/viewtopic.php?f=3&amp;t=18349).</li>
<dt>2011-03-14  6.6.8-6 Cristy  &lt;quetzlzacatenango@image...&gt;</dt>
  <li> Fixed memory leak for PDF and Bitmap PSD RLE support (reference    https://www.imagemagick.org/discourse-server/viewtopic.php?f=3&amp;t=18317).</li>
...
<dt>2011-03-14  6.6.8-5 Glenn Randers-Pehrson &lt;glennrp@image...&gt;</dt>
  ...
  <li> Don't write text-encoded profile when "-define PNG:exclude-chunk=text,ztxt"    is present (reference    https://www.imagemagick.org/discourse-server/viewtopic.php?f=3&amp;t=17086 and    https://www.imagemagick.org/discourse-server/viewtopic.php?f=3&amp;t=18225).</li>
...
<dt>2011-03-11  6.6.8-4 Glenn Randers-Pehrson &lt;glennrp@image...&gt;</dt>
  <li> Don't try to store a bKGD chunk in a PNG8 when there are already    256 colors in the palette and the background colors is not in that    palette (reference    https://www.imagemagick.org/discourse-server/viewtopic.php?f=3&amp;t=18199);</li>
  <li> The "-define PNG:exclude-chunk=bKGD" option was also excluding    the text chunks. (reference    https://www.imagemagick.org/discourse-server/viewtopic.php?f=3&amp;t=18253).</li>
<dt>2011-03-10  6.6.8-4 Cristy  &lt;quetzlzacatenango@image...&gt;</dt>
  ...
  <li> No image scene suffix for filenames that include a single bracket (reference    https://www.imagemagick.org/discourse-server/viewtopic.php?f=3&amp;t=18267).</li>
...
<dt>2011-03-06  6.6.8-2 Glenn Randers-Pehrson &lt;glennrp@image...&gt;</dt>
  <li> Throw error message when the requested color-type or bit-depth    cannot be written by the PNG encoder (error was being thrown    into the wrong image structure).  (Reference    https://www.imagemagick.org/discourse-server/viewtopic.php?f=3&amp;t=18162).</li>
  <li> Don't write a PNG text chunk with "density" keyword that overrides the    PNG pHYs chunk, if the pHYs chunk was not excluded (reference    https://www.imagemagick.org/discourse-server/viewtopic.php?f=3&amp;t=18253).</li>
...
<dt>2011-02-27  6.6.8-0 Glenn Randers-Pehrson &lt;glennrp@image...&gt;</dt>
  ...
  <li> Delay opening the PNG output blob until the PNG encoder is ready    to write the IHDR chunk, to avoid writing zero-length PNG files when    errors are found while building the palette.  (reference    https://www.imagemagick.org/discourse-server/viewtopic.php?f=3&amp;t=18162).</li>
...
<dt>2011-02-23  6.6.7-10 Cristy  &lt;quetzlzacatenango@image...&gt;</dt>
  ...
  <li> Get rid of 'respect_parenthesis defined but not used' warnings (reference    https://www.imagemagick.org/discourse-server/viewtopic.php?f=2&amp;t=18173).</li>
...
<dt>2011-02-22  6.6.7-9 Glenn Randers-Pehrson &lt;glennrp@image...&gt;</dt>
  <li> Disabled reduction of grayscale images (color-type 0) to less than 8 bits    when writing because this sometimes produced incorrect output (reference    https://www.imagemagick.org/discourse-server/viewtopic.php?f=3&amp;t=18098).</li>
<dt>2011-02-21  6.6.7-9 Cristy  &lt;quetzlzacatenango@image...&gt;</dt>
  <li> Check image has properties before accessing the splay tree (reference    https://www.imagemagick.org/discourse-server/viewtopic.php?f=3&amp;t=18136).</li>
...
<dt>2011-02-14  6.6.7-8 Glenn Randers-Pehrson &lt;glennrp@image...&gt;</dt>
  <li> The PNG encoder should ignore bogus q-&gt;opacity values when image-&gt;matte    is MagickFalse (reference    https://www.imagemagick.org/discourse-server/viewtopic.php?f=3&amp;t=18067).</li>
...
<dt>2011-02-08  6.6.7-7 Cristy  &lt;quetzlzacatenango@image...&gt;</dt>
  ...
  <li> Posterize now distributes color uniformly (reference    https://www.imagemagick.org/discourse-server/viewtopic.php?f=3&amp;t=17623).</li>
  <li> Add -smush option (reference    https://www.imagemagick.org/discourse-server/viewtopic.php?f=1&amp;t=17953).</li>
  <li> Repair memory leak in the display program.</li>
<dt>2011-02-07  6.6.7-6 Cristy  &lt;quetzlzacatenango@image...&gt;</dt>
  <li> Fix bug in carg() define when HAVE_COMPLEX is not defined (reference    https://www.imagemagick.org/discourse-server/viewtopic.php?f=3&amp;t=18030).</li>
...
<dt>2011-02-02  6.6.7-5 Cristy  &lt;quetzlzacatenango@image...&gt;</dt>
  <li> Check if the font is null in RenderFreetype() to prevent fault (reference    https://www.imagemagick.org/discourse-server/viewtopic.php?f=3&amp;t=17890).</li>
  <li> Eliminate fault when reading WMF image files (reference    https://www.imagemagick.org/discourse-server/viewtopic.php?f=2&amp;t=17971).</li>
...
<dt>2011-01-25  6.6.7-3 Glenn Randers-Pehrson &lt;glennrp@image...&gt;</dt>
  <li> Removed a call to GetNumberColors() from the PNG encoder that was    only there for debugging purposes and was consuming a huge amount    of CPU time. (reference    https://www.imagemagick.org/discourse-server/viewtopic.php?f=2&amp;t=17799).</li>
  <li> Sometimes black was still written as transparent, when the PNG    encoder received an image with image-&gt;matte==true but no transparent    pixels were present. (reference    https://www.imagemagick.org/discourse-server/viewtopic.php?f=3&amp;t=17913);</li>
<dt>2011-01-24  6.6.7-3 Cristy  &lt;quetzlzacatenango@image...&gt;</dt>
  <li> Remove memory leak from ThrowFileException() macro (reference    https://www.imagemagick.org/discourse-server/viewtopic.php?f=3&amp;t=17908).</li>
...
<dt>2011-01-14  6.6.7-1 Glenn Randers-Pehrson &lt;glennrp@image...&gt;</dt>
  <li> Don't let the PNG encoder try to sort the colormap when there are more    than 256 colors in the image. (reference    https://www.imagemagick.org/discourse-server/viewtopic.php?f=3&amp;t=17834).</li>
<dt>2011-01-10  6.6.7-1 Cristy  &lt;quetzlzacatenango@image...&gt;</dt>
  <li> Accept escaped % in output filename (reference    https://www.imagemagick.org/discourse-server/viewtopic.php?f=3&amp;t=17810).</li>
...
<dt>2011-01-01  6.6.6-10 Glenn Randers-Pehrson &lt;glennrp@image...&gt;</dt>
  <li> The PNG decoder now checks whether the image actually has any transparency    when the input file contains an alpha channel or a tRNS chunk.  (Reference    https://www.imagemagick.org/discourse-server/viewtopic.php?f=3&amp;t=17748)</li>
<dt>2010-12-26  6.6.6-8 Cristy  &lt;quetzlzacatenango@image...&gt;</dt>
  <li> -posterize fails with more than 40 levels (reference    https://www.imagemagick.org/discourse-server/viewtopic.php?f=3&amp;t=17741).</li>
...
<dt>2010-12-14  6.6.6-6 Cristy  &lt;quetzlzacatenango@image...&gt;</dt>
  <li> -format "%[fx:u.p{5,5}]" no longer reports parse exception (reference    https://www.imagemagick.org/discourse-server/viewtopic.php?f=3&amp;t=17678).</li>
<dt>2010-12-10  6.6.6-5 Glenn Randers-Pehrson &lt;glennrp@image...&gt;</dt>
  <li> Make the PNG encoder always rebuild the palette, to avoid losing    transparency when it is out of sync with the pixel data (reference    https://www.imagemagick.org/discourse-server/viewtopic.php?f=3&amp;t=17655).</li>
...
<dt>2010-12-10  6.6.6-5 Cristy  &lt;quetzlzacatenango@image...&gt;</dt>
  <li> Account for virtual canvas for the -flip / -flop options (reference    https://www.imagemagick.org/discourse-server/viewtopic.php?f=1&amp;t=17626).</li>
...
<dt>2010-12-03  6.6.6-3 Glenn Randers-Pehrson &lt;glennrp@image...&gt;</dt>
  <li> Fixed two more cases where the PNG encoder lost transparency (reference    https://www.imagemagick.org/discourse-server/viewtopic.php?f=3&amp;t=17516).</li>
<dt>2010-12-01  6.6.6-2 Cristy  &lt;quetzlzacatenango@image...&gt;</dt>
  <li> Affine multiplication reversed when translating (reference    https://www.imagemagick.org/discourse-server/viewtopic.php?f=3&amp;t=17570).</li>
...
<dt>2010-11-17  6.6.5-9 Glenn Randers-Pehrson &lt;glennrp@image...&gt;</dt>
  <li> Many of the problems with the PNG encoder have been fixed (reference    https://www.imagemagick.org/discourse-server/viewtopic.php?f=3&amp;t=16490).</li>
...
<dt>2010-11-08  6.6.5-8 Cristy  &lt;quetzlzacatenango@image...&gt;</dt>
  ...
  <li> %[fx:mean] is the mean of the default channels (all but opacity) (reference    https://www.imagemagick.org/discourse-server/viewtopic.php?f=1&amp;t=17432).</li>
...
<dt>2010-10-30  6.6.5-5 Cristy  &lt;quetzlzacatenango@image...&gt;</dt>
  ...
  <li> Allow numeric characters in the XPM basename (reference    https://www.imagemagick.org/discourse-server/viewtopic.php?f=3&amp;t=17385).</li>
...
<dt>2010-10-10  6.6.5-0 Cristy  &lt;quetzlzacatenango@image...&gt;</dt>
  <li> Patch for  DrawableRotation() and DrawableTranslation() (reference    https://www.imagemagick.org/discourse-server/viewtopic.php?f=3&amp;t=17246).</li>
...
<dt>2010-10-03  6.6.4-9 Cristy  &lt;quetzlzacatenango@image...&gt;</dt>
  <li> Fix memory assertion with --enable-embeddable (reference    https://www.imagemagick.org/discourse-server/viewtopic.php?f=3&amp;t=17201).</li>
  <li> Don't permit access to pixels when pinging an image (reference    https://www.imagemagick.org/discourse-server/viewtopic.php?f=3&amp;t=17194).</li>
...
<dt>2010-09-28  6.6.4-8 Cristy  &lt;quetzlzacatenango@image...&gt;</dt>
  <li> Temporary files not always deleted (reference    https://www.imagemagick.org/discourse-server/viewtopic.php?f=2&amp;t=15960).</li>
...
<dt>2010-09-26  6.6.4-6 Cristy  &lt;quetzlzacatenango@image...&gt;</dt>
  <li> Don't allow resize filter weights to go to zero (reference    https://www.imagemagick.org/discourse-server/viewtopic.php?f=3&amp;t=17132).</li>
...
<dt>2010-09-21  6.6.4-6 Cristy  &lt;quetzlzacatenango@image...&gt;</dt>
  <li> Do not break words if caption size is absolute (reference    https://www.imagemagick.org/discourse-server/viewtopic.php?f=1&amp;t=17123).</li>
...
<dt>2010-08-31  6.6.4-0 Cristy  &lt;quetzlzacatenango@image...&gt;</dt>
  <li> Path no longer closed if join style is round (reference    https://www.imagemagick.org/discourse-server/viewtopic.php?f=3&amp;t=16943).</li>
...
<dt>2010-08-23  6.6.3-10 Cristy  &lt;quetzlzacatenango@image...&gt;</dt>
  <li> Fixed bug in the raw BGRA coders (reference    https://www.imagemagick.org/discourse-server/viewtopic.php?f=3&amp;t=16880).</li>
  ...
  <li> Eliminate a small memory leak in LevelizeImageChannel() (reference    https://www.imagemagick.org/discourse-server/viewtopic.php?f=3&amp;t=16951).</li>
  <li> Recognize -fx logtwo (reference    https://www.imagemagick.org/discourse-server/viewtopic.php?f=3&amp;t=16958).</li>
...
<dt>2010-08-13  6.6.3-6 Cristy  &lt;quetzlzacatenango@image...&gt;</dt>
  <li> The AdobeRgb.tif TIFF image no longer faults under Windows (reference    https://www.imagemagick.org/discourse-server/viewtopic.php?f=3&amp;t=16838).</li>
  <li> Add -subimage-search option to the compare utility.</li>
<dt>2010-08-12  6.6.3-5 Cristy  &lt;quetzlzacatenango@image...&gt;</dt>
  <li> The -fx 2e+6/1e+5 argument no longer returns the wrong results (reference    https://www.imagemagick.org/discourse-server/viewtopic.php?f=3&amp;t=16833).</li>
...
<dt>2010-08-07  6.6.3-4 Cristy  &lt;quetzlzacatenango@image...&gt;</dt>
  <li> The orient option sometimes improperly set "undefined" (reference    https://www.imagemagick.org/discourse-server/viewtopic.php?f=3&amp;t=16795).</li>
  <li> Only list orientation options for the -list orientation option (reference    https://www.imagemagick.org/discourse-server/viewtopic.php?f=3&amp;t=16801).</li>
  <li> Return proper standard deviation for combined channels (reference    https://www.imagemagick.org/discourse-server/viewtopic.php?f=3&amp;t=16786).</li>
...
<dt>2010-07-09  6.6.3-1 Cristy  &lt;quetzlzacatenango@image...&gt;</dt>
  <li> Fix memory leak in for corrupt BMP images (reference    https://www.imagemagick.org/discourse-server/viewtopic.php?f=3&amp;t=16600).</li>
  <li> Repair several issues when writing to stdout (reference    https://www.imagemagick.org/discourse-server/viewtopic.php?f=3&amp;t=16620).</li>
  <li> A GIF image with the .bgr extension is still a GIF (reference    https://www.imagemagick.org/discourse-server/viewtopic.php?f=3&amp;t=16662).</li>
...
<dt>2010-06-22  6.6.2-8 Cristy  &lt;quetzlzacatenango@image...&gt;</dt>
  <li> Skip byte when DDS bitcount is 32 (reference    https://www.imagemagick.org/discourse-server/viewtopic.php?f=3&amp;t=16487).</li>
...
<dt>2010-05-24  6.6.2-1 Cristy  &lt;quetzlzacatenango@image...&gt;</dt>
  ...
  <li> Prevent MNG divide by zero in calculation of frame_delay (reference    https://www.imagemagick.org/discourse-server/viewtopic.php?f=3&amp;t=16320).</li>
...
<dt>2010-05-15  6.6.1-10 Cristy  &lt;quetzlzacatenango@image...&gt;</dt>
  <li> Use ScaleCharToQuantum() in coders/src.c (reference    https://www.imagemagick.org/discourse-server/viewtopic.php?f=3&amp;t=16229).</li>
...
<dt>2010-04-24  6.6.1-6 Cristy  &lt;quetzlzacatenango@image...&gt;</dt>
  ...
  <li> Register / unregister CALS format in static.c (reference    https://www.imagemagick.org/discourse-server/viewtopic.php?f=2&amp;t=16103).</li>
...
<dt>2010-04-17  6.6.1-5 Cristy  &lt;quetzlzacatenango@image...&gt;</dt>
  ...
  <li> Match on literal after backslash in glob expression (reference    https://www.imagemagick.org/discourse-server/viewtopic.php?f=3&amp;t=16068).</li>
  <li> Enable JPEG-compression for grayscale TIFF images (reference    https://www.imagemagick.org/discourse-server/viewtopic.php?f=3&amp;t=16064).</li>
  <li> Don't write empty tile if tile geometry matches the image width (reference    https://www.imagemagick.org/discourse-server/viewtopic.php?f=3&amp;t=16064).</li>
  <li> Support -regard-warnings in the mogrify utility.</li>
  <li> Output the correct units for the identify utility (reference    https://www.imagemagick.org/discourse-server/viewtopic.php?f=3&amp;t=16075).</li>
...
<dt>2010-03-21  6.6.0-10 Cristy  &lt;quetzlzacatenango@image...&gt;</dt>
  ...
  <li> Distort barrel no longer complains when 3 arguments are given (reference    https://www.imagemagick.org/discourse-server/viewtopic.php?f=3&amp;t=15883).</li>
...
<dt>2010-03-21  6.6.0-9 Cristy  &lt;quetzlzacatenango@image...&gt;</dt>
  <li> Windows does not support complex.h (reference    https://www.imagemagick.org/discourse-server/viewtopic.php?f=1&amp;t=15808).</li>
...
<dt>2010-03-18  6.6.0-8 Cristy  &lt;quetzlzacatenango@image...&gt;</dt>
  ...
  <li> Don't gamma correct log to linear color conversion unless the -gamma is    specified (reference    https://www.imagemagick.org/discourse-server/viewtopic.php?f=1&amp;t=15799).</li>
...
<dt>2010-03-13  6.6.0-6 Cristy  &lt;quetzlzacatenango@image...&gt;</dt>
  ...
  <li> The default Helvetica font is not always available, check for    Century Schoolbook too (reference    https://www.imagemagick.org/discourse-server/viewtopic.php?f=2&amp;t=15780).</li>
...
<dt>2010-02-27  6.6.0-1 Cristy  &lt;quetzlzacatenango@image...&gt;</dt>
  ...
  <li> Add support for -fx airy(), j0(), j1(), jinc(), and sinc() (reference    https://www.imagemagick.org/discourse-server/viewtopic.php?f=2&amp;t=15685).    Anthony, review these for correctness.</li>
...
<dt>2010-02-09  6.5.9-4 Cristy  &lt;quetzlzacatenango@image...&gt;</dt>
  <li> Resolve "too many open files"  (reference    https://www.imagemagick.org/discourse-server/viewtopic.php?f=3&amp;t=15546).</li>
...
<dt>2010-01-01  6.5.9-0 Cristy  &lt;quetzlzacatenango@image...&gt;</dt>
  ...
  <li> Support heterogeneous distributed processing, see    https://www.imagemagick.org/script/architecture.php#distributed.</li>
...
<dt>2009-12-18  6.5.8-7 Cristy  &lt;quetzlzacatenango@image...&gt;</dt>
  ...
  <li> The -gaussian-blur over blurred the opacity channel (reference    https://www.imagemagick.org/discourse-server/viewtopic.php?f=3&amp;t=15218).</li>
...
<dt>2009-12-03  6.5.8-3 Cristy  &lt;quetzlzacatenango@image...&gt;</dt>
  <li> It's interword-spacing, not interword_spacing (reference    https://www.imagemagick.org/discourse-server/viewtopic.php?f=3&amp;t=1515).</li>
...
<dt>2009-11-19  6.5.8-0 Cristy  &lt;quetzlzacatenango@image...&gt;</dt>
  ...
  <li> SetLogFormat() no longer causes crash (reference    https://www.imagemagick.org/discourse-server/viewtopic.php?f=3&amp;t=15091).</li>
...
<dt>2009-11-18  6.5.7-9 Cristy  &lt;quetzlzacatenango@image...&gt;</dt>
  ...
  <li> Cairo format returns pixels with the alpha premultiplied (reference    https://www.imagemagick.org/discourse-server/viewtopic.php?f=2&amp;t=15081).</li>
...
<dt>2009-08-10  6.5.5-0 Cristy  &lt;quetzlzacatenango@image...&gt;</dt>
  ...
  <li> Clone ImageInfo members scene and number_scenes (reference    https://www.imagemagick.org/discourse-server/viewtopic.php?f=2&amp;t=14437).</li>
  ...
  <li> MVG partial opacity not set properly (reference    https://www.imagemagick.org/discourse-server/viewtopic.php?f=6&amp;t=14442).</li>
  <li> Black channel was not blurring properly (reference    https://www.imagemagick.org/discourse-server/viewtopic.php?f=3&amp;t=14473).</li>
<dt>2009-08-06  6.5.4-10 Cristy  &lt;quetzlzacatenango@image...&gt;</dt>
  ...
  <li> SVG permits multiple arc paths with an omitted 'A' (reference    https://www.imagemagick.org/discourse-server/viewtopic.php?f=6&amp;t=14377).</li>
  <li> The 'skewY' MVG attribute produced incorrect angles (reference    https://www.imagemagick.org/discourse-server/viewtopic.php?f=6&amp;t=14144).</li>
...
<dt>2009-07-28  6.5.4-7 Cristy  &lt;quetzlzacatenango@image...&gt;</dt>
  <li> The -thumbnail option no longer removes color profiles (reference    https://www.imagemagick.org/discourse-server/viewtopic.php?f=2&amp;t=14312).</li>
  <li> Do not scale real / imaginary FFT / IFT.</li>
  <li> Check for localtime() NULL return.</li>
  <li> import --help requires an X server (reference    https://www.imagemagick.org/discourse-server/viewtopic.php?f=3&amp;t=14323).</li>
  <li> Fails to load MS Windows icons with compressed PNG elements (reference    https://www.imagemagick.org/discourse-server/viewtopic.php?f=3&amp;t=14324).</li>
...
<dt>2009-07-21  6.5.4-4 Cristy  &lt;quetzlzacatenango@image...&gt;</dt>
  ...
  <li> More than one -dispose setting overwrote previous settings (reference    https://www.imagemagick.org/discourse-server/viewtopic.php?f=1&amp;t=14252).</li>
...
<dt>2009-06-23  6.5.4-0 Anthony Thyssen &lt;A.Thyssen@griffith...&gt;</dt>
  <li> Automatic determination of B from C and C from B for a 'Keys Filter'    when using the B,C Cubic Filter Expert options was broken.    See https://www.imagemagick.org/discourse-server/viewtopic.php?f=3&amp;t=14037</li>
...
<dt>2009-05-29  6.5.3-0 Cristy  &lt;quetzlzacatenango@image...&gt;</dt>
  <li> Do not treat -page as a global option (reference    https://www.imagemagick.org/discourse-server/viewtopic.php?f=3&amp;t=13864).</li>
...
<dt>2009-05-04  6.5.2-1 Chris Madison  &lt;madisonblu@gmail...&gt;</dt>
  ...
  <li> Duplicate line in tiff.c breaking read of zip compressed tif (reference    https://www.imagemagick.org/discourse-server/viewtopic.php?f=3&amp;t=13688).</li>
...
<dt>2009-05-02  6.5.2-0 Chris Madison  &lt;madisonblu@gmail...&gt;</dt>
  ...
  <li> Generate a proper file path for -path @filelist.txt (reference    https://www.imagemagick.org/discourse-server/viewtopic.php?f=1&amp;t=13671).</li>
...
<dt>2009-04-30  6.5.1-10 Cristy  &lt;quetzlzacatenango@image...&gt;</dt>
  <li> Do not return a black image for -channel RGBA -gaussian (reference    https://www.imagemagick.org/discourse-server/viewtopic.php?f=3&amp;t=13669).</li>
...
<dt>2009-04-25  6.5.1-9 Cristy  &lt;quetzlzacatenango@image...&gt;</dt>
  <li> Generate BMP 32-bit ARGB format for images with transparency (reference    https://www.imagemagick.org/discourse-server/viewtopic.php?f=3&amp;t=13633).</li>
<dt>2009-04-24  6.5.1-7 Cristy  &lt;quetzlzacatenango@image...&gt;</dt>
  <li> Grok 'image.psd[0]' and 'image.mpg[0]' (reference    https://www.imagemagick.org/discourse-server/viewtopic.php?f=1&amp;t=13609).</li>
  <li> Normalize similarity based on reconstruction not the original (reference    https://www.imagemagick.org/discourse-server/viewtopic.php?f=3&amp;t=13626).</li>
...
<dt>2009-04-17  6.5.1-3 Cristy  &lt;quetzlzacatenango@image...&gt;</dt>
  <li> The display program now returns a 0 exit code on success (reference    https://www.imagemagick.org/discourse-server/viewtopic.php?f=3&amp;t=13579).</li>
...
<dt>2009-04-13  6.5.1-3 Cristy  &lt;quetzlzacatenango@image...&gt;</dt>
  <li> MVG autodetection failing (reference    https://www.imagemagick.org/discourse-server/viewtopic.php?f=1&amp;t=13542).</li>
<dt>2009-04-11  6.5.1-2 Cristy  &lt;quetzlzacatenango@image...&gt;</dt>
  <li> Image not properly placed when displaying to the X server root (reference    https://www.imagemagick.org/discourse-server/viewtopic.php?f=3&amp;t=13532).</li>
  <li> fmax() is not support on some platforms (reference    https://www.imagemagick.org/discourse-server/viewtopic.php?f=3&amp;t=13533).</li>
...
<dt>2009-04-01  6.5.1-1 Cristy  &lt;quetzlzacatenango@image...&gt;</dt>
  <li> Default to min-is-white Photometric for fax / group4 compression (reference    https://www.imagemagick.org/discourse-server/viewtopic.php?f=3&amp;t=13468).</li>
  <li> Respect image resolution when setting PDF MediaBox (reference    https://www.imagemagick.org/discourse-server/viewtopic.php?f=1&amp;t=13350).</li>
...
<dt>2009-03-28  6.5.0-10 Cristy  &lt;quetzlzacatenango@image...&gt;</dt>
  ...
  <li> Unexpected end-of-file @ xwd.c/ReadXWDImage/252 (reference    https://www.imagemagick.org/discourse-server/viewtopic.php?f=3&amp;t=13430).</li>
...
<dt>2009-03-25  6.5.0-8 Cristy  &lt;quetzlzacatenango@image...&gt;</dt>
  <li> Fix assertion in IntegralRotateImage (reference    https://www.imagemagick.org/discourse-server/viewtopic.php?f=3&amp;t=13410).</li>
<dt>2009-03-24  6.5.0-7 Cristy  &lt;quetzlzacatenango@image...&gt;</dt>
  <li> Referenced counted blob incremented incorrectly in CloneImage() (reference    https://www.imagemagick.org/discourse-server/viewtopic.php?f=3&amp;t=13410).</li>
<dt>2009-03-23  6.5.0-6 Chris Madison  &lt;madisonblu@gmail...&gt;</dt>
  <li> Assertion failure reading PSD image (reference    https://www.imagemagick.org/discourse-server/viewtopic.php?f=3&amp;t=13397).</li>
...
<dt>2009-03-21  6.5.0-4 ERB  &lt;entropy@xebec...&gt;</dt>
  <li> Missing locks in blob - race condition (reference    https://www.imagemagick.org/discourse-server/viewtopic.php?f=3&amp;t=13385).</li>
<dt>2009-03-19  6.5.0-3 Chris Madison  &lt;madisonblu@gmail...&gt;</dt>
  <li> Use default SVG resolution unless resolution is explicitly set (reference    https://www.imagemagick.org/discourse-server/viewtopic.php?f=3&amp;t=13373).</li>
  <li> Add support for -selective-blur option.</li>
<dt>2009-03-19  6.5.0-3 ragesteel  &lt;iimagemagic-org-iapied0o@gt2.r...&gt;</dt>
  <li> ImageToBlob() no longer faults if Jasper compression is wrong (reference    https://www.imagemagick.org/discourse-server/viewtopic.php?f=3&amp;t=13372).</li>
<dt>2009-03-19  6.5.0-3 ERB  &lt;entropy@xebec...&gt;</dt>
  <li> Check the 8BIM profile resource block length (reference    https://www.imagemagick.org/discourse-server/viewtopic.php?f=3&amp;t=13368).</li>
  <li> Unlocked read in DeleteNodeByValueFromSplayTree (reference    https://www.imagemagick.org/discourse-server/viewtopic.php?f=3&amp;t=13370).</li>
<dt>2009-03-18  6.5.0-2 ERB  &lt;entropy@xebec...&gt;</dt>
  <li> Eliminate race condition when acquiring a wand (reference    https://www.imagemagick.org/discourse-server/viewtopic.php?f=3&amp;t=13357).</li>
  <li> Use of "localtime" in FormatMagickTime not thread-safe (reference    https://www.imagemagick.org/discourse-server/viewtopic.php?f=3&amp;t=13358).</li>
<dt>2009-03-18  6.5.0-2 Cristy  &lt;quetzlzacatenango@image...&gt;</dt>
  <li> Fix the image compose operator at OverCompositeOP for shadows (reference    https://www.imagemagick.org/discourse-server/viewtopic.php?f=1&amp;t=13330).</li>
...
<dt>2009-03-01  6.4.9-9 Cristy  &lt;quetzlzacatenango@image...&gt;</dt>
  <li> Convert returns MagickFalse for the -version option (reference    https://www.imagemagick.org/discourse-server/viewtopic.php?f=2&amp;t=13230).</li>
  <li> Don't set pixel opacity unless the image alpha channel is active (reference    https://www.imagemagick.org/discourse-server/viewtopic.php?f=3&amp;t=13189).</li>
...
<dt>2009-02-10  6.4.9-3 Cristy  &lt;quetzlzacatenango@image...&gt;</dt>
  ...
  <li> The stream utility no longer go into an infinite loop (reference    https://www.imagemagick.org/discourse-server/viewtopic.php?f=1&amp;t=13102).</li>
<dt>2009-02-04  6.4.9-2 Cristy  &lt;quetzlzacatenango@image...&gt;</dt>
  <li> JPEG to PDF was not always reversible (reference    https://www.imagemagick.org/discourse-server/viewtopic.php?f=3&amp;t=13020).</li>
<dt>2009-01-30  6.4.9-0 Cristy  &lt;quetzlzacatenango@image...&gt;</dt>
  <li> Stroking when annotating failed for stroke widths &gt; 2 (reference    https://www.imagemagick.org/discourse-server/viewtopic.php?f=3&amp;t=13009).</li>
<dt>2009-01-24  6.4.8-10 Cristy  &lt;quetzlzacatenango@image...&gt;</dt>
  <li> TransformImageColorspace() returns GRAYColorspace when set (reference    https://www.imagemagick.org/discourse-server/viewtopic.php?f=3&amp;t=12990).</li>
...
<dt>2009-01-18  6.4.8-7 Cristy  &lt;quetzlzacatenango@image...&gt;</dt>
  <li> Respect mouse wheel movements for display program (reference    https://www.imagemagick.org/discourse-server/viewtopic.php?f=2&amp;t=12938).</li>
  <li> Grab button in Display Open menu now works consistently (reference    https://www.imagemagick.org/discourse-server/viewtopic.php?f=3&amp;t=12942).</li>
  <li> Patch for problem with opacity in MVG (reference    https://www.imagemagick.org/discourse-server/viewtopic.php?f=3&amp;t=12946).</li>
...
<dt>2009-01-11  6.4.8-6 Chris Madison  &lt;madisonblu@gmail...&gt;</dt>
  <li> Set the stroke opacity for "opacity" SVG element (reference    https://www.imagemagick.org/discourse-server/viewtopic.php?f=3&amp;t=10594).</li>
...
<dt>2009-01-01  6.4.8-4 Cristy  &lt;quetzlzacatenango@image...&gt;</dt>
  ...
  <li> Do not set the fill element when 'opacity' is set (reference    https://www.imagemagick.org/discourse-server/viewtopic.php?f=3&amp;t=10594).</li>
  <li> Restore support for decoding the DVI format.</li>
  <li> Add perl and math lib reference to PerlMagick Makefile (reference    https://www.imagemagick.org/discourse-server/viewtopic.php?f=3&amp;t=12840).</li>
...
<dt>2008-12-26  6.4.8-2 Cristy  &lt;quetzlzacatenango@image...&gt;</dt>
  ...
  <li> Support reading FITS test files (reference    https://www.imagemagick.org/discourse-server/viewtopic.php?f=3&amp;t=12799).</li>
  <li> Replace input.ttf with the public domain Tuffy.ttf font.</li>
  <li> MagickNewImage() no longer faults when parameters are incorrect (reference    https://www.imagemagick.org/discourse-server/viewtopic.php?f=3&amp;t=12817).</li>
  <li> Allocate strings returned by XGetResourceInstance() (reference    https://www.imagemagick.org/discourse-server/viewtopic.php?f=3&amp;t=12818).</li>
  <li> The -append gravity is relative to the container (reference    https://www.imagemagick.org/discourse-server/viewtopic.php?f=1&amp;t=12821).</li>
...
<dt>2008-12-19  6.4.8-0 Cristy  &lt;quetzlzacatenango@image...&gt;</dt>
  ...
  <li> Initialize the black channel when testing the CMY colorspace (reference    https://www.imagemagick.org/discourse-server/viewtopic.php?f=3&amp;t=12685).</li>
  <li> remove calls to exit() in MagickWand (reference    https://www.imagemagick.org/discourse-server/viewtopic.php?f=2&amp;t=12772).</li>
...
<dt>2008-11-29  6.4.6-6 Cristy  &lt;quetzlzacatenango@image...&gt;</dt>
  ...
  <li> -extent x256+100+100 no longer returns an exception (reference    https://www.imagemagick.org/discourse-server/viewtopic.php?f=7&amp;t=12583).</li>
<dt>2008-11-27  6.4.6-5 Cristy  &lt;quetzlzacatenango@image...&gt;</dt>
  <li> TIFF pad is relative to bits-per-sample (reference    https://www.imagemagick.org/discourse-server/viewtopic.php?f=1&amp;t=12563).</li>
...
<dt>2008-11-26  6.4.6-4 Cristy  &lt;quetzlzacatenango@image...&gt;</dt>
  <li> DPX 10 bit YUV 4:2:2 are now processed properly (reference    https://www.imagemagick.org/discourse-server/viewtopic.php?f=1&amp;t=12443).</li>
...
<dt>2008-11-20  6.4.6-2 Cristy  &lt;quetzlzacatenango@image...&gt;</dt>
  <li> Transient bug in encipher / decipher operation (reference    https://www.imagemagick.org/discourse-server/viewtopic.php?f=3&amp;t=12540).</li>
<dt>2008-11-14  6.4.6-1 Cristy  &lt;quetzlzacatenango@image...&gt;</dt>
  <li> MPC image files working again.</li>
  <li> coders/wmf.c/lite_font_stringwidth() returns string width (reference    https://www.imagemagick.org/discourse-server/viewtopic.php?f=3&amp;t=12528).</li>
...
<dt>2008-11-10  6.4.5-6 Cristy  &lt;quetzlzacatenango@image...&gt;</dt>
  <li> Correct DPX frame position property label (reference    https://www.imagemagick.org/discourse-server/viewtopic.php?f=3&amp;t=12440).</li>
...
<dt>2008-11-01  6.4.5-3 Cristy  &lt;quetzlzacatenango@image...&gt;</dt>
  <li> Off by one error when computing affine in DrawAffineImage() (reference    https://www.imagemagick.org/discourse-server/viewtopic.php?f=3&amp;t=12391.</li>
<dt>2008-10-30  6.4.5-2 Cristy  &lt;quetzlzacatenango@image...&gt;</dt>
  <li> Fixed local adaptive thresholding  when using an offset (reference    https://www.imagemagick.org/discourse-server/viewtopic.php?f=3&amp;t=12371.</li>
...
<dt>2008-10-26  6.4.5-1 Cristy  &lt;quetzlzacatenango@image...&gt;</dt>
  <li> Set explicit image format for BlobToImage() (reference    https://www.imagemagick.org/discourse-server/viewtopic.php?f=2&amp;t=12340).</li>
...
<dt>2008-09-23  6.4.3-10 Cristy  &lt;quetzlzacatenango@image...&gt;</dt>
  <li> Fixed an OTB coder bug (reference    https://www.imagemagick.org/discourse-server/viewtopic.php?f=3&amp;t=12119).</li>
...
<dt>2008-09-01  6.4.3-7 Cristy  &lt;quetzlzacatenango@image...&gt;</dt>
  ...
  <li> Remove small memory leak when cloning image properties (reference    https://www.imagemagick.org/discourse-server/viewtopic.php?f=3&amp;t=11981).</li>
  <li> The scan delegate requires a device name, not a symbolic link.</li>
  <li> Report alpha instead of opacity for the TXT image format (reference    https://www.imagemagick.org/discourse-server/viewtopic.php?f=3&amp;t=12002).</li>
  <li> Add channel support to -motion-blur.</li>
  <li> Set the SVG affine matrix *before* we compute the scale (reference    https://www.imagemagick.org/discourse-server/viewtopic.php?f=3&amp;t=12030).</li>
  ...
  <li> Return the correct number of unique colors for colormapped image (reference    https://www.imagemagick.org/discourse-server/viewtopic.php?f=3&amp;t=12055).</li>
  <li> SVG depends on MagickWand for parallel make (reference    https://www.imagemagick.org/discourse-server/viewtopic.php?f=3&amp;t=12099).</li>
...
<dt>2008-08-27  6.4.3-6 Cristy  &lt;quetzlzacatenango@image...&gt;</dt>
  <li> Extract / embed namespace for JPEG XMP profiles (reference    https://www.imagemagick.org/discourse-server/viewtopic.php?f=3&amp;t=11832).</li>
  <li> Deprecate -map and replace with -affinity which supports dither methods.</li>
  <li> Set image depth when -depth is fired.</li>
  <li> Fix small memory leak in TIFF coder (reference    https://www.imagemagick.org/discourse-server/viewtopic.php?f=3&amp;t=11968).</li>
<dt>2008-08-24  6.4.3-5 Cristy  &lt;quetzlzacatenango@image...&gt;</dt>
  <li> Parallelize the colorspace transforms.</li>
  <li> Honor gravity for -extent option (reference    https://www.imagemagick.org/discourse-server/viewtopic.php?f=3&amp;t=11944).</li>
...
<dt>2008-08-20  6.4.3-2 Cristy  &lt;quetzlzacatenango@image...&gt;</dt>
  ...
  <li> Check for depth == 0 in GetQuantumScale() (reference    https://www.imagemagick.org/discourse-server/viewtopic.php?f=3&amp;t=11921).</li>
  <li> Fix CIN coder scanline length (reference    https://www.imagemagick.org/discourse-server/viewtopic.php?f=3&amp;t=11922).</li>
<dt>2008-08-20  6.4.3-1 Cristy  &lt;quetzlzacatenango@image...&gt;</dt>
  <li> Add $(MAGICKWAND_LIBS) dependency to the PerlMagick Makefile (reference    https://www.imagemagick.org/discourse-server/viewtopic.php?f=3&amp;t=11908).</li>
  <li> Fix configure script to configure the JBIG delegate library (reference    https://www.imagemagick.org/discourse-server/viewtopic.php?f=3&amp;t=11907).</li>
  <li> Error in indexed PNG output if number of colors &lt;= 16 (reference    https://www.imagemagick.org/discourse-server/viewtopic.php?f=3&amp;t=11905).</li>
...
<dt>2008-08-14  6.4.2-9 Cristy  &lt;quetzlzacatenango@image...&gt;</dt>
  <li> The -draw option no longer returns an error when for # like .6 (reference    https://www.imagemagick.org/discourse-server/viewtopic.php?f=3&amp;t=11879).</li>
<dt>2008-08-14  6.4.2-9 Cristy  &lt;quetzlzacatenango@image...&gt;</dt>
...
<dt>2008-08-07  6.4.2-8 Cristy  &lt;quetzlzacatenango@image...&gt;</dt>
  <li> Change MPEG delegate from mpeg2decode/mpeg2encode to ffmpeg (reference    https://www.imagemagick.org/discourse-server/viewtopic.php?f=3&amp;t=11827).</li>
...
<dt>2008-07-31  6.4.2-6 Cristy  &lt;quetzlzacatenango@image...&gt;</dt>
  ...
  <li> Properly append .magick to the USERPROFILES path (reference    https://www.imagemagick.org/discourse-server/viewtopic.php?f=3&amp;t=11806).</li>
...
<dt>2008-07-20  6.4.2-5 Cristy  &lt;quetzlzacatenango@image...&gt;</dt>
  <li> Certain corrupt GIF images no longer hang (reference    https://www.imagemagick.org/discourse-server/viewtopic.php?f=3&amp;t=11723).</li>
  <li> Read more than one image (if they exist) from DJVU image files.</li>
  <li> Don't set image depth in histogram coder (references    https://www.imagemagick.org/discourse-server/viewtopic.php?f=3&amp;t=11752).</li>
...
<dt>2008-06-25  6.4.1-9 Cristy  &lt;quetzlzacatenango@image...&gt;</dt>
  <li> The TXT format correctly reports alpha channel (reference    https://www.imagemagick.org/discourse-server/viewtopic.php?f=3&amp;t=11478).</li>
  <li> MONOTCHROME1 Dicom images are not longer inverted (reference    https://www.imagemagick.org/discourse-server/viewtopic.php?f=3&amp;t=11492).</li>
...
<dt>2008-06-08  6.4.1-8 Cristy  &lt;quetzlzacatenango@image...&gt;</dt>
  <li> The -sketch option is working again (reference    https://www.imagemagick.org/discourse-server/viewtopic.php?f=3&amp;t=11454).</li>
<dt>2008-06-08  6.4.1-7 Cristy  &lt;quetzlzacatenango@image...&gt;</dt>
  <li> More algorithms refactored to support a threaded cache view.</li>
  <li> EPS2 output only 1/3 of image when using LZW or rle compress (reference    https://www.imagemagick.org/discourse-server/viewforum.php?f=3).</li>
  <li> ISO C++ 1998 does not support 'long long' (reference    https://www.imagemagick.org/discourse-server/viewtopic.php?f=3&amp;t=11405).</li>
  <li> Patch GetMagickMemoryHandlers() to return the properly return the memory    handler addresses.</li>
  <li> Generate histogram comment if # unique colors exceed 1024 (reference    https://www.imagemagick.org/discourse-server/viewtopic.php?f=3&amp;t=11434).</li>
...
<dt>2008-05-15  6.4.1-4 Cristy  &lt;quetzlzacatenango@image...&gt;</dt>
  ...
  <li> Call DrawAffineImage() instead of CompositeImage() (reference    https://www.imagemagick.org/discourse-server/viewtopic.php?f=3&amp;t=11288).</li>
  <li> Throw exception for TIFF compression not support (reference    https://www.imagemagick.org/discourse-server/viewtopic.php?f=3&amp;t=11289).</li>
  <li> The +opaque option now recognizes its required argument (reference    https://www.imagemagick.org/discourse-server/viewtopic.php?f=3&amp;t=11298).</li>
  ...
  <li> Correct recolor equation for computing opacity (reference    https://www.imagemagick.org/discourse-server/viewtopic.php?f=3&amp;t=11346).</li>
...
<dt>2008-05-05  6.4.1-2 Sean Patrick Burke  &lt;seanburk@gmail...&gt;</dt>
  <li> Update IPLab coder (reference    https://www.imagemagick.org/discourse-server/viewtopic.php?f=2&amp;t=11200).</li>
...
<dt>2008-04-24  6.4.0-11 Cristy  &lt;quetzlzacatenango@image...&gt;</dt>
  ...
  <li> Use a uniform convolution filter for motion blur (reference    https://www.imagemagick.org/discourse-server/viewtopic.php?f=3&amp;t=11122).</li>
...
<dt>2008-04-20  6.4.0-10 Chris Madison  &lt;madisonblu@hotma...&gt;</dt>
  ...
  <li> Default to HSL colorspace when modulating (reference    https://www.imagemagick.org/discourse-server/viewtopic.php?f=1&amp;t=11073).</li>
  ...
  <li> Report 'no clip path defined' exception for -clip-path option (reference    https://www.imagemagick.org/discourse-server/viewtopic.php?f=3&amp;t=11098).</li>
<dt>2008-04-16  6.4.0-8 Cristy  &lt;quetzlzacatenango@image...&gt;</dt>
  ...
  <li> Return MagickTrue if InvokeDynamicImageFilter() does not generate an    exception (reference                https://www.imagemagick.org/discourse-server/viewtopic.php?f=2&amp;t=11065).</li>
...
<dt>2008-04-12  6.4.0-7 Cristy  &lt;quetzlzacatenango@image...&gt;</dt>
  ...
  <li> Use GetImagePixels() rather than SetImagePixels() when making multiple    passes and setting image pixels (reference    https://www.imagemagick.org/discourse-server/viewtopic.php?f=3&amp;t=11022).</li>
...
<dt>2008-03-26  6.4.0-1 Cristy  &lt;quetzlzacatenango@image...&gt;</dt>
  ...
  <li> Malformed use of caption no longer consumes memory (reference   https://www.imagemagick.org/discourse-server/viewtopic.php?f=3&amp;t=10914).</li>
  <li> Don't run Ghostscript twice (reference   https://www.imagemagick.org/discourse-server/viewtopic.php?f=3&amp;t=10922).</li>
<dt>2008-03-21  6.4.0-0 Cristy  &lt;quetzlzacatenango@image...&gt;</dt>
  <li> SpreadImage() no longer introduces noise into the resulting image (reference                https://www.imagemagick.org/discourse-server/viewtopic.php?f=3&amp;t=10892).</li>
...
<dt>2008-03-11  6.3.9-6 Cristy  &lt;quetzlzacatenango@image...&gt;</dt>
  <li> Support both GTK and CAIRO interfaces to RSVG (reference    ttp://www.imagemagick.org/discourse-server/viewtopic.php?f=2&amp;t=10802).</li>
  <li> Display colormapped PNG images with alpha properly (reference    https://www.imagemagick.org/discourse-server/viewtopic.php?f=3&amp;t=10819).</li>
...
<dt>2008-02-24  6.3.9-1 Cristy  &lt;quetzlzacatenango@image...&gt;</dt>
  <li> Return the actual image format for HTTP: or FTP: format (reference        https://www.imagemagick.org/discourse-server/viewtopic.php?f=1&amp;t=10715).</li>
  <li> Fix so image.quantize(true) returns error as expected (reference    https://www.imagemagick.org/discourse-server/viewtopic.php?f=1&amp;t=10735).</li>
<dt>2008-02-20  6.3.9-0 Cristy  &lt;quetzlzacatenango@image...&gt;</dt>
  ...
  <li> Identify now reports both actual and reported image depths (reference    https://www.imagemagick.org/discourse-server/viewtopic.php?f=1&amp;t=10716).</li>
...
<dt>2008-01-28  6.3.8-3 Cristy  &lt;quetzlzacatenango@image...&gt;</dt>
  <li> Liquid rescale limits the final size to twice the original size (reference    https://www.imagemagick.org/discourse-server/viewtopic.php?f=1&amp;t=10536).</li>
...
<dt>2008-01-14  6.3.8-0 Cristy  &lt;quetzlzacatenango@image...&gt;</dt>
  <li> Monochome EPS3 images are no longer corrupt (reference    https://www.imagemagick.org/discourse-server/viewtopic.php?f=3&amp;t=10422).</li>
  <li> Eliminate memory corruption with broken PICT image (reference    https://www.imagemagick.org/discourse-server/viewtopic.php?f=3&amp;t=10447).</li>
  <li> Return a Grayscale colorspace for grayscale DPX image (previously    returned Log colorspace).</li>
  <li> Fix -g option for PCL6 support (reference    https://www.imagemagick.org/discourse-server/viewtopic.php?f=3&amp;t=10462).</li>
<dt>2008-01-08  6.3.7-10 Cristy  &lt;quetzlzacatenango@image...&gt;</dt>
  ...
  <li> Throw an exception *before* we call wmf_api_destroy() (reference    https://www.imagemagick.org/discourse-server/viewtopic.php?f=3&amp;t=10420).</li>
...
<dt>2007-12-13  6.3.7-5 Cristy  &lt;quetzlzacatenango@image...&gt;</dt>
  ...
  <li> Fix bug in GetEXIFProperty() (reference    https://www.imagemagick.org/discourse-server/viewtopic.php?f=3&amp;t=10300).</li>
...
<dt>2007-12-01  6.3.7-3 Cristy  &lt;quetzlzacatenango@image...&gt;</dt>
  <li> Fix 'insufficient image data' for DCM format (reference    https://www.imagemagick.org/discourse-server/viewtopic.php?f=3&amp;t=10227).</li>
  ...
  <li> Colormapped multi-image PDF's are no longer corrupt (reference    https://www.imagemagick.org/discourse-server/viewtopic.php?f=3&amp;t=10258).</li>
...
<dt>2007-11-02  6.3.7-0 Cristy  &lt;quetzlzacatenango@image...&gt;</dt>
  ...
  <li> Fixed -threshold option to return all white for -threshold 0 (reference    https://www.imagemagick.org/discourse-server/viewtopic.php?f=3&amp;t=10126).</li>
...
<dt>2007-11-02  6.3.6-6 Cristy  &lt;quetzlzacatenango@image...&gt;</dt>
  <li> Upgrade to FPX version libfpx-1.2.0.14 (reference    https://www.imagemagick.org/discourse-server/viewtopic.php?f=3&amp;t=10041).</li>
  <li> Modules are searched first in the directories specified by the environment    variables, and then -- if the desired module is not found -- in the    compiled-in path.  (reference    https://www.imagemagick.org/discourse-server/viewtopic.php?f=3&amp;t=10039).</li>
...
<dt>2007-09-22  6.3.6-0 Cristy  &lt;quetzlzacatenango@image...&gt;</dt>
  <li> Check the API version and quantum depth before loading a coder module or          image filter (reference    https://www.imagemagick.org/discourse-server/viewtopic.php?f=3&amp;t=9780).</li>
  ...
  <li> Fixed memory leak in CloneString() (reference    https://www.imagemagick.org/discourse-server/viewtopic.php?f=3&amp;t=9763).</li>
...
<dt>2007-09-04  6.3.5-9 Gozer404</dt>
  <li> Add French to the messaging system (reference    https://www.imagemagick.org/discourse-server/viewtopic.php?f=2&amp;t=9601).</li>
  <li> Add -fopenmp to MAGICK_PCFLAGS (reference   https://www.imagemagick.org/discourse-server/viewtopic.php?f=3&amp;t=9608).</li>
<dt>2007-08-14  6.3.5-7 Cristy  &lt;quetzlzacatenango@image...&gt;</dt>
  ...
  <li> Fix glyph memory leak in AnnotateImage (reference    https://www.imagemagick.org/discourse-server/viewtopic.php?f=3&amp;t=9523).</li>
  <li> Rename analyze.c to Analyze.c (reference    ttp://www.imagemagick.org/discourse-server/viewtopic.php?f=3&amp;t=9538).</li>
...
<dt>2007-08-05  6.3.5-6 Cristy  &lt;quetzlzacatenango@image...&gt;</dt>
  <li> Remove atexit in Magick++ code to avoid possible client crash (reference    https://www.imagemagick.org/discourse-server/viewtopic.php?f=3&amp;t=9270).</li>
...
<dt>2007-07-25  6.3.5-4 Cristy  &lt;quetzlzacatenango@image...&gt;</dt>
  <li> Remove extraneous break statement so -type option properly sets the    image_info-&gt;type member (reference    https://www.imagemagick.org/discourse-server/viewtopic.php?f=3&amp;t=9261).</li>
...
<dt>2007-06-18  6.3.5-0 Cristy  &lt;quetzlzacatenango@image...&gt;</dt>
  ...
  <li> Tiff images in the LAB colorspace are no longer identified as RGB    (reference https://www.imagemagick.org/discourse-server/viewtopic.php?f=3&amp;t=9015).</li>
  <li> Update image color_profile and iptc_profile members in the JPEG coder    (reference https://www.imagemagick.org/discourse-server/viewtopic.php?f=3&amp;t=9063);</li>
<dt>2007-06-13  6.3.4-10 Cristy  &lt;quetzlzacatenango@image...&gt;</dt>
  ...
  <li> Remove Photoshop string segment from JPEG profile (reference    https://www.imagemagick.org/discourse-server/viewtopic.php?f=3&amp;t=9006).</li>
<dt>2007-06-11  6.3.4-9 Cristy  &lt;quetzlzacatenango@image...&gt;</dt>
  <li> Converting a jpg to pdf is creating an empty pdf object (reference    https://www.imagemagick.org/discourse-server/viewtopic.php?f=3&amp;t=8954).</li>
  <li> Respect the '-set type:hinting off option' (bug report from Richard    Jones).</li>
  <li> WritePSDImage vulnerable to exploitable heap corruption (reference    https://www.imagemagick.org/discourse-server/viewtopic.php?f=3&amp;t=8967).</li>
<dt>2007-06-09  6.3.4-8 Cristy  &lt;quetzlzacatenango@image...&gt;</dt>
  <li> SetMagickRegistry() post-increment the value 'id' (reference    https://www.imagemagick.org/discourse-server/viewtopic.php?f=3&amp;t=8944).</li>
...
<dt>2007-05-22  6.3.4-3 Cristy  &lt;quetzlzacatenango@image...&gt;</dt>
  <li> Fixed mogrify conversions with -format and -path (reference    https://www.imagemagick.org/discourse-server/viewtopic.php?f=1&amp;t=9127).</li>
...
<dt>2007-05-03  6.3.4-1 Cristy  &lt;quetzlzacatenango@image...&gt;</dt>
  ...
  <li> Writing JPEG YCbCr TIFF images no longer faults (reference    https://www.imagemagick.org/discourse-server/viewtopic.php?f=3&amp;t=8896).</li>
<dt>2007-04-30  6.3.4-0 Anthony  &lt;anthony@griffith...&gt;</dt>
...
<dt>2007-03-11  6.3.3-2 Cristy  &lt;quetzlzacatenango@image...&gt;</dt>
  <li> Improve configure script to better support Ghostscript under Mac OSX (    reference https://www.imagemagick.org/discourse-server/viewtopic.php?t=8557).</li>
...
<dt>2007-03-08  6.3.3-1 Cristy  &lt;quetzlzacatenango@image...&gt;</dt>
  <li> Support versions 2.1.0 and above (reference    https://www.imagemagick.org/discourse-server/viewtopic.php?f=2&amp;t=8620).</li>
  <li> Support SVG rotation about a point (e.g. rotate(45 75 75)).</li>
  <li> Fix fault in DCM coder (reference    https://www.imagemagick.org/discourse-server/viewtopic.php?f=3&amp;t=8618).</li>
  <li> Check for a NULL parser in SVGReference in coders/svg.c (reference    https://www.imagemagick.org/discourse-server/viewtopic.php?f=3&amp;t=8609).</li>
...
<dt>2007-02-24  6.3.3-0 Cristy  &lt;quetzlzacatenango@image...&gt;</dt>
  ...
  <li> Configure Ghostscript for library or framework (reference    https://www.imagemagick.org/discourse-server/viewtopic.php?f=2&amp;t=8557).</li>
...
<dt>2007-01-06  6.3.1-6 Cristy  &lt;quetzlzacatenango@image...&gt;</dt>
  <li> Fix the -auto-orient to work with an image sequence (reference    https://www.imagemagick.org/discourse-server/viewtopic.php?t=8100).</li>
