...
<pre class="bg-light text-dark"><samp>magick rose.jpg -encipher passphrase.txt rose.png </samp></pre>

<p>Here we encipher an image using another image as the passphrase:</p>

<pre class="bg-light text-dark"><samp>magick rose.jpg -encipher smiley.gif rose.png </samp></pre>
...
<pre class="bg-light text-dark"><samp>magick rose.png -decipher passphrase.txt rose.jpg </samp></pre>
