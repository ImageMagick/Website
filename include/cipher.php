...
<p>Use the <a href="/command-line-options/#encipher">-encipher</a> option to scramble your image so that it is unrecognizable.  The option requires a filename that contains your passphrase.  In this example we scramble an image and save it in the PNG format:</p>
...
<p>Use the <a href="/command-line-options/#decipher">-decipher</a> option to unscramble your image so that it is recognizable once again.  The option requires a filename that contains your passphrase.  In this example we unscramble an image and save it in the JPEG format:</p>
...
Examples <a href="https://usage.imagemagick.org/transform/#encipher"
