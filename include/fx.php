...
<p class="lead magick-description">Use the <a href="http://im.snibgo.com/fxnew.htm">FX special effects image operator</a> to apply a mathematical expression to an image or image channels.  Use FX to:</p>
...
<li>single character variables are reserved.  Assignments to reserved built-ins do not throw an exception and have no effect;  e.g. <samp>r=3.0; r</samp> returns the pixel red color value, not 3.0</li>
...
<ul><pre class="bg-light text-dark"><samp>$ magick canvas:'rgb(25%,50%,75%)' rose: -colorspace gray  \
