...
<pre class="p-3 mb-2 bg-light text-dark cli"><samp>magick -size 64x64 canvas:black -channel blue -fx "1/2" fx_navy.png
</samp></pre>
...
<pre class="p-3 mb-2 bg-light text-dark cli"><samp>magick rose: \
...
<pre class="p-3 mb-2 bg-light text-dark cli"><samp>magick -size 70x70 canvas: \
...
<pre class="p-3 mb-2 bg-light text-dark cli"><samp>magick photo.jpg -fx 'iso=32; rone=rand(); rtwo=rand(); \
...
<pre class="p-3 mb-2 bg-light text-dark cli"><samp>magick -size 400x400 xc:gray -fx " \
  Xi=2.4*i/w-1.2; \
  Yj=2.4*j/h-1.2; \
...
<pre class="p-3 mb-2 bg-light text-dark cli"><samp>magick xc:gray -fx " \
...
, &gt;&gt;=,
  ...
  <dt class="col-md-4"> user settings:</dt>
  	<dd class="col-md-8">define Fx symbols as user settings, e.g. <pre class="p-3 mb-2 bg-light text-dark cli"><samp>magick ... -set option:wd1 "%[fx:w/2]" -resize "%[fx:wd1-5]" ...</samp></pre><dd>
</dl>
...
<pre class="p-3 mb-2 bg-light text-dark cli"><samp>magick image1.jpg image2.jpg image3.jpg -fx "(u+u[2])/2" image.jpg
</samp></pre>
...
<pre class="p-3 mb-2 bg-light text-dark"><samp>p[-1].g      green value of pixel to the immediate left of the current pixel
...
<pre class="p-3 mb-2 bg-light text-dark"><samp>p{0,0}.r     red value of the pixel in the upper left corner of the image
...
<pre class="p-3 mb-2 bg-light text-dark cli"><samp>magick rose: -duplicate 29 -virtual-pixel Gray -distort SRT '%[fx:360.0*t/n]' \
