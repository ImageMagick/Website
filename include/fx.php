...
<pre class="bg-light text-dark mx-4"><samp>p[-1].g      green value of pixel to the immediate left of the current pixel
...
<pre class="bg-light text-dark mx-4"><samp>p{0,0}.r     red value of the pixel in the upper left corner of the image
...
<pre class="bg-light text-dark mx-4"><samp>$ magick canvas:'rgb(25%,50%,75%)' rose: -colorspace gray  \
