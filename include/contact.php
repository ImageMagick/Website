...
<?php
  ...
  switch ($action)
  {
    case 'Send':
    {
      ...
      $mail->Send();
?>
      <p>Your message was sent.  Expect a reply within 24-48 hours if your message is on topic and is a sponsorship, license, security, or paid support issue.  For all other issues, post your message to the <a href="http://www.imagemagick.org/discourse-server">discourse server</a>.</p>
...
?>
  <div>
  <p class="lead magick-description">Post here for any of the issues listed below.  You can expect a response from our team if your issue is a sponsorship, <a href="http://www.imagemagick.org/script/license.php">license</a>, security, or paid support issue.  If you require a response for any other issue, post to the ImageMagick public <a href="http://www.imagemagick.org/discourse-server">forums</a>.  You can also post bug reports to the <a href="https://github.com/ImageMagick/ImageMagick/issues">issues</a> forum.  Note, we do <u>not</u> offer sponsored links <u>nor do we respond to solicitations</u>.</p>
  <fieldset>
