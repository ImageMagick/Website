...
<pre class="p-3 mb-2 bg-light text-dark cli"><samp>magick composite -gravity center smile.gif  rose: rose-over.png </samp></pre>
...
<pre class="p-3 mb-2 bg-light text-dark cli"><samp>magick -size 70x70 canvas:none -fill red -draw 'circle 35,35 10,30' red-circle.png
...
<pre class="p-3 mb-2 bg-light text-dark cli"><samp>magick -verbose stream.jpg bear.jpg bear_mask.png -define compose:args=400x0.0002+100 \
...
<pre class="p-3 mb-2 bg-light text-dark cli"><samp>magick -verbose stream.jpg \( bear.jpg -read-mask only_bear.png \) bear_mask.png \
...
transparent, extract, background, or shape the alpha channel</td>
  ...
  <tr>
    <td><a href="/script/command-line-options.php#blend">-blend <var>geometry</var></a></td>
    <td>blend images</td>
  </tr>
  ...
  <tr>
    <td><a href="/script/command-line-options.php#displace">-displace <var>geometry</var></a></td>
    <td>shift image pixels defined by a displacement map</td>
  </tr>

  <tr>
    <td><a href="/script/command-line-options.php#dissolve">-dissolve <var>value</var></a></td>
  ...
  <tr>
    <td><a href="/script/command-line-options.php#stegano">-stegano <var>offset</var></a></td>
    <td>hide watermark within an image</td>
  </tr>

  <tr>
    <td><a href="/script/command-line-options.php#stereo">-stereo <var>geometry</var></a></td>
  ...
  <tr>
    <td><a href="/script/command-line-options.php#tile">-tile</a></td>
  ...
  <tr>
    <td><a href="/script/command-line-options.php#watermark">-watermark <var>geometry</var></a></td>
