...
<pre class="p-3 mb-2 bg-light text-dark cli"><samp>magick import rose.jpg </samp></pre>

<p>To capture the entire X server screen in the Postscript image format:</p>

<pre class="p-3 mb-2 bg-light text-dark cli"><samp>magick import -window root screen.ps </samp></pre>
...
<table class="table table-sm table-hover table-striped table-responsive">
  ...
  <tr>
    <td><a href="/script/command-line-options.php#border">-border</a></td>
  ...
  <tr>
    <td><a href="/script/command-line-options.php#despeckle">-descend</a></td>
  ...
  <tr>
    <td><a href="/script/command-line-options.php#frame">-frame</a></td>
  ...
  <tr>
    <td><a href="/script/command-line-options.php#pause">-pause <var>seconds</var></a></td>
  ...
  <tr>
    <td><a href="/script/command-line-options.php#screen">-screen</a></td>
  ...
  <tr>
    <td><a href="/script/command-line-options.php#sharpen">-silent</a></td>
  ...
  <tr>
    <td><a href="/script/command-line-options.php#update">-type <var>type</var></a></td>
    <td>image type</td>
  </tr>
