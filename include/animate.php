...
<p class="lead">Use the <samp>animate</samp> program to animate an image sequence on any X server.   See <a href="/script/command-line-processing.php">Command Line Processing</a> for advice on how to structure your <samp>animate</samp> command or see below for example usages of the command.</p>
...
<pre class="p-3 mb-2 bg-light text-dark cli"><samp>magick animate movie.gif </samp></pre>

<p>To animate a directory of JPEG images, use:</p>

<pre class="p-3 mb-2 bg-light text-dark cli"><samp>magick animate *.jpg </samp></pre>
...
transparent, extract, background, or shape the alpha channel</td>
  ...
  <tr>
    <td><a href="/script/command-line-options.php#backdrop">-backdrop</a></td>
  ...
  <tr>
    <td><a href="/script/command-line-options.php#colormap">-colormap <var>type</var></a></td>
  ...
  <tr>
    <td><a href="/script/command-line-options.php#animate">-display <var>server</var></a></td>
  ...
  <tr>
    <td><a href="/script/command-line-options.php#gravity">-gravity <var>geometry</var></a></td>
  ...
  <tr>
    <td><a href="/script/command-line-options.php#immutable">-immutable <var>type</var></a></td>
  ...
  <tr>
    <td><a href="/script/command-line-options.php#label">-label <var>name</var></a></td>
  ...
  <tr>
    <td><a href="/script/command-line-options.php#map">-map <var>filename</var></a></td>
  ...
  <tr>
    <td><a href="/script/command-line-options.php#remote">-remote <var>command</var></a></td>
  ...
  <tr>
    <td><a href="/script/command-line-options.php#update">-update <var>seconds</var></a></td>
  ...
  <tr>
    <td><a href="/script/command-line-options.php#visual">-visual</a></td>
    <td>animate image using this visual type</td>
  </tr>

  <tr>
    <td><a href="/script/command-line-options.php#write">-window <var>id</var></a></td>
    <td>animate images to background of this window</td>
  </tr>

  <tr>
    <td><a href="/script/command-line-options.php#write">-window-group <var>id</var></a></td>
