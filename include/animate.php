...
<p class="lead">Use the <samp>animate</samp> program to animate an image sequence on any X server.   See <a href="/command-line-processing/">Command Line Processing</a> for advice on how to structure your <samp>animate</samp> command or see below for example usages of the command.</p>
...
transparent, extract, background, or shape the alpha channel</td>
  ...
  <tr>
    <td><a href="/command-line-options/#animate">-display <var>server</var></a></td>
