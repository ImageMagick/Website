...
<ul><pre class="bg-light text-dark"><code>magick -bordercolor lime -border 10 image.jpg image.png
...
<ul><pre class="bg-light text-dark"><code>$ magick xc:cyan -colorspace LAB txt:
