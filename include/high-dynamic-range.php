...
<p>Under Windows, follow the instructions (straightforward for a non-programmer) in a one hour process to build and configure your own executables: <a href="/install-source/">Install from Windows Source</a>.</p>
