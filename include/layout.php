...
<head>
  ...
  <link type="image/png" sizes="64x64" href="/image/wand.png" rel="icon">
  <link type="image/icon" sizes="16x16" href="/image/wand.ico" rel="shortcut icon">
...
<svg xmlns="http://www.w3.org/2000/svg" class="d-none">
  ...
  <div class="container-fluid">
    <a class="navbar-brand" href="/"><img class="d-block" id="icon" alt="ImageMagick" width="32" height="32" src="/image/wand.ico"/></a>
    ...
    <div class="collapse navbar-collapse" id="magick-navbars">
      <ul class="navbar-nav me-auto mb-2 mb-md-0">
        <li class="nav-item">
          <a class="nav-link <?php IsActive($topic,'Download'); ?>" href="/script/download.php">Download</a>
        </li>
        <li class="nav-item">
          <a class="nav-link <?php IsActive($topic,'Tools'); ?>" href="/script/command-line-tools.php">Tools</a>
        </li>
        <li class="nav-item">
          <a class="nav-link <?php IsActive($topic,'CLI'); ?>" href="/script/command-line-processing.php">CLI</a>
        </li>
        <li class="nav-item">
          <a class="nav-link <?php IsActive($topic,'Develop'); ?>" href="/script/develop.php">Develop</a>
        </li>
        <li class="nav-item">
...
?>
  ...
  <footer class="py-5 text-center text-body-secondary bg-body-tertiary">
    <div class="container-fluid">
      <a href="/script/security-policy.php">Security</a> •
      <a href="/script/news.php">News</a>
    &nbsp;
   ...
   <br/>
     <a href="/script/support.php">Sponsor</a> •
     <a href="/script/cite.php">Cite</a> •
  ...
  <!-- Javascript assets -->
  <script src="/assets/magick-js.php" ></script>
  </body>
</html>
<?php
  }
