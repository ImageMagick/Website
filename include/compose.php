...
<pre class="bg-light text-dark"><samp>composite ... -blend 50x50 ...  </samp></pre>
...
<pre class="bg-light text-dark"><samp>magick ... -compose blend  -define compose:args=50,50 -composite ...  </samp></pre>
